...
class DatabaseImporter {
  ...
  async importContactsToDatabase(contacts, communicationHistory = [], callHistory = []) {
    ...
    // Skip communication history import due to RLS policy restrictions
    console.log(`⚠️ Skipping communication history import (${communicationHistory.length} records) due to RLS policy restrictions`);
    console.log(`⚠️ Skipping call history import (${callHistory.length} records) due to RLS policy restrictions`);
