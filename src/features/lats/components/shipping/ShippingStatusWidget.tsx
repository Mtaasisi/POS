...
const ShippingStatusWidget: React.FC<ShippingStatusWidgetProps> = ({
  ...
  const mockShipments = shipments.length > 0 ? shipments : [
    { id: '1', status: 'in_transit', trackingNumber: 'DHL1234567890', carrier: { name: 'DHL Tanzania' } },
    { id: '2', status: 'delivered', trackingNumber: 'TNT0987654321', carrier: { name: 'TNT Tanzania' } },
    { id: '3', status: 'pending', trackingNumber: 'POSTA5555666', carrier: { name: 'Posta Tanzania' } }
  ];
