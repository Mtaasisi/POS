...
const OrderManagementModal: React.FC<OrderManagementModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-7xl max-h-[95vh] mx-4 overflow-hidden">
    ...
    <div className={`border border-gray-200 rounded-lg bg-white hover:shadow-md transition-all ${
      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="flex items-center gap-2">
          <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(order.status as OrderStatus)}`}>
              ...
              <div className="flex gap-1 flex-wrap">
                {availableStatuses.map(status => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-xs font-medium transition-colors hover:opacity-80 ${getStatusColor(status)}`}
