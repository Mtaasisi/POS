...
export const PURCHASE_ORDERS_CONFIG = {
  ...
  BASE_ROUTE: '/lats/purchase-orders',
  
  // Routes configuration
  ROUTES: {
    LIST: '/lats/purchase-orders',
    CREATE: '/lats/purchase-order/create',
    DETAIL: '/lats/purchase-orders/:id',
    EDIT: '/lats/purchase-orders/:id/edit',
    SHIPPED_ITEMS: '/lats/purchase-orders/shipped-items',
    SHIPPED_ITEMS_BY_PO: '/lats/purchase-orders/:id/shipped-items',
    SUPPLIERS: '/lats/purchase-orders/suppliers'
  },
