...
export const ShelfManagementPage: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const [shelvesData, locationsData, statsData] = await Promise.all([
        storeShelfApi.getAll({ 
          ...filters,
          search: searchTerm || undefined
        }),
        storeLocationApi.getAll(),
        storeShelfApi.getStats()
      ]);
  ...
  const getStoreLocationName = (locationId: string) => {
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Manage all shelves across all store locations</p>
          </div>
        </div>
            ...
            <div>
              ...
              <GlassSelect
                ...
                onChange={(value) => setFilters(prev => ({ 
                  ...prev, 
                  store_location_id: value || undefined 
                }))}
                options={[
            ...
            <div className="flex justify-between items-start mb-3">
              <div className="flex-1">
                ...
                <p className="text-sm text-blue-600 flex items-center gap-1">
                  ...
                  {getStoreLocationName(shelf.store_location_id)}
                </p>
              </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <GlassSelect
                ...
                onChange={(value) => setFormData(prev => ({ ...prev, store_location_id: value }))}
                disabled={isEditing}
                options={[
                  { value: '', label: 'Select Store Location' },
                  ...storeLocations.map(location => ({
                    value: location.id,
                    label: `${location.name} (${location.city})`
                  }))
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <GlassSelect
                ...
                onChange={(value) => setFormData(prev => ({ ...prev, shelf_type: value as any }))}
                options={SHELF_TYPES}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <GlassSelect
                value={formData.zone || ''}
                onChange={(value) => setFormData(prev => ({ ...prev, zone: value as any }))}
                options={SHELF_ZONES}
              />
            </div>
          </div>
          ...
          <div className="flex justify-end gap-3">
            ...
            <GlassButton
              ...
              disabled={!formData.store_location_id || !formData.name || !formData.code}
            >
        ...
        {selectedShelf && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <span className="font-medium">Store Location:</span> {getStoreLocationName(selectedShelf.store_location_id)}
              </div>
              <div>
