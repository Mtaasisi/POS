...
const BrandManagementPage: React.FC = () => {
  ...
  useEffect(() => {
    console.log('🔍 BrandManagementPage: Component loaded');
    console.log('🔍 BrandManagementPage: Environment check:', {
  ...
  const fetchBrands = async () => {
    try {
      setLoading(true);
      const data = showDeletedBrands ? await getAllBrands() : await getActiveBrands();
      setBrands(data);
    } catch (error: any) {
