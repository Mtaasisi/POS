      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <GlassCard className="p-4">
              ...
              <nav className="space-y-2">
                {[
                  ...
                  { id: 'performanceMonitoring', label: 'Performance Monitoring', icon: BarChart3 }
                ].map((section) => (
                  <button
                    key={section.id}
          ...
          <div className="lg:col-span-3">
            ...
            {activeSection === 'performanceMonitoring' && (
              <PerformanceMonitoringSettings 
                settings={settings.performanceMonitoring}
                onSave={(data) => saveSettings('performanceMonitoring', data)}
                expanded={expandedSections.has('performanceMonitoring')}
                onToggle={() => toggleSection('performanceMonitoring')}
                getStatusIcon={getStatusIcon}
                getStatusColor={getStatusColor}
              />
            )}
      ...
      {expanded && (
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-800">App Logo</h4>
            <LogoUpload
          ...
          {/* Company Information */}
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-800">Company Information</h4>
          ...
          {/* Color Scheme */}
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-800">Color Scheme</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-800">Logo Display</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          {/* Preview Section */}
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-800">Preview</h4>
      ...
      <div className="flex items-center justify-between cursor-pointer" onClick={onToggle}>
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Configure automatic system operations</p>
          </div>
        </div>
...
const PerformanceMonitoringSettings: React.FC<{
  settings: any;
  onSave: (data: any) => void;
  expanded: boolean;
  onToggle: () => void;
  ...
  const handleSave = async () => {
    ...
    try {
      await onSave(localSettings);
      toast.success('Performance monitoring settings saved successfully!');
    } catch (error) {
      toast.error('Failed to save performance monitoring settings');
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="flex items-center justify-between cursor-pointer" onClick={onToggle}>
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Real-time metrics, alerts, and auto-scaling</p>
          </div>
        </div>
        {expanded ? <ChevronDown className="h-5 w-5" /> : <ChevronRight className="h-5 w-5" />}
      </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <GlassInput
                ...
                type="number"
                value={localSettings.resourceLimits.maxBandwidth}
                onChange={(e) => setLocalSettings({
                  ...localSettings,
                  resourceLimits: {
                    ...localSettings.resourceLimits,
              ...
              <GlassInput
                ...
                type="number"
                value={localSettings.resourceLimits.maxRequestsPerMinute}
                onChange={(e) => setLocalSettings({
                  ...localSettings,
                  resourceLimits: {
                    ...localSettings.resourceLimits,
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <GlassInput
                ...
                type="number"
                value={localSettings.monitoringIntervals.metricsCollection}
                onChange={(e) => setLocalSettings({
                  ...localSettings,
                  monitoringIntervals: {
                    ...localSettings.monitoringIntervals,
                    metricsCollection: parseInt(e.target.value)
                  }
                })}
                min="10"
              />
              <GlassInput
                label="Alert Check"
                type="number"
                value={localSettings.monitoringIntervals.alertCheck}
                onChange={(e) => setLocalSettings({
                  ...localSettings,
                  monitoringIntervals: {
                    ...localSettings.monitoringIntervals,
                    alertCheck: parseInt(e.target.value)
                  }
                })}
                min="10"
              />
              <GlassInput
                label="Health Check"
                type="number"
                value={localSettings.monitoringIntervals.healthCheck}
                onChange={(e) => setLocalSettings({
                  ...localSettings,
                  monitoringIntervals: {
                    ...localSettings.monitoringIntervals,
                    healthCheck: parseInt(e.target.value)
                  }
                })}
                min="10"
              />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    checked={localSettings.performanceAlerts.emailNotifications}
                    onChange={(e) => setLocalSettings({
                      ...localSettings,
                      performanceAlerts: {
                        ...localSettings.performanceAlerts,
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    checked={localSettings.performanceAlerts.slackNotifications}
                    onChange={(e) => setLocalSettings({
                      ...localSettings,
                      performanceAlerts: {
                        ...localSettings.performanceAlerts,
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    checked={localSettings.performanceAlerts.smsNotifications}
                    onChange={(e) => setLocalSettings({
                      ...localSettings,
                      performanceAlerts: {
                        ...localSettings.performanceAlerts,
              ...
              <GlassInput
                ...
                type="number"
                value={localSettings.performanceAlerts.alertCooldown}
                onChange={(e) => setLocalSettings({
                  ...localSettings,
                  performanceAlerts: {
                    ...localSettings.performanceAlerts,
