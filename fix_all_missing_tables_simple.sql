-- Fix All Missing Tables (Simple Version - No Foreign Keys)
...
-- Create product_variants table (without foreign key references)
CREATE TABLE IF NOT EXISTS product_variants (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  product_id TEXT, -- Changed from UUID to TEXT to avoid foreign key issues
  sku TEXT NOT NULL,
