...
in the LATS Customer Contacts Excel file.
"""
...
def update_excel_whatsapp():
    """Copy phone numbers to WhatsApp column in Excel file where WhatsApp is empty"""
    
    # Read the Excel file
    print("Reading LATS_Customer_Contacts.xlsx...")
    df = pd.read_excel('LATS_Customer_Contacts.xlsx')
    ...
    # Create a backup
    backup_filename = 'LATS_Customer_Contacts_backup.xlsx'
    ...
    df.to_excel('LATS_Customer_Contacts.xlsx', index=False)
    print("Updated LATS_Customer_Contacts.xlsx saved successfully!")
...
if __name__ == "__main__":
    try:
        updated_df = update_excel_whatsapp()
        print("\n✅ Excel Phone to WhatsApp copy operation completed successfully!")
