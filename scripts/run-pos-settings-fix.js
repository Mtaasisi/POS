...
async function runPOSSettingsFix() {
  console.log('🚀 Running POS Settings Database Fix...');
  ...
  try {
    ...
    const migrationPath = path.join(process.cwd(), 'supabase', 'migrations', '20241201000020_fix_pos_settings_complete.sql');
    ...
    console.error('💥 Error running POS settings fix:', error);
  }
}
