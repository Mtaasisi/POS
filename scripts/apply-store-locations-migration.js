// Script to apply the store locations table migration
...
async function applyStoreLocationsMigration() {
  try {
    console.log('🚀 Applying store locations migration...');
    ...
    console.log('✅ Store locations migration applied successfully!');
    console.log('📋 Migration details:');
    console.log('   - Created lats_store_locations table');
    console.log('   - Added comprehensive location fields');
    console.log('   - Created indexes for performance');
    console.log('   - Enabled Row Level Security');
    console.log('   - Added default main branch');
