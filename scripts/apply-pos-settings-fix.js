...
async function applyMigration() {
  console.log('🚀 Starting POS Settings migration...');
...
async function createTablesDirectly() {
  console.log('🚀 Creating POS settings tables directly...');
  ...
  try {
    ...
    console.log('🎉 All tables created and configured successfully!');
