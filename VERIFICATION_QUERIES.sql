...
-- =====================================================
-- ⚠️  DO NOT RUN THIS FILE AS A MIGRATION!
-- These are example queries for manual testing only.
-- Copy individual queries and replace 'YOUR_PO_ID_HERE' with your actual PO UUID
-- 
-- Example: Replace 'YOUR_PO_ID_HERE' with something like:
