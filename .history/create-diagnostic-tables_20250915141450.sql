...
-- This script creates the missing diagnostic_requests and diagnostic_devices tables
...
CREATE POLICY IF NOT EXISTS "Enable all access for authenticated users" ON diagnostic_requests
    FOR ALL USING (auth.role() = 'authenticated');

CREATE POLICY IF NOT EXISTS "Enable all access for authenticated users" ON diagnostic_devices
    FOR ALL USING (auth.role() = 'authenticated');
