...
-- This ensures the function is available for the PurchaseOrderPaymentDashboard
...
SELECT 'process_purchase_order_payment function created successfully' as status;
