-- =====================================================
-- COMPLETE QUALITY CHECK SYSTEM FIX
-- This script fixes all quality check database issues
-- =====================================================

-- =====================================================
-- STEP 1: CREATE QUALITY CHECK TEMPLATES TABLE
-- =====================================================
...
-- =====================================================
-- STEP 2: CREATE QUALITY CHECK CRITERIA TABLE
-- =====================================================
...
-- =====================================================
-- STEP 3: CREATE PURCHASE ORDER QUALITY CHECKS TABLE
-- =====================================================
...
-- =====================================================
-- STEP 4: CREATE PURCHASE ORDER QUALITY CHECK ITEMS TABLE
-- =====================================================
...
-- =====================================================
-- STEP 8: INSERT DEFAULT TEMPLATES AND CRITERIA
-- =====================================================
