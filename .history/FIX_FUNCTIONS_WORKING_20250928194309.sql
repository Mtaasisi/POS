-- =====================================================
-- WORKING FUNCTIONS WITH FULL FUNCTIONALITY
-- =====================================================
-- This script creates the final working functions
...
-- Step 2: Create working get_purchase_order_items_with_products function
...
BEGIN
    ...
    SELECT 
        ...
        poi.created_at,
        poi.updated_at,
        -- Product details with safe defaults
        ...
        -- Variant details with safe defaults
...
-- Step 3: Create working get_received_items_for_po function
...
SELECT 'Testing working functions...' as message;
...
SELECT 
    'Sample data from get_purchase_order_items_with_products' as info,
    id,
    product_name,
    quantity,
    unit_cost,
...
SELECT 'Working functions created and tested successfully!' as message;
