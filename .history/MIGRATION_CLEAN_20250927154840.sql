...
-- Create RLS policies
CREATE POLICY IF NOT EXISTS "Enable all access for lats_purchase_order_items" ON lats_purchase_order_items FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Enable all access for inventory_items" ON inventory_items FOR ALL USING (true);
