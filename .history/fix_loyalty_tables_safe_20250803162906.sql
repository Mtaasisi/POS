-- Fix Loyalty Program Tables (Safe Version)
-- This script safely creates loyalty-related tables and handles existing policies
...
-- 9. Create triggers for updated_at (drop if exists first)
