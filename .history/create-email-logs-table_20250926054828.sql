...
INSERT INTO email_logs (to_email, subject, content, status, sent_at, user_id) VALUES
('test@example.com', 'Welcome to LATS CHANCE', 'Thank you for joining us!', 'sent', NOW(), auth.uid())
ON CONFLICT DO NOTHING;

-- Verify the table was created successfully
SELECT 
    'Email logs table created successfully' as status,
    COUNT(*) as total_logs
FROM email_logs;
