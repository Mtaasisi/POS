-- =====================================================
-- FINAL FIX FOR REPAIR PAYMENTS SYSTEM
-- =====================================================
-- This version avoids all syntax errors
...
-- 8. Add unique constraint on name column (without IF NOT EXISTS)
DO $$
BEGIN
...
-- 9. Insert default finance accounts with proper ON CONFLICT handling
