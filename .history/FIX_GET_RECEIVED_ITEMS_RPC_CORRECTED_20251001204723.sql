...
-- This script creates the corrected RPC function for getting received items
...
SELECT 'Corrected get_received_items_for_po RPC function created successfully!' as status;
