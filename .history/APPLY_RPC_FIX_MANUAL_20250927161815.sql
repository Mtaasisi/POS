-- MANUAL RPC FIX FOR PURCHASE ORDER PAYMENT
-- Run this SQL directly in your Supabase SQL Editor
-- This fixes the 400 Bad Request error in process_purchase_order_payment

-- First, ensure the audit table has the correct schema
...
-- Now recreate the RPC function with proper error handling
...
--     'e2153365-6edb-4476-9951-ab474754b7c7'::UUID,
--     'deb92580-95dd-4018-9f6a-134b2157716c'::UUID,
--     2000.00,
--     'USD',
--     'Cash',
--     NULL,
