...
SELECT 
    ...
    CASE 
        ...
        THEN array_length(jsonb_object_keys(p.attributes), 1)
        ELSE 0
    END as spec_count
...
SELECT 
    ...
    CASE 
        ...
        THEN array_length(jsonb_object_keys(pv.attributes), 1)
        ELSE 0
...
WHERE p.is_active = true 
    ...
    AND p.attributes != '{}'
ORDER BY array_length(jsonb_object_keys(p.attributes), 1) DESC
LIMIT 5;
