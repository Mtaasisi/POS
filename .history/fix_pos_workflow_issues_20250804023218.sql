...
BEGIN
    ...
    RAISE NOTICE 'sales_orders table recreated successfully';
END $$;
...
BEGIN
    ...
    RAISE NOTICE 'locations table created/verified';
END $$;
...
BEGIN
    ...
    RAISE NOTICE 'installment_payments table created/verified';
END $$;
...
BEGIN
    ...
    RAISE NOTICE 'loyalty_customers table created/verified';
END $$;
...
RAISE NOTICE 'POS workflow fixes completed successfully!'; 