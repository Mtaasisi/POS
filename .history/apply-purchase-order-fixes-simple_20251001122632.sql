-- =====================================================
-- PURCHASE ORDER FIXES - SIMPLIFIED VERSION
-- =====================================================
-- This script applies only the essential fixes needed for purchase orders
...
-- Note: The log_purchase_order_audit function was skipped because there are
-- multiple versions in your database. The audit functionality will fall back
-- to direct inserts which work fine.
