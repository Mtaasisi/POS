...
async function importContacts() {
  ...
  try {
    ...
    // Process each row (limit to first 1000 for testing)
    console.log('\n🔄 Processing contacts (first 1000 only for testing)...\n');
    
    const maxRows = Math.min(1001, lines.length); // Process first 1000 contacts (plus header)
