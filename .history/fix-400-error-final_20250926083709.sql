...
SELECT 
    ...
    pv.barcode,
    pv.attributes,
    -- pv.price, (column doesn't exist)
    -- pv.cost, (column doesn't exist)
    -- pv.stock_quantity, (column doesn't exist)
    -- pv.min_stock_level, (column doesn't exist)
            ...
            json_build_object(
                ...
                'variant', CASE 
                    WHEN pv.id IS NOT NULL THEN json_build_object(
                        ...
                        -- 'price', pv.price, (column doesn't exist)
                        -- 'cost', pv.cost, (column doesn't exist)
                        -- 'stock_quantity', pv.stock_quantity, (column doesn't exist)
                        -- 'min_stock_level', pv.min_stock_level, (column doesn't exist)
                        -- 'is_active', pv.is_active, (column doesn't exist)
