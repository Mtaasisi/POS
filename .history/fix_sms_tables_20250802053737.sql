...
DROP POLICY IF EXISTS "Users can view all SMS logs" ON public.sms_logs;
DROP POLICY IF EXISTS "Users can insert SMS logs" ON public.sms_logs;
DROP POLICY IF EXISTS "Users can view all SMS triggers" ON public.sms_triggers;
DROP POLICY IF EXISTS "Users can insert SMS triggers" ON public.sms_triggers;
DROP POLICY IF EXISTS "Users can update their own SMS triggers" ON public.sms_triggers;
DROP POLICY IF EXISTS "Users can view all scheduled SMS" ON public.scheduled_sms;
DROP POLICY IF EXISTS "Users can insert scheduled SMS" ON public.scheduled_sms;
DROP POLICY IF EXISTS "Users can update their own scheduled SMS" ON public.scheduled_sms;
DROP POLICY IF EXISTS "Users can view all SMS trigger logs" ON public.sms_trigger_logs;
DROP POLICY IF EXISTS "Users can insert SMS trigger logs" ON public.sms_trigger_logs;
DROP POLICY IF EXISTS "Users can view all communication templates" ON public.communication_templates;
DROP POLICY IF EXISTS "Users can insert communication templates" ON public.communication_templates;
DROP POLICY IF EXISTS "Users can update their own communication templates" ON public.communication_templates;
