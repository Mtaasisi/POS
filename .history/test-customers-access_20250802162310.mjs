...
async function testCustomersAccess() {
  ...
  try {
    ...
    console.log(`✅ Customers table accessible. Total customers: ${countData.length || 0}`);
    ...
    console.log(`✅ Search test successful. Found ${searchResults.length} customers with 'a' in name or phone`);
