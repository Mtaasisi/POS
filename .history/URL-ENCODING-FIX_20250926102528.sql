-- URL ENCODING FIX
-- The exact solution for the 400 errors you're experiencing
-- The issue is URL encoding in Supabase query strings
...
-- const selectString = '*,customers(name%2Cphone%2Cemail)';
-- This URL-encodes commas as %2C, which Supabase doesn't handle properly

-- ✅ CORRECT (working solution):
-- const selectString = '*,customers(name,phone,email)';
...
-- Replace any URL-encoded commas with literal commas:
