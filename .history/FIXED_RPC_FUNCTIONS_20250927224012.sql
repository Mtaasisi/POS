-- CORRECTED RPC FUNCTIONS WITH PROPER COLUMN NAMES
-- This script fixes the column name issues in the RPC functions
...
-- Step 3: Create corrected get_po_inventory_stats function
...
-- Step 4: Create corrected get_received_items_for_po function
...
-- Success message
SELECT 'Corrected RPC functions have been created successfully!' as message;
