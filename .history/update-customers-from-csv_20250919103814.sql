-- Update existing customers with names and locations from CSV data
-- This script updates customers based on phone number matching

-- First, let's create a temporary table to hold the cleaned CSV data
...
-- Show summary of data to be processed
SELECT 
    'Summary of customer data to be processed:' as info,
    COUNT(*) as total_records,
    COUNT(DISTINCT phone) as unique_phones,
    COUNT(DISTINCT name) as unique_names
FROM temp_customer_data;

-- Show customers that will be updated (existing customers with phone numbers)
SELECT 
