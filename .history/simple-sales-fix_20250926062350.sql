...
-- 4. Make customer_id nullable (to allow walk-in customers)
...
-- 8. Create or find walk-in customer
DO $$
DECLARE
...
BEGIN
    ...
    IF walk_in_customer_id IS NULL THEN
        ...
        BEGIN
            INSERT INTO customers (name, phone, email, created_by)
            VALUES ('Walk-in Customer', '+255000000000', 'walkin@lats.com', 'System')
            RETURNING id INTO walk_in_customer_id;
            RAISE NOTICE 'Created walk-in customer with ID: %', walk_in_customer_id;
        EXCEPTION WHEN OTHERS THEN
            -- Try with minimal fields if the above fails
            INSERT INTO customers (name, phone)
            VALUES ('Walk-in Customer', '+255000000000')
            RETURNING id INTO walk_in_customer_id;
