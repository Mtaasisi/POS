...
// Function to also import devices
async function importDevices(devices) {
  ...
  const normalizedDevices = devices.map(device => ({
    ...
    accessories_confirmed: device.accessories_confirmed || false,
    problem_confirmed: device.problem_confirmed || false,
    privacy_confirmed: device.privacy_confirmed || false,
    ...
    issue_confirmed: device.issue_confirmed || false,
    physical_check: device.physical_check || false
  }));
