-- =====================================================
-- FIX FUNCTIONS WITH MISSING COLUMNS
-- =====================================================
-- This script fixes the functions by removing references to non-existent columns
...
-- Step 2: Create corrected get_purchase_order_items_with_products function
-- Removed references to poi.status and other potentially missing columns
...
BEGIN
    ...
    SELECT 
        ...
        -- Use a default status since the column doesn't exist
        CASE 
...
-- Step 3: Create corrected get_received_items_for_po function
...
SELECT 'Testing corrected functions...' as message;

-- Test get_purchase_order_items_with_products
SELECT COUNT(*) as items_found FROM get_purchase_order_items_with_products('2f772843-d993-4987-adb4-393ab0bf718c'::UUID);

-- Test get_received_items_for_po  
SELECT COUNT(*) as received_found FROM get_received_items_for_po('2f772843-d993-4987-adb4-393ab0bf718c'::UUID);

SELECT 'Functions corrected and tested successfully!' as message;
