...
-- This avoids the "function name is not unique" error completely
...
COMMENT ON FUNCTION add_quality_items_to_inventory_v2 IS 'Adds quality-checked items to inventory with selling prices. New function to avoid naming conflicts.';

SELECT 'Successfully created add_quality_items_to_inventory_v2 function!' as status;
