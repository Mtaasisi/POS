-- Create spare part variants table (Simplified version)
...
CREATE INDEX idx_spare_part_variants_sku ON lats_spare_part_variants(sku);
CREATE INDEX idx_spare_part_variants_created_at ON lats_spare_part_variants(created_at);
...
COMMENT ON COLUMN lats_spare_part_variants.variant_attributes IS 'JSON object storing variant-specific attributes and specifications';
COMMENT ON COLUMN lats_spare_part_variants.image_url IS 'URL of the variant image';
