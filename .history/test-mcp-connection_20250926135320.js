...
async function testConnection() {
  try {
    ...
    // Test 4: List all tables (using RPC function)
    console.log('\n📋 Available tables:');
    try {
      ...
      if (tablesError) {
        ...
        // Alternative: Test known tables
        const knownTables = ['customers', 'lats_products', 'lats_sales', 'lats_product_variants', 'employees'];
        console.log('✅ Known database tables:');
