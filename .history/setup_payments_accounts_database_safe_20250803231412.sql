...
-- RLS Policies for finance_accounts (simplified - allow all authenticated users)
...
-- RLS Policies for payment_methods (simplified - allow all authenticated users)
...
-- RLS Policies for payment_method_accounts (simplified - allow all authenticated users)
...
-- RLS Policies for payment_transactions (simplified - allow all authenticated users)
...
-- RLS Policies for account_balance_history (simplified - allow all authenticated users)
