...
-- Add cost column to sms_logs table if it doesn't exist
ALTER TABLE public.sms_logs ADD COLUMN IF NOT EXISTS cost DECIMAL(10,4);
...
BEGIN
    ...
    RAISE NOTICE '📊 Tables added: sms_triggers, scheduled_sms, sms_trigger_logs, communication_templates';
