...
-- =====================================================
-- This function receives quality-checked items to inventory
-- by creating inventory records for passed items
    ...
    FOR v_qc_item IN (
        ...
        BEGIN
            ...
            IF v_uses_serial THEN
                -- For serialized items, create individual inventory items
                -- This would require serial numbers to be entered separately
                -- For now, we'll create a single adjustment record
