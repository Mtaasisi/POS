-- Update ALL Customers from Call Log
-- This script processes the complete call log and updates all customers with matching phone numbers
...
WITH call_data AS (
    SELECT 
        ...
        -- Standardize phone number format - ensure it starts with +255
        CASE 
        ...
        -- Parse duration to minutes (simplified version)
        CASE 
...
-- Step 3: Show customers that will be updated
SELECT 
