...
-- =====================================================
-- FIX PURCHASE ORDER PAYMENTS RLS POLICY ISSUE
-- =====================================================

-- Drop existing restrictive policies on purchase_order_payments
...
CREATE POLICY "Enable all access for authenticated users" ON purchase_order_payments
    FOR ALL USING (auth.role() = 'authenticated');

-- Grant all permissions to authenticated users
GRANT ALL ON purchase_order_payments TO authenticated;

-- Also ensure lats_purchase_orders has permissive policies for the join to work
...
-- Ensure lats_suppliers has permissive policies for the nested join to work
