...
async function importContacts() {
  ...
  try {
    ...
    // Process each row (limit to first 10 for testing)
    console.log('\n🔄 Processing contacts (first 10 only for testing)...\n');
    
    const maxRows = Math.min(11, lines.length); // Process first 10 contacts (plus header)
