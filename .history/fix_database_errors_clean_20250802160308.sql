-- Fix Database Errors - Clean Version
...
-- 14. Insert sample data for testing (only if tables are empty)
...
INSERT INTO inventory_categories (name, description, color)
SELECT 'Parts', 'Replacement parts and accessories', '#10B981'
WHERE NOT EXISTS (SELECT 1 FROM inventory_categories WHERE name = 'Parts');

INSERT INTO inventory_categories (name, description, color)
SELECT 'Accessories', 'Device accessories and add-ons', '#F59E0B'
WHERE NOT EXISTS (SELECT 1 FROM inventory_categories WHERE name = 'Accessories');
...
INSERT INTO suppliers (name, contact_person, email, phone, city)
SELECT 'MobileParts Kenya', 'Jane Smith', 'jane@mobileparts.co.ke', '+254700000002', 'Mombasa'
WHERE NOT EXISTS (SELECT 1 FROM suppliers WHERE name = 'MobileParts Kenya');

INSERT INTO suppliers (name, contact_person, email, phone, city)
SELECT 'Generic Supplies', 'Mike Johnson', 'mike@genericsupplies.com', '+254700000003', 'Kisumu'
WHERE NOT EXISTS (SELECT 1 FROM suppliers WHERE name = 'Generic Supplies');
