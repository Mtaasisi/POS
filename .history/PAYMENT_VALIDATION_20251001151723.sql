...
OR table_name = 'lats_purchase_order_payments'
...
SELECT 
    CASE 
        ...
        WHEN EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'lats_purchase_order_payments') 
        THEN 'lats_purchase_order_payments'
...
WITH payment_table AS (
    ...
    UNION ALL
    SELECT 'lats_purchase_order_payments'
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'lats_purchase_order_payments')
    LIMIT 1
)
SELECT 
