...
async function importContacts() {
  ...
  try {
    ...
    // Process each row (limit to first 20 for testing)
    console.log('\n🔄 Processing contacts (first 20 only for testing)...\n');
    
    const maxRows = Math.min(21, lines.length); // Process first 20 contacts (plus header)
