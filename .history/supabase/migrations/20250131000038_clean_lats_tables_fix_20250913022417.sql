-- Clean LATS tables fix - handles existing triggers and tables
-- Migration: 20250131000038_clean_lats_tables_fix.sql
...
-- Create lats_products table if it doesn't exist
...
-- Create lats_product_variants table if it doesn't exist
...
BEGIN
    ...
    RAISE NOTICE '✅ Clean LATS tables fix completed successfully!';
