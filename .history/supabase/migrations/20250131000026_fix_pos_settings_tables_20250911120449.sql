-- Fix POS settings tables - ensure they exist with proper permissions
-- Migration: 20250131000026_fix_pos_settings_tables.sql
...
-- Create permissive policy for lats_pos_receipt_settings (drop existing first)
