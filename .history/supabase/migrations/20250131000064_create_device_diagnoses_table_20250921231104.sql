...
-- This table is used by DiagnosisModal.tsx to store diagnosis data
...
COMMENT ON TABLE device_diagnoses IS 'Stores device diagnosis results from DiagnosisModal';
