-- Migrate Items and Received Tabs Functionality
-- Migration: 20250131000070_migrate_items_received_tabs.sql
-- This migration ensures proper functionality for items and received tabs in purchase order details
