...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_updated_at_column') THEN
        ...
        RAISE NOTICE 'Created update_diagnostic_checklist_results_updated_at trigger';
    ELSE
        RAISE NOTICE 'update_updated_at_column function not found, skipping trigger creation';
    END IF;
EXCEPTION
    WHEN duplicate_object THEN
        RAISE NOTICE 'Trigger update_diagnostic_checklist_results_updated_at already exists';
    WHEN OTHERS THEN
