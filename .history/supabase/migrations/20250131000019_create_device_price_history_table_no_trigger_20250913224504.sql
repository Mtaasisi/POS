-- Create device_price_history table for tracking price changes (No Trigger Version)
-- Migration: 20250131000019_create_device_price_history_table_no_trigger.sql
...
INSERT INTO device_price_history (
    ...
    (SELECT id FROM devices LIMIT 1), -- Use first device if exists
    0,
    1000,
    'Test price history entry',
    'manual',
    'system',
    '{"test": true}'::jsonb
