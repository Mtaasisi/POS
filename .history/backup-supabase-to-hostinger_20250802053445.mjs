...
const config = {
  supabase: {
    url: process.env.VITE_SUPABASE_URL || 'https://jxhzveborezjhsmzsgbc.supabase.co',
    anonKey: process.env.VITE_SUPABASE_ANON_KEY,
    serviceRoleKey: process.env.SUPABASE_SERVICE_ROLE_KEY, // You'll need to add this to your ENVs
  },
  hostinger: {
    apiUrl: process.env.HOSTINGER_API_URL || 'https://api.hostinger.com/v1',
    apiToken: process.env.HOSTINGER_API_TOKEN,
    storagePath: process.env.HOSTINGER_STORAGE_PATH || '/backups/supabase',
  },
  backup: {
    retentionDays: parseInt(process.env.BACKUP_RETENTION_DAYS) || 30,
    maxFileSize: parseInt(process.env.MAX_BACKUP_SIZE_MB) || 100, // MB
    compressBackups: process.env.COMPRESS_BACKUPS !== 'false',
  }
};
