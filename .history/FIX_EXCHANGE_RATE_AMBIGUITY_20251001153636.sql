-- FIX: Column reference "exchange_rate" is ambiguous
-- This script removes the ambiguous exchange_rate variable declaration
...
-- Success message
SELECT 'Function fixed successfully! The exchange_rate ambiguity has been resolved.' as status;
