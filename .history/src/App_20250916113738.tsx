...
import { DeviceRepairPage } from './features/repair/pages/DeviceRepairPage';
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="/repair" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care', 'technician']}><Suspense fallback={<PageLoadingSpinner />}><DeviceRepairPage /></Suspense></RoleProtectedRoute>} />
          <Route path="/repair/simple" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care', 'technician']}><Suspense fallback={<PageLoadingSpinner />}><SimpleRepairPage /></Suspense></RoleProtectedRoute>} />
