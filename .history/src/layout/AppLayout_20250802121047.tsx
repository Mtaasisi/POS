  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'transparent' }}>
      ...
      <div
        ...
        original-theme:bg-white/80 original-theme:border-gray-200 dark-theme:bg-white/10 dark-theme:border-white/20 backdrop-blur-xl shadow-xl
      ...
      >
        <div className="flex flex-col h-full">
          {/* Sidebar Header */}
          <div className={`
            p-6 border-b original-theme:border-gray-200 dark-theme:border-white/20 flex items-center original-theme:bg-white/20 dark-theme:bg-white/10
                  ...
                  <Link
                    ...
                    className={`
                      ...
                      ${location.pathname === item.path
                        ? 'original-theme:bg-gradient-to-r original-theme:from-blue-500/10 original-theme:to-indigo-500/10 original-theme:text-blue-700 original-theme:font-medium original-theme:shadow-sm original-theme:backdrop-blur-sm original-theme:border original-theme:border-blue-200/30 dark-theme:bg-gradient-to-r dark-theme:from-blue-500/20 dark-theme:to-indigo-500/20 dark-theme:text-white dark-theme:font-medium dark-theme:shadow-sm dark-theme:backdrop-blur-sm dark-theme:border dark-theme:border-blue-300/30'
                        : 'original-theme:text-gray-700 original-theme:hover:bg-white/40 original-theme:hover:text-gray-900 dark-theme:text-white dark-theme:hover:bg-white/20 dark-theme:hover:text-white'
                      }
                    `}
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <span className={`
                      ${location.pathname === item.path ? 'original-theme:text-blue-600 dark-theme:text-blue-300' : 'original-theme:text-blue-500 dark-theme:text-blue-200'}
                    ...
                    {location.pathname === item.path && (
                      <ChevronRightIcon size={16} className={`
                        ml-auto original-theme:text-blue-500 dark-theme:text-blue-300
          ...
          <div className={`${isNavCollapsed ? 'p-2' : 'p-4'} border-t border-white/20`}>
            <div className={`
              ...
              original-theme:bg-gradient-to-br original-theme:from-gray-100 original-theme:to-gray-50 dark-theme:bg-white/10 backdrop-blur-sm mb-4 
              ${isNavCollapsed ? 'justify-center' : ''}
            `}>
              ...
              <div className={`transition-opacity duration-300 ${isNavCollapsed ? 'md:hidden' : ''} min-w-0 flex-1`}>
                <p className="font-medium original-theme:text-gray-900 dark-theme:text-white truncate">{currentUser.name}</p>
                <p className="text-sm original-theme:text-gray-600 dark-theme:text-gray-300 capitalize truncate">{currentUser.role.replace('-', ' ')}</p>
              </div>
            </div>
