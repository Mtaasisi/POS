    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="/ad-generator" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><Suspense fallback={<PageLoadingSpinner />}><ProductAdGeneratorPage /></Suspense></RoleProtectedRoute>} />
