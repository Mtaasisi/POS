    ...
    try {
      ...
      if (data && data.length > 0) {
        console.log('🔍 Sample device data:', {
          ...
          brand: data[0].brand,
          model: data[0].model,
          unlock_code: data[0].unlock_code,
          repair_cost: data[0].repair_cost,
          deposit_amount: data[0].deposit_amount,
          diagnosis_required: data[0].diagnosis_required,
          device_notes: data[0].device_notes,
          device_cost: data[0].device_cost,
          estimated_hours: data[0].estimated_hours,
          device_condition: data[0].device_condition,
        });
      }
