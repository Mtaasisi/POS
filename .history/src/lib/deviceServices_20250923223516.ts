...
export const deviceServices = {
  ...
  async addPaymentRecord(paymentData: {
    ...
    try {
      console.log('🔧 DeviceServices: Adding payment record...');
      console.log('📊 Input payment data:', JSON.stringify(paymentData, null, 2));
      ...
      if (!paymentData.amount || paymentData.amount <= 0) {
        ...
        throw new Error('Valid amount is required for payment record');
      }
      ...
      // 3. Prepare payment data with authenticated user ID
      console.log('🔍 Step 3: Preparing enhanced payment data...');
      ...
      console.log('📤 Enhanced payment data to insert:', JSON.stringify(enhancedPaymentData, null, 2));
      console.log('📋 Data types:', {
        customer_id: typeof enhancedPaymentData.customer_id,
        amount: typeof enhancedPaymentData.amount,
        method: typeof enhancedPaymentData.method,
        device_id: typeof enhancedPaymentData.device_id,
        payment_type: typeof enhancedPaymentData.payment_type,
        status: typeof enhancedPaymentData.status,
        currency: typeof enhancedPaymentData.currency,
        payment_date: typeof enhancedPaymentData.payment_date,
        created_by: typeof enhancedPaymentData.created_by
      });
      ...
      if (error) {
        ...
        if (error.message.includes('violates foreign key constraint')) {
          ...
          console.error('💡 Check if customer_id exists in customers table');
        }
      ...
      console.log('📊 Created payment:', JSON.stringify(data, null, 2));
