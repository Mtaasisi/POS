...
export interface Brand {
  ...
  description?: string;
  logo_url?: string;
  category?: BrandCategory[] | string[] | string; // JSONB array or string for backward compatibility
  categories?: BrandCategory[] | string[] | string; // For backward compatibility
  is_active: boolean;
  created_at: string;
  updated_at: string;
}
