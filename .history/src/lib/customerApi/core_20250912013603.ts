  ...
  try {
    ...
    if (error) {
      ...
      if (error.code === '23505') { // Unique constraint violation
        ...
        throw new Error('Invalid reference data. Please check your input and try again.');
      ...
      } else if (error.code === 'PGRST116') { // Row Level Security violation
        ...
        throw new Error('Database service is temporarily unavailable. Please try again in a few minutes.');
      } else {
