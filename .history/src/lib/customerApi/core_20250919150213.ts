...
import { retryWithBackoff, isNetworkError, withTimeoutAndRetry } from '../../utils/networkErrorHandler';
...
export async function fetchAllCustomersSimple() {
  console.log('🚀 fetchAllCustomersSimple function called - starting execution');
