...
import { 
  ...
  Settings, ShoppingCart, Shield, Zap
} from 'lucide-react';
...
const EnhancedPaymentManagementPage: React.FC = () => {
  ...
  // Real-time subscriptions for repair shop payment monitoring
  useEffect(() => {
    ...
    const paymentsSubscription = supabase
      .channel('repair-shop-payment-management')
      ...
      .subscribe((status) => {
        console.log('📡 Repair shop payment management subscription status:', status);
            ...
            <div className="mb-6">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-4">
                  ...
                  <div className="text-lg font-bold text-blue-900">{formatMoney(metrics.completedAmount)}</div>
                </div>
