          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            {activeTab === 'tracking' && (
              <div>
                ...
                <p className="text-gray-600">Payment tracking functionality will be loaded here.</p>
              </div>
            )}
            {activeTab === 'providers' && (
              <div>
            ...
            {activeTab === 'purchase-orders' && (
              <div>
                ...
                <p className="text-gray-600">Purchase order payment management will be loaded here.</p>
              </div>
            )}
          </div>
        </div>
