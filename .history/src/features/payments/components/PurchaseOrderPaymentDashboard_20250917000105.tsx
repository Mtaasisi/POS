    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">Manage supplier payments and track purchase orders</p>
        </div>
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors text-xs font-medium"
                >
                  <Plus size={14} />
                  Pay
                </button>
      ...
      {/* Recent Payments - Matching PurchaseOrderDetailPage style */}
