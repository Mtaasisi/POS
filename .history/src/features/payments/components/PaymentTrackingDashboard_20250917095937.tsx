...
const PaymentTrackingDashboard: React.FC<PaymentTrackingDashboardProps> = ({
  ...
  const fetchPaymentData = useCallback(async () => {
    ...
    try {
      ...
      if (enhancedTransactionsData.status === 'fulfilled') {
        setAvailableCurrencies(enhancedTransactionsData.value);
        console.log(`✅ Fetched ${enhancedTransactionsData.value.length} available currencies`);
      } else {
        console.error('Failed to fetch available currencies:', enhancedTransactionsData.reason);
      }
