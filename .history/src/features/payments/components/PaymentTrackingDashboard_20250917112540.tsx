  ...
  const fetchPaymentData = useCallback(async () => {
    ...
    try {
      ...
      const [
        ...
        supabase.from('customer_payments').select('*').order('created_at', { ascending: false }).limit(100),
        supabase.from('purchase_order_payments').select('*').order('created_at', { ascending: false }).limit(100),
        supabase.from('device_payments').select('*').order('created_at', { ascending: false }).limit(100),
        supabase.from('repair_payments').select('*').order('created_at', { ascending: false }).limit(100),
