              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                ...
                <div className="space-y-2">
                  {latestTransactions.map((payment) => {
                    ...
                    return (
                      <div key={payment.id} className={`group relative bg-white border-l-4 ${statusConfig.border} ${statusConfig.bg} rounded-lg shadow-sm hover:shadow-md transition-all duration-200`}>
                        <div className="p-4">
                          <div className="flex items-start justify-between">
                            <div className="flex items-start space-x-3 flex-1">
                              {/* Status indicator */}
                              <div className="flex-shrink-0 mt-1">
                                <div className={`w-3 h-3 ${statusConfig.dot} rounded-full ${payment.status === 'pending' ? 'animate-pulse' : ''}`}></div>
                              </div>
                  ...
                  {latestTransactions.length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <div className="text-gray-600 font-medium mb-1">No recent transactions</div>
                      <div className="text-sm text-gray-400">Transactions will appear here once they're processed</div>
                    </div>
                  )}
                </div>
              </div>
