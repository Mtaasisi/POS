            ...
            <GlassCard className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm text-gray-600">
                  <div>Revenue Growth: {financialAnalytics.summary.revenueGrowth.toFixed(1)}%</div>
                  <div>Expense Growth: {financialAnalytics.summary.expenseGrowth.toFixed(1)}%</div>
                  <div>Profit Growth: {financialAnalytics.summary.profitGrowth.toFixed(1)}%</div>
                </div>
              </div>
            </GlassCard>
          )}
          ...
          {paymentInsights && (
            <GlassCard className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm text-gray-600">
                  <div>Success Rate: {paymentInsights.successRate.toFixed(1)}%</div>
                  <div>Failure Rate: {paymentInsights.failureRate.toFixed(1)}%</div>
                  <div>Refund Rate: {paymentInsights.refundRate.toFixed(1)}%</div>
                </div>
              </div>
            </GlassCard>
          )}
              ...
              <div key={provider.id} className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{provider.performance.successRate.toFixed(1)}%</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{provider.performance.uptime.toFixed(1)}%</span>
                  </div>
                </div>
              </div>
            ))}
