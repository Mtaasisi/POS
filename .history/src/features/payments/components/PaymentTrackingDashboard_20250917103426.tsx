    ...
    <div className="space-y-6">
      ...
      {paymentProviders.length > 0 && (
        <GlassCard className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Payment Providers Summary</h3>
              <p className="text-sm text-gray-600">Quick overview of provider performance</p>
            </div>
            <button
          ...
          <div className="space-y-2">
            {paymentProviders.slice(0, 3).map((provider) => {
              const getProviderIcon = (type: string) => {
                switch (type) {
                  case 'mobile_money': return <Smartphone className="w-4 h-4 text-blue-600" />;
                  case 'card': return <CreditCard className="w-4 h-4 text-green-600" />;
                  case 'bank': return <Building className="w-4 h-4 text-purple-600" />;
                ...
                <div key={provider.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-600 capitalize">{provider.type.replace('_', ' ')}</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
            ...
            {paymentProviders.length > 3 && (
              <div className="text-center py-2">
                <button className="text-sm text-blue-600 hover:text-blue-800 font-medium">
                  View all {paymentProviders.length} providers →
                </button>
              </div>
            )}
          </div>
