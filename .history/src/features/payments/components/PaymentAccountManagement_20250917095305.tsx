...
const PaymentAccountManagement: React.FC = () => {
  ...
  const summaryStats = React.useMemo(() => {
    ...
    const totalReceived = accounts.reduce((sum, account) => sum + account.totalReceived, 0);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {accounts.map((account) => (
          <GlassCard key={account.id} className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
