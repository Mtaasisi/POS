              ...
              <div key={index} className="bg-white rounded-lg border border-blue-200 p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900 capitalize text-lg">{payment.method}</div>
                      <div className="text-sm text-gray-600">
                        Payment #{index + 1} of {transaction.metadata.paymentMethod.details.payments.length}
                      </div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-xl font-bold text-blue-900">{formatMoney(payment.amount, transaction.currency)}</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                  {payment.accountId && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">{payment.accountId.slice(0, 8)}...</span>
                    </div>
                  )}
                  {payment.reference && (
                    <div className="flex justify-between">
                  ...
                  {payment.cardLast4 && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">****{payment.cardLast4}</span>
                    </div>
                  )}
                  {payment.mobileNumber && (
                    <div className="flex justify-between">
                      <span className="text-gray-600">Mobile:</span>
                      <span className="font-medium text-gray-900">{payment.mobileNumber}</span>
                    </div>
                  )}
                  {payment.bankName && (
                    <div className="flex justify-between">
      ...
      <div className="flex gap-4">
        {transaction.status === 'pending' && (
          <>
            ...
            <GlassButton
              onClick={() => handlePaymentAction('stop')}
