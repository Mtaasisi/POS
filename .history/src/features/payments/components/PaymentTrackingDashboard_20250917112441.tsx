...
const PaymentTrackingDashboard: React.FC<PaymentTrackingDashboardProps> = ({
  ...
  const chartData = useMemo(() => {
    ...
    const methodsData = methodSummary.map(method => ({
      name: method.method.charAt(0).toUpperCase() + method.method.slice(1).replace('_', ' '),
  ...
  }, [dailySummary, methodSummary, metrics, payments]);
