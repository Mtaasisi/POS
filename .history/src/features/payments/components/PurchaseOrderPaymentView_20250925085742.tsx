        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              {selectedPayment.metadata?.paymentMethod?.type === 'multiple' && selectedPayment.metadata.paymentMethod.details?.payments && (
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl border border-blue-200 p-6">
                  ...
                  <div className="space-y-4">
                    {selectedPayment.metadata.paymentMethod.details.payments.map((payment: any, index: number) => (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="text-center">
                          ...
                          <div className="text-lg font-semibold text-blue-900">
                            {selectedPayment.metadata.paymentMethod.details.payments.length}
                          </div>
                        </div>
                        <div className="text-center">
                          <div className="text-sm text-gray-600">Payment Methods</div>
                          <div className="text-lg font-semibold text-blue-900">
                            {new Set(selectedPayment.metadata.paymentMethod.details.payments.map((p: any) => p.method)).size}
                          </div>
                        </div>
                        <div className="text-center">
                          ...
                          <div className="text-xl font-bold text-green-600">
                            {formatMoney(
                              selectedPayment.metadata.paymentMethod.details.payments.reduce((sum: number, p: any) => sum + p.amount, 0)
                            )}
                          </div>
                        </div>
                      </div>
