...
const LATS_PERMISSIONS: Permission[] = [
  ...
  { resource: 'inventory', action: 'view', roles: ['admin', 'technician'] },
  ...
  // Categories
  { resource: 'categories', action: 'view', roles: ['admin', 'technician'] },
  ...
  // Brands
  { resource: 'brands', action: 'view', roles: ['admin', 'technician'] },
...
const LATS_ROUTE_PERMISSIONS: RoutePermission[] = [
  ...
  { path: '/lats/inventory/products/:id', roles: ['admin', 'technician'] },
