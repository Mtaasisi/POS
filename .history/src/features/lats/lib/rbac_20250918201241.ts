...
const LATS_PERMISSIONS: Permission[] = [
  ...
  // POS
  { resource: 'pos', action: 'view', roles: ['admin'] },
  { resource: 'pos', action: 'sell', roles: ['admin'] },
  { resource: 'pos', action: 'refund', roles: ['admin'] },
  { resource: 'pos', action: 'void', roles: ['admin'] },

  // POS Inventory
  { resource: 'pos-inventory', action: 'view', roles: ['admin'] },
  { resource: 'pos-inventory', action: 'search', roles: ['admin'] },
  { resource: 'pos-inventory', action: 'add-to-cart', roles: ['admin'] },

  // Sales
  { resource: 'sales', action: 'view', roles: ['admin'] },
  { resource: 'sales', action: 'create', roles: ['admin'] },
...
const LATS_ROUTE_PERMISSIONS: RoutePermission[] = [
  ...
  // POS routes
  { path: '/lats/pos-inventory', roles: ['admin'] },
  { path: '/lats/pos', roles: ['admin'] }
];
