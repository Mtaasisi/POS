...
export const useDynamicGrid = (options: UseDynamicGridOptions = {}) => {
  ...
  const getGridClasses = useCallback(() => {
    ...
    // Generate responsive classes based on calculated columns with progressive scaling
    ...
    if (columns <= 8) return `${baseClasses} grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-7 4xl:grid-cols-8`;
