  ...
  const handleQualityCheckComplete = async () => {
    ...
    try {
      ...
      switch (purchaseOrder.status) {
        case 'received':
          // After quality check, move to 'quality_checked'
        ...
        case 'completed':
          ...
          break;
        case 'cancelled':
          // Cannot perform quality check on cancelled orders
