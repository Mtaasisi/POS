...
const PurchaseOrdersPage: React.FC = () => {
  ...
  // Smart action buttons - only show relevant actions based on status
  const getSmartActionButtons = (order: any) => {
    ...
    switch (order.status) {
      ...
      case 'received':
        // No additional actions needed for received orders
        break;
      
      case 'cancelled':
        // No additional actions needed for cancelled orders
        break;
    }
