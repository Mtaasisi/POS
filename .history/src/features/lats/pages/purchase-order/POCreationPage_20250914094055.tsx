...
const POCreationPage: React.FC = () => {
  ...
  const handleCreatePurchaseOrder = useCallback(async () => {
    try {
      ...
      // Only include shipping info if it has meaningful data
      const hasShippingData = shippingInfo.shippingAddress || 
                             shippingInfo.shippingMethod !== 'standard' || 
                             shippingInfo.trackingNumber || 
                             shippingInfo.carrier !== 'DHL' ||
                             shippingInfo.estimatedCost > 0;
      ...
      const purchaseOrderData = {
        ...
        // Only include shipping info if there's actual data
        ...(hasShippingData && {
          shippingInfo: {
            ...
            contact: shippingInfo.shippingContact,
