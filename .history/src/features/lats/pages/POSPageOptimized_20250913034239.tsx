        ...
        onPaymentComplete={async (payments, totalPaid) => {
          try {
            ...
            if (result.success) {
              ...
              // Show success message
              toast.success(`Payment of ${totalPaid.toLocaleString()} TZS processed successfully! Sale #${result.sale?.saleNumber}`);
            ...
            if (error instanceof Error) {
              ...
              if (isCriticalError) {
                ...
                toast.success(`Payment of ${totalPaid.toLocaleString()} TZS processed successfully!`);
                setShowPaymentModal(false);
              }
            } else {
