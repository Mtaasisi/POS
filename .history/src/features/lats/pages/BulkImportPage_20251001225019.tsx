...
// Lazy load the BulkProductImport component to avoid circular dependencies
const BulkProductImport = React.lazy(() => import('../components/product/BulkProductImport'));
