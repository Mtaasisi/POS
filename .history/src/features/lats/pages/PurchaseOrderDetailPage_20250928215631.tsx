...
const PurchaseOrderDetailPage: React.FC<PurchaseOrderDetailPageProps> = ({ editMode = false }) => {
  ...
  const handleSubmitForApproval = async (notes: string) => {
    ...
    try {
      const response = await PurchaseOrderService.submitForApproval(purchaseOrder.id, currentUser?.id || '', notes);
      if (response.success) {
        await loadPurchaseOrder();
                    ...
                    <div className="space-y-2">
                      {isEditing ? (
                        ...
                        <>
                            ...
                            <>
                              <div className="grid grid-cols-2 gap-3">
                                <button
                                  ...
                                  className="flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium text-sm"
                                >
                                  <Edit className="w-4 h-4" />
                                  Edit Order
                                </button>
                                <button
                                  ...
                                  className="flex items-center justify-center gap-2 px-4 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors font-medium text-sm"
                                >
                              ...
                              <div className="grid grid-cols-3 gap-2 mt-3">
                                <button
                                  ...
                                  className="flex items-center justify-center gap-2 px-3 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors font-medium text-xs"
                                >
                                ...
                                <button
                                  ...
                                  className="flex items-center justify-center gap-2 px-3 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors font-medium text-xs"
                                >
                                ...
                                <button
                                  ...
                                  className="flex items-center justify-center gap-2 px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors font-medium text-xs"
                                >
                            ...
                            <>
                              <div className="text-center py-4">
                                ...
                                <div className="grid grid-cols-2 gap-3 mb-4">
                                  ...
                                  <button
                                    onClick={() => setShowApprovalModal(true)}
                                    className="flex items-center justify-center gap-2 px-4 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors font-medium text-sm"
                                  >
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                  ...
                                  <button
                                    ...
                                    className="flex items-center justify-center gap-2 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium text-xs"
                                  >
                            ...
                            <>
                              ...
                              <div className="grid grid-cols-4 gap-2">
                                ...
                                <button
                                  ...
                                  className="flex items-center justify-center gap-2 px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors font-medium text-xs"
                                >
                          ...
                          {/* Step 4: Received/Quality Check - Can receive items */}
                          {(purchaseOrder.status === 'received' || purchaseOrder.status === 'quality_check') && (
                            <>
                              <div className="grid grid-cols-2 gap-3 mb-4">
                                <button
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                ...
                                <button
                                  ...
                                  className="flex items-center justify-center gap-2 px-3 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors font-medium text-xs"
                                >
                                  <Settings className="w-4 h-4" />
                                  Bulk Actions
                                </button>
                          ...
                          {/* Step 5: Other statuses - General actions */}
                          {!['draft', 'pending_approval', 'sent', 'confirmed', 'received', 'quality_check'].includes(purchaseOrder.status) && (
                            <>
            {/* Debug logging */}
