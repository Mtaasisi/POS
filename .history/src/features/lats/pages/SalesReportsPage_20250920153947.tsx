    ...
    <div className="min-h-screen p-6 bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <GlassCard className={`p-4 border-2 ${isDailyClosed ? 'bg-gradient-to-br from-gray-50 to-gray-100 border-gray-300' : 'bg-gradient-to-br from-orange-50 to-amber-100 border-orange-300'}`}>
          ...
          {!isDailyClosed && !canCloseDailySales && (
            <div className="w-full mt-3 p-3 bg-gray-100 border border-gray-200 rounded-lg text-center">
              <p className="text-sm text-gray-600">Daily closing requires customer care permissions</p>
            </div>
          )}
        </GlassCard>
      </div>
