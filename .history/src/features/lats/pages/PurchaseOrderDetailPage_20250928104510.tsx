...
const PurchaseOrderDetailPage: React.FC<PurchaseOrderDetailPageProps> = ({ editMode = false }) => {
  ...
  }, [id, purchaseOrder, refreshPurchaseOrderData]);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className={`flex items-center justify-between p-6 border-b ${isEditing ? 'border-blue-200 bg-blue-50' : 'border-gray-100'}`}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-500">
              ...
              Auto-refresh: {isBackgroundLoading ? 'Active' : 'Paused'}
            </div>
          </div>
          <button 
            onClick={() => navigate('/lats/purchase-orders')}
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          {activeTab === 'received' && (
            <div className="space-y-6">
              {/* Search and Filters - REMOVED: Component doesn't exist */}
                      ...
                      <tbody>
                        {filteredReceivedItems.map((item, index) => (
                          <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td className="p-3">
                              {/* REMOVED: InventoryItemActions component doesn't exist */}
        ...
        {/* Enhanced Inventory Management Modals - REMOVED: Components don't exist */}
        {/* <StatusUpdateModal
