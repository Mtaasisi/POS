              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="text-center p-3 bg-green-50 rounded-lg">
                    ...
                    <div className="text-lg font-bold text-green-900">{formatCurrency(purchaseOrder.totalAmount, 'TZS')}</div>
                  </div>
                  <div className="text-center p-3 bg-blue-50 rounded-lg">
                    <div className="text-xs font-medium text-blue-700 uppercase tracking-wide mb-1">Avg Cost/Unit</div>
                    <div className="text-lg font-bold text-blue-900">
                      {(() => {
                        const totalQuantity = purchaseOrder.items.reduce((sum, item) => sum + item.quantity, 0);
                        return formatCurrency(totalQuantity > 0 ? purchaseOrder.totalAmount / totalQuantity : 0, 'TZS');
                      })()}
                    </div>
                  </div>
                  ...
                  <div className="text-center p-3 bg-orange-50 rounded-lg">
                    <div className="text-xs font-medium text-orange-700 uppercase tracking-wide mb-1">Line Items</div>
