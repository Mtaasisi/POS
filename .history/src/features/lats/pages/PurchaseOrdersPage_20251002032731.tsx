...
import { 
  ...
  Clock, CheckSquare, Send, CheckCircle, CreditCard, Copy, PackageCheck
} from 'lucide-react';
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl p-4">
                      <div className="text-2xl font-bold text-green-900">
                        TSh {filteredOrders.reduce((sum: number, order: any) => {
                    ...
                    <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-4">
                      <div className="text-2xl font-bold text-orange-900">{filteredOrders.filter((order: any) => order.status === 'draft' || order.status === 'sent' || order.status === 'partial_received').length}</div>
                      <div className="text-xs font-medium text-orange-700 uppercase tracking-wide">Pending</div>
                    </div>
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-4">
                      <div className="text-2xl font-bold text-purple-900">{filteredOrders.filter((order: any) => order.status === 'received').length}</div>
