        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200/50 shadow-sm mb-8">
          <div className="p-6 border-b border-gray-200/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">More reporting and export options</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <button className="p-4 bg-white/50 rounded-xl border border-gray-200/50 hover:bg-white/80 hover:shadow-md transition-all duration-200 group">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-gray-600">Download as PDF</div>
                  </div>
                </div>
              </button>
              ...
              <button className="p-4 bg-white/50 rounded-xl border border-gray-200/50 hover:bg-white/80 hover:shadow-md transition-all duration-200 group">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="text-left">
                    <div className="font-semibold text-gray-900">Schedule Report</div>
                    <div className="text-xs text-gray-600">Auto-generate reports</div>
                  </div>
                </div>
              </button>
              ...
              <button className="p-4 bg-white/50 rounded-xl border border-gray-200/50 hover:bg-white/80 hover:shadow-md transition-all duration-200 group">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="text-left">
                    <div className="font-semibold text-gray-900">Email Report</div>
              ...
              <button className="p-4 bg-white/50 rounded-xl border border-gray-200/50 hover:bg-white/80 hover:shadow-md transition-all duration-200 group">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="text-left">
                    <div className="font-semibold text-gray-900">Report Settings</div>
                    <div className="text-xs text-gray-600">Configure reports</div>
                  </div>
                </div>
              </button>
            </div>
