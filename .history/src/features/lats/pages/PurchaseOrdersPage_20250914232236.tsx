  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'transparent' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoading ? (
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/30 p-12">
          ...
          <div className={viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6' : 'space-y-6'}>
            {filteredOrders.map((order) => (
              <div key={order.id} className="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/30 p-6 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 overflow-hidden relative">
                {/* Decorative Background */}
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-blue-100/20 to-transparent opacity-60 rounded-full -translate-y-16 translate-x-16"></div>
                ...
                <div className="relative flex justify-between items-start mb-6">
                  ...
                  <div className={`flex items-center gap-2 px-3 py-2 rounded-2xl text-sm font-semibold shadow-lg ${getStatusColor(order.status)}`}>
                ...
                {/* Financial Info */}
                <div className="relative mb-6 p-4 bg-gradient-to-r from-blue-50/50 to-purple-50/50 rounded-2xl border border-blue-100/30">
                  ...
                  <div className="flex justify-between text-sm text-gray-600">
                    ...
                    <span>{order.paymentTerms || 'Net 30'}</span>
                  </div>
                </div>

                {/* Supplier Info */}
                {order.supplier && (
                  <div className="mb-6 p-3 bg-gray-50/50 rounded-xl border border-gray-100/50">
                    <div className="flex items-center gap-3">
                ...
                <div className="flex gap-3 pt-4 border-t border-gray-100/50">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                  >
                  ...
                  {order.status === 'draft' && (
                    <>
                      <button
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                      >
                        <Edit className="w-4 h-4" />
                      </button>
                      <button
                        onClick={() => handleDeleteOrder(order.id)}
                        className="flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                      >
        ...
        {/* Enhanced Summary */}
        {filteredOrders.length > 0 && (
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/30 p-6 mt-8">
              ...
              <div className="flex items-center gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">
                    TSh {filteredOrders.reduce((sum, order) => sum + order.totalAmount, 0).toLocaleString()}
                  </div>
                  <div className="text-sm text-gray-600">Total Value</div>
                </div>
                <div className="text-center">
