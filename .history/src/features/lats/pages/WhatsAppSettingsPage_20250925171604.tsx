      ...
      if (currentSettings) {
        ...
        try {
          ...
          if (error.message?.includes('ERR_CONNECTION_REFUSED') || 
            ...
            toast.warning('Green API proxy is not available. Using default settings.');
          }
          ...
          try {
            ...
            toast.warning('Settings saved locally but not to database.');
          }
        }
      }
    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">LATS System Dashboard - WhatsApp Settings</h1>
