...
const SalesReportsPage: React.FC = () => {
  ...
  const fetchSales = async () => {
    try {
      ...
      // Now including the newly added customer columns
          ...
          <div className="flex justify-between items-center mt-6 pt-6 border-t border-gray-200/50">
            <div className="flex items-center gap-3">
              ...
              {isDailyClosed && (
                <div className="flex items-center gap-2 px-3 py-1 bg-green-100 rounded-full">
                  ...
                  <span className="text-sm font-medium text-green-700">Daily Sales Closed</span>
                </div>
              )}
            </div>
            <div className="flex space-x-3">
              <button
                ...
                className="px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 font-medium"
              >
                <RefreshCw className={`w-4 h-4 ${loading ? 'animate-spin' : ''}`} />
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200/50">
                  <th className="text-left py-4 px-6 font-semibold text-gray-700">Sale #</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-700">Status</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-700">Date</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-700">Customer</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-700">Payment</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-700">Cashier</th>
              ...
              <tbody>
                {sales.map((sale) => (
                  <tr
                    ...
                    className="border-b border-gray-100 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200 cursor-pointer hover:shadow-sm"
                  >
                    <td className="py-4 px-6">
                      <span className="font-mono text-sm font-medium text-gray-900">#{sale.sale_number}</span>
                    </td>
                    <td className="py-4 px-6">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-1 text-sm text-gray-600">
                        ...
                        {sale.customer_name || (sale.customer_id ? `Customer: ${sale.customer_id.slice(0, 8)}...` : 'Walk-in')}
                      </div>
                    </td>
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-1 text-sm text-gray-600">
