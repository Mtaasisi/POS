              ...
              <div className="flex-shrink-0 mb-6 space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-16 py-4 text-base border-2 border-orange-200 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500 shadow-sm hover:shadow-md transition-all duration-200"
                  />
          ...
          <div className="lg:w-[450px] flex-shrink-0">
            <GlassCard className="p-6 h-full flex flex-col">
              <div className="flex items-center gap-3 mb-6 flex-shrink-0">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-800">Purchase Cart</h2>
                  <p className="text-sm text-gray-600">{purchaseCartItems.length} items</p>
                </div>
              </div>
