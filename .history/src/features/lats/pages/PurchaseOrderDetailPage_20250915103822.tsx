          ...
          <table class="items-table">
            <thead>
              <tr>
                ...
                <th style="width: 12%;">Price (TZS)</th>
                <th style="width: 12%;">Total</th>
                <th style="width: 12%;">Total (TZS)</th>
...
${index + 1}. ${item.product?.name || `Product ${item.productId}`}
   ...
   Total: ${formatCurrency(item.quantity * item.costPrice, order.currency)} (TZS ${totalPriceTZS.toLocaleString()})
