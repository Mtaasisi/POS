...
const InventorySparePartsPage: React.FC = () => {
  ...
  // const [selectedSpareParts, setSelectedSpareParts] = useState<string[]>([]); // Unused variables
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-6xl mx-auto p-3">
        ...
        {/* Stock Alerts Banner */}
        {stockAlerts.total > 0 && (
          <GlassCard className="mb-4 p-3 border-l-4 border-l-yellow-500">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700">
                    {stockAlerts.lowStock.length} parts with low stock, {stockAlerts.outOfStock.length} parts out of stock
                  </p>
                </div>
              </div>
              <div className="flex gap-2">
                {stockAlerts.lowStock.length > 0 && (
                  <GlassButton
                    ...
                    className="text-xs px-2 py-1 bg-yellow-100 text-yellow-800 hover:bg-yellow-200"
                  >
                ...
                {stockAlerts.outOfStock.length > 0 && (
                  ...
                  >
                    View Out of Stock ({stockAlerts.outOfStock.length})
                  </GlassButton>
                )}
              </div>
            </div>
