              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    ...
                    {purchaseOrder.exchangeRate && purchaseOrder.exchangeRate !== 1.0 && (
                      <div className="px-2 py-1 bg-orange-100 text-orange-700 text-xs font-medium rounded">
                        Rate: {formatExchangeRate(purchaseOrder.exchangeRate)}
                      </div>
                    )}
                  </div>
                </div>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    {purchaseOrder.exchangeRate && purchaseOrder.exchangeRate !== 1.0 && (
                      <div className="text-xs text-gray-500 mt-1">
                        ≈ TZS {purchaseOrder.totalAmountBaseCurrency ? 
                          ...
                          calculateTZSEquivalent(purchaseOrder.totalAmount, purchaseOrder.currency, purchaseOrder.exchangeRate).toLocaleString()
                        }
                      </div>
                    )}
                  </div>
                  <div className="text-center p-3 bg-blue-50 rounded-lg">
                    ...
                    {purchaseOrder.exchangeRate && purchaseOrder.exchangeRate !== 1.0 && (
                      <div className="text-xs text-gray-500 mt-1">
                        ≈ TZS {Math.round(calculateAverageCostPerItem(purchaseOrder.totalAmount, purchaseOrder.items) * purchaseOrder.exchangeRate).toLocaleString()}
                      </div>
                    )}
                  </div>
