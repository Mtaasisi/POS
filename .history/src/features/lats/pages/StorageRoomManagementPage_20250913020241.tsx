...
import DatabaseConnectionTest from '../components/inventory-management/DatabaseConnectionTest';
...
const StorageRoomManagementPage: React.FC = () => {
  ...
  const handleDeleteRoom = async (room: StorageRoom) => {
    if (!confirm(`Are you sure you want to delete "${room.code}"? This will also delete all associated shelves.`)) {
      return;
    }
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-lg font-semibold text-gray-900 font-mono">{room.code}</h3>
                    {room.is_secure && (
