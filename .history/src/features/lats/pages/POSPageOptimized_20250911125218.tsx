        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold">Search Customers</h3>
              <button
                onClick={() => {
                  setShowCustomerSearch(false);
            ...
            <input
              type="text"
              placeholder="Search by name, phone, or email... (or click 'Add New' to create)"
            ...
            <div className="max-h-60 overflow-y-auto">
              {customerSearchQuery.trim() ? (
                ...
                // Show recent customers when there's no search query
                recentCustomers.length > 0 ? (
                  ...
                  <div className="text-center py-4">
                    <p className="text-gray-500 mb-4">No recent customers</p>
                    <button
                      onClick={() => {
                        setShowCustomerSearch(false);
                        setShowAddCustomerModal(true);
