...
const POSPageOptimized: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="p-2 sm:p-4 lg:p-6 pb-20 max-w-full mx-auto space-y-4 lg:space-y-6">
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 h-[calc(100vh-180px)] sm:h-[calc(100vh-200px)]">
