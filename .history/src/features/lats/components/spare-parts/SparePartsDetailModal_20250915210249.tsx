              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {isLoadingImages ? (
                      <div className="w-full max-w-md mx-auto aspect-square relative rounded-xl overflow-hidden bg-gray-50 border border-gray-200 flex items-center justify-center">
                      ...
                      <>
                        <div className="w-full max-w-md mx-auto aspect-square relative rounded-xl overflow-hidden bg-gray-50 border border-gray-200">
                          <img
                      ...
                      <div className="w-full max-w-md mx-auto aspect-square relative rounded-xl overflow-hidden bg-gradient-to-br from-blue-100 to-indigo-100 border-2 border-dashed border-blue-300 flex items-center justify-center">
