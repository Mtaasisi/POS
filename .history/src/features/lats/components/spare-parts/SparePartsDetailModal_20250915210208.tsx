  ...
  const fetchSparePartImages = async () => {
    ...
    try {
      ...
      if (dbImages && dbImages.length > 0) {
        // Convert database images to the format expected by SimpleImageDisplay
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {isLoadingImages ? (
                      <div className="aspect-square relative rounded-xl overflow-hidden bg-gray-50 border border-gray-200 flex items-center justify-center max-w-md mx-auto">
                      ...
                      <>
                        <div className="aspect-square relative rounded-xl overflow-hidden bg-gray-50 border border-gray-200 max-w-md mx-auto">
                          <img
                      ...
                      <div className="aspect-square relative rounded-xl overflow-hidden bg-gradient-to-br from-blue-100 to-indigo-100 border-2 border-dashed border-blue-300 flex items-center justify-center max-w-md mx-auto">
