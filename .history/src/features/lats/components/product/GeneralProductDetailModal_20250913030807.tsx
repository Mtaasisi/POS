            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-2 px-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <span className="text-sm text-blue-700 font-medium">Category</span>
                    <span className="text-sm font-semibold text-blue-900">{currentProduct.category?.name || 'Uncategorized'}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 px-3 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <div className="flex justify-between items-center py-2 px-3 bg-purple-50 border border-purple-200 rounded-lg">
                    <span className="text-sm text-purple-700 font-medium">Product ID</span>
                    <span className="text-sm font-semibold text-purple-900 font-mono">{product.id}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 px-3 bg-orange-50 border border-orange-200 rounded-lg">
                    <span className="text-sm text-orange-700 font-medium">Total Variants</span>
                    <span className="text-sm font-semibold text-orange-900">{product.variants?.length || 0}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 px-3 bg-indigo-50 border border-indigo-200 rounded-lg">
                    <span className="text-sm text-indigo-700 font-medium">Total Stock</span>
                    <span className="text-sm font-semibold text-indigo-900">{currentProduct.totalQuantity || 0}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 px-3 bg-pink-50 border border-pink-200 rounded-lg">
                    <span className="text-sm text-pink-700 font-medium">Images</span>
                    <span className="text-sm font-semibold text-pink-900">{images.length} photo{images.length !== 1 ? 's' : ''}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide">Pricing Summary</h3>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl">
                    <span className="text-sm text-green-700 font-medium">Primary Price</span>
                    <span className="text-lg font-bold text-green-900">{format.money(primaryVariant?.sellingPrice || 0)}</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-red-50 to-rose-50 border border-red-200 rounded-xl">
                    <span className="text-sm text-red-700 font-medium">Cost Price</span>
                    <span className="text-lg font-bold text-red-900">{format.money(primaryVariant?.costPrice || 0)}</span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-xl">
                    <span className="text-sm text-blue-700 font-medium">Profit/Unit</span>
                    <span className="text-lg font-bold text-blue-900">
                      {format.money((primaryVariant?.sellingPrice || 0) - (primaryVariant?.costPrice || 0))}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-purple-50 to-violet-50 border border-purple-200 rounded-xl">
                    <span className="text-sm text-purple-700 font-medium">Markup</span>
                  ...
                  <div className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-xl">
                    <span className="text-sm text-orange-700 font-medium">Total Value</span>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {product.variants.slice(0, 3).map((variant, index) => (
                      <div key={variant.id || index} className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200 rounded-xl">
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                          <span className="text-sm font-medium text-purple-900">{variant.name || `Variant ${index + 1}`}</span>
                          <span className="text-xs text-purple-600 bg-purple-100 px-2 py-1 rounded-full">({variant.sku})</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm">
                          <span className="text-purple-700 bg-purple-100 px-2 py-1 rounded-full">Stock: {variant.quantity || 0}</span>
                          <span className="font-bold text-purple-900">{format.money(variant.sellingPrice || 0)}</span>
                        </div>
                      </div>
                    ))}
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-sm font-semibold text-gray-900">{currentProduct.supplier.name}</span>
                    </div>
                    {currentProduct.supplier.contactPerson && (
                      <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                        <span className="text-sm text-gray-600">Contact</span>
                        <span className="text-sm font-semibold text-gray-900">{currentProduct.supplier.contactPerson}</span>
                      </div>
                    )}
                    {currentProduct.supplier.phone && (
                      <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                        <span className="text-sm text-gray-600">Phone</span>
                        <span className="text-sm font-semibold text-gray-900">{currentProduct.supplier.phone}</span>
                      </div>
                    )}
                    {currentProduct.supplier.email && (
                      <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                        <span className="text-sm text-gray-600">Email</span>
                        <span className="text-sm font-semibold text-gray-900">{currentProduct.supplier.email}</span>
                      </div>
                    )}
                  </div>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="text-sm font-semibold text-gray-900 capitalize">{(product as any).condition || 'New'}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                    <span className="text-sm text-gray-600">Primary Variant</span>
                    <span className="text-sm font-semibold text-gray-900">
