              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="text-sm font-semibold text-gray-900 font-mono">{product.id}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                    <span className="text-sm text-gray-600">Total Variants</span>
                    <span className="text-sm font-semibold text-gray-900">{product.variants?.length || 0}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="text-sm font-semibold text-gray-900">{images.length} photo{images.length !== 1 ? 's' : ''}</span>
                  </div>
                </div>
              </div>
