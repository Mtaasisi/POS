    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          {/* Dynamic Additional Information Sections */}
          <div className="mt-8">
            {(() => {
              // Collect all available data sections
              const availableSections = [];
              
              // Physical & Shipping Information
              if (product.weight || product.length || product.width || product.height || product.shippingClass || product.requiresSpecialHandling) {
                availableSections.push({
                  ...
                  summary: (
                    <div className="text-sm text-gray-600">
                      ...
                      {product.shippingClass && <span className="ml-4">Class: {product.shippingClass}</span>}
                    </div>
                  )
                });
              }
              ...
              if (product.lastOrderDate || product.pendingQuantity || product.orderStatus) {
                availableSections.push({
                  key: 'purchaseOrders',
              ...
              // Shipping Status
              if (product.shippingStatus || product.trackingNumber || product.expectedDelivery) {
                availableSections.push({
                  key: 'shippingStatus',
              ...
              if (product.usdPrice || product.eurPrice) {
                availableSections.push({
                  key: 'multiCurrency',
              ...
              // Product Metadata
              if ((product as any).isDigital || (product as any).requiresShipping !== undefined || (product as any).isFeatured) {
                availableSections.push({
                  key: 'metadata',
              ...
              // Calculate optimal grid layout based on number of sections
              ...
              return (
                <div className={`grid ${gridCols} gap-6`}>
                  {availableSections.map((section) => {
                    ...
                    return (
                      <div key={section.key} className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                        ...
                        {section.collapsible ? (
                          expandedSections[section.key] ? section.content : section.summary
                        ) : (
                          section.content
                        )}
                      </div>
