...
const ProductPreviewCard: React.FC<ProductPreviewCardProps> = ({
  ...
  return (
    <div className="bg-white border-2 border-gray-200 rounded-lg shadow-sm hover:shadow-md hover:border-blue-300 transition-all">
      {/* Header */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 font-medium">SKU: {product.sku}</p>
            </div>
          </div>
        </div>
        <div className="flex items-center gap-3">
          {!isEditing ? (
            <button
              ...
              className="p-3 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors font-medium"
              title="Edit product"
            >
              <Edit3 size={18} />
            </button>
            ...
            <div className="flex gap-3">
              <button
                onClick={handleSave}
                className="p-3 text-green-600 hover:bg-green-50 rounded-lg transition-colors font-medium"
                title="Save changes"
              >
                <Save size={18} />
              </button>
              <button
                ...
                className="p-3 text-red-600 hover:bg-red-50 rounded-lg transition-colors font-medium"
      ...
      <div className="p-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-sm font-medium text-gray-600 mb-1">Cost Price</div>
            <div className="text-lg font-bold text-gray-900">TZS {product.costPrice.toLocaleString()}</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-sm font-medium text-gray-600 mb-1">Selling Price</div>
            <div className="text-lg font-bold text-gray-900">TZS {product.sellingPrice.toLocaleString()}</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-sm font-medium text-gray-600 mb-1">Stock</div>
            <div className="text-lg font-bold text-gray-900">{product.stockQuantity}</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-sm font-medium text-gray-600 mb-1">Min Level</div>
            <div className="text-lg font-bold text-gray-900">{product.minStockLevel}</div>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1">
            ...
            <div className="text-lg font-semibold text-gray-900 font-mono">{product.sku}</div>
          </div>
          <div className="space-y-1">
            <div className="text-sm font-medium text-gray-600">Category</div>
            <div className="text-lg font-semibold text-gray-900">{product.category || 'Not specified'}</div>
          </div>
          <div className="space-y-1">
            <div className="text-sm font-medium text-gray-600">Supplier</div>
            <div className="text-lg font-semibold text-gray-900">{product.supplier || 'Not specified'}</div>
          </div>
        </div>
        {product.description && (
          <div className="mt-6">
            <div className="text-sm font-medium text-gray-600 mb-2">Description</div>
            <div className="text-gray-800 bg-gray-50 rounded-lg p-4">{product.description}</div>
          </div>
        )}
      </div>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-sm font-medium text-gray-600 mb-1">Cost Price</div>
            <div className="text-xl font-bold text-gray-900">TZS {product.costPrice.toLocaleString()}</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-sm font-medium text-gray-600 mb-1">Selling Price</div>
            <div className="text-xl font-bold text-gray-900">TZS {product.sellingPrice.toLocaleString()}</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-sm font-medium text-gray-600 mb-1">Stock Quantity</div>
            <div className="text-xl font-bold text-gray-900">{product.stockQuantity}</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-sm font-medium text-gray-600 mb-1">Min Stock Level</div>
            <div className="text-xl font-bold text-gray-900">{product.minStockLevel}</div>
          </div>
        </div>
        <div className="mt-6 bg-green-50 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div className="text-sm font-medium text-green-700">Profit Margin</div>
      ...
      {/* Variants */}
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        <h3 className="text-lg font-bold text-gray-900 mb-4">Product Variants</h3>
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="space-y-1">
              <div className="text-sm font-medium text-gray-600">Variant Name</div>
              <div className="text-lg font-semibold text-gray-900">Default</div>
            </div>
            <div className="space-y-1">
              <div className="text-sm font-medium text-gray-600">Variant SKU</div>
              <div className="text-lg font-semibold text-gray-900 font-mono">{product.sku}</div>
            </div>
            <div className="space-y-1">
              <div className="text-sm font-medium text-gray-600">Cost Price</div>
              <div className="text-lg font-semibold text-gray-900">TZS {product.costPrice.toLocaleString()}</div>
            </div>
            <div className="space-y-1">
              <div className="text-sm font-medium text-gray-600">Selling Price</div>
              <div className="text-lg font-semibold text-gray-900">TZS {product.sellingPrice.toLocaleString()}</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Import multiple products from CSV or JSON files</p>
              </div>
            </div>
            <div className="flex gap-3">
              <button
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Choose your CSV or JSON file to import products</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-3 px-8 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isImporting ? (
                  <>
              ...
              {importResults.map((result, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-lg font-bold text-gray-900">{result.product}</p>
                    {result.error && (
                      <p className="text-red-600 mt-1 font-medium">{result.error}</p>
                    )}
                  </div>
                </div>
              ))}
