            ...
            {(product.lastOrderDate || product.pendingQuantity || product.orderStatus) && (
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="text-sm text-gray-600">
                    {product.lastOrderDate && <span>Last Order: {new Date(product.lastOrderDate).toLocaleDateString()}</span>}
                    {product.pendingQuantity && <span className="ml-4">Pending: {product.pendingQuantity}</span>}
                  </div>
                )}
              </div>
            )}
