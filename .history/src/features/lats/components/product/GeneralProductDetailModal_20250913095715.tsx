        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
           ...
           {activeTab === 'details' && (
            ...
            {/* Product Metadata & Additional Details */}
            {((product as any).isDigital || (product as any).requiresShipping !== undefined || (product as any).isFeatured || (product as any).taxRate || (product as any).debutDate || (product as any).shortDescription || (product as any).debutNotes || (product as any).debutFeatures || (product as any).metadata) && (
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                  <FileText className="w-5 h-5 text-indigo-600" />
                  <h3 className="text-sm font-semibold text-gray-800">Product Metadata & Details</h3>
                </div>
                <div className="max-h-64 overflow-y-auto pr-2">
                  <div className="grid grid-cols-2 gap-3">
                  {/* Product Type */}
                  ...
                  {(product as any).isFeatured !== undefined && (
                    <div className="space-y-1">
                      <span className="text-xs text-gray-500 uppercase tracking-wide">Featured Product</span>
                      <p className={`text-sm font-medium ${(product as any).isFeatured ? 'text-yellow-600' : 'text-gray-600'}`}>
                        {(product as any).isFeatured ? 'Yes' : 'No'}
                      </p>
                            </div>
                  ...
                  {(product as any).shortDescription && (
                    <div className="col-span-2 space-y-1">
                      <span className="text-xs text-gray-500 uppercase tracking-wide">Short Description</span>
                      <p className="text-sm font-medium text-gray-900">
                        {(product as any).shortDescription}
                      </p>
                    </div>
                  ...
                  {(product as any).debutNotes && (
                    <div className="col-span-2 space-y-1">
                      <span className="text-xs text-gray-500 uppercase tracking-wide">Debut Notes</span>
                      <p className="text-sm font-medium text-gray-900">
                        {(product as any).debutNotes}
                      </p>
                  </div>
                  ...
                  {(product as any).metadata && Object.keys((product as any).metadata).length > 0 && (
                    <div className="col-span-2 space-y-1">
                      ...
                      <div className="text-sm text-gray-600">
                        {Object.keys((product as any).metadata).length} custom field(s) available
                      </div>
                    </div>
                  )}
                  </div>
