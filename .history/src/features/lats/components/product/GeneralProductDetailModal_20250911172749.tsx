  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Content */}
        <div className="p-6">
          {/* Financial Analytics - Prominent Position */}
          {analytics && (
            <div className="mb-8">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-gray-100/50 p-6 shadow-lg">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                      ...
                      <h4 className="text-lg font-bold text-gray-800">Financial Overview</h4>
                    </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
            ...
            <div className="xl:col-span-1 space-y-6">
              ...
              <GlassCard variant="elevated" padding="lg" className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-lats-primary/20 rounded-lats-radius-md flex items-center justify-center">
                    <Tag className="w-4 h-4 text-lats-primary" />
                  </div>
                  <h4 className="text-lg font-semibold text-lats-text">Basic Information</h4>
                </div>
                
                <div className="space-y-3">
                  <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-lats-text-secondary">Product Name</span>
                      <span className="font-medium text-lats-text">{product.name}</span>
                    </div>
                  </GlassCard>
                  
                  <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-lats-text-secondary">SKU</span>
                      <span className="font-medium text-lats-text font-mono">{primaryVariant?.sku || 'No SKU'}</span>
                    </div>
                  </GlassCard>
                  ...
                  <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium text-lats-text">{currentProduct.category?.name || 'Uncategorized'}</span>
                    </div>
                  </GlassCard>

                  <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-lats-text-secondary">Product ID</span>
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-lats-text font-mono text-xs">{product.id}</span>
                        <button 
                ...
                <GlassCard variant="elevated" padding="lg" className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-lats-info/20 rounded-lats-radius-md flex items-center justify-center">
                      <FileText className="w-4 h-4 text-lats-info" />
                    </div>
                    <h4 className="text-lg font-semibold text-lats-text">Product Description</h4>
                  </div>
                  
                  <div className="bg-lats-surface/50 rounded-lats-radius-md p-4">
                    <p className="text-lats-text leading-relaxed">{product.description}</p>
                  </div>
                </GlassCard>
              )}
              ...
              <GlassCard variant="elevated" padding="lg" className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <GlassBadge 
                        variant={
                          ...
                          product.status === 'inactive' ? 'error' : 'warning'
                        } 
                        size="sm"
                      >
                        {product.status === 'active' ? 'Active' : 
                         product.status === 'inactive' ? 'Inactive' : 'Draft'}
                      </GlassBadge>
                    </div>
                  </GlassCard>
                  ...
                  <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-lats-text-secondary">Active</span>
                      <GlassBadge 
              ...
              {(product as any).tags && (product as any).tags.length > 0 && (
                <GlassCard variant="elevated" padding="lg" className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-lats-info/20 rounded-lats-radius-md flex items-center justify-center">
                      <Tag className="w-4 h-4 text-lats-info" />
                    </div>
                    <h4 className="text-lg font-semibold text-lats-text">Product Tags</h4>
                  </div>
                  
                  <div className="flex flex-wrap gap-2">
                    {(product as any).tags.map((tag: string, index: number) => (
                      <GlassBadge key={index} variant="info" size="sm">
                        {tag}
                      </GlassBadge>
                    ))}
                  </div>
              ...
              <GlassCard variant="elevated" padding="lg" className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <h4 className="text-lg font-semibold text-lats-text">Product Condition & Status</h4>
                </div>
              ...
              {((product as any).storageRoomName || (product as any).shelfName || (product as any).storeLocationName || (product as any).isRefrigerated || (product as any).requiresLadder) ? (
                <GlassCard variant="elevated" padding="lg" className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-lats-primary/20 rounded-lats-radius-md flex items-center justify-center">
              ...
              <GlassCard variant="elevated" padding="lg" className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-lats-warning/20 rounded-lats-radius-md flex items-center justify-center">
                    <Truck className="w-4 h-4 text-lats-warning" />
                  </div>
                  <h4 className="text-lg font-semibold text-lats-text">Shipping & Physical Information</h4>
                </div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {product.weight && (
                        <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-lats-text-secondary">Weight</span>
                            <span className="font-medium text-lats-text">{product.weight} kg</span>
                          </div>
                        </GlassCard>
                      )}
                      {product.length && (
                        <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-lats-text-secondary">Length</span>
                            <span className="font-medium text-lats-text">{product.length} cm</span>
                          </div>
                        </GlassCard>
                      )}
                      {product.width && (
                        <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-lats-text-secondary">Width</span>
                            <span className="font-medium text-lats-text">{product.width} cm</span>
                          </div>
                        </GlassCard>
                      )}
                      {product.height && (
                        <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-lats-text-secondary">Height</span>
                            <span className="font-medium text-lats-text">{product.height} cm</span>
                          </div>
                        </GlassCard>
                      )}
                      {product.cbm && (
                        <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-lats-text-secondary">Volume (CBM)</span>
                            <span className="font-medium text-lats-text">{product.cbm} m³</span>
                          </div>
                        </GlassCard>
                      )}
                    </div>
                  ...
                  {product.shippingClass && (
                    <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-lats-text-secondary">Shipping Class</span>
                        <GlassBadge 
                          variant={
                            product.shippingClass === 'fragile' ? 'warning' :
                            product.shippingClass === 'hazardous' ? 'error' :
                            product.shippingClass === 'oversized' ? 'info' : 'success'
                          } 
                          size="sm"
                        >
                          {product.shippingClass.charAt(0).toUpperCase() + product.shippingClass.slice(1)}
                        </GlassBadge>
                      </div>
                    </GlassCard>
                  )}
                  ...
                  {product.requiresSpecialHandling && (
                    <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-lats-text-secondary">Special Handling</span>
                        <GlassBadge variant="warning" size="sm">Required</GlassBadge>
                      </div>
                    </GlassCard>
                  )}

                  {/* Shipping Costs */}
                  {(product.shippingCost || product.totalShippingCost) && (
                    <div className="space-y-2">
                      <span className="text-sm text-lats-text-secondary">Shipping Costs</span>
                      <div className="grid grid-cols-2 gap-2">
                        {product.shippingCost && (
                          <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                            <div className="flex items-center justify-between">
                              <span className="text-xs text-lats-text-secondary">Base Cost</span>
                              <span className="text-sm font-medium text-lats-text">{format.money(product.shippingCost)}</span>
                            </div>
                          </GlassCard>
                        )}
                        {product.totalShippingCost && (
                          <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                            <div className="flex items-center justify-between">
                              <span className="text-xs text-lats-text-secondary">Total Cost</span>
                              <span className="text-sm font-medium text-lats-text">{format.money(product.totalShippingCost)}</span>
                            </div>
                          </GlassCard>
                        )}
                      </div>
              ...
              {(product.usdPrice || product.eurPrice) && (
                <GlassCard variant="elevated" padding="lg" className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-lats-success/20 rounded-lats-radius-md flex items-center justify-center">
                      <Banknote className="w-4 h-4 text-lats-success" />
                    </div>
                    <h4 className="text-lg font-semibold text-lats-text">Multi-Currency Pricing</h4>
                  </div>
                  ...
                  <div className="space-y-3">
                    {product.usdPrice && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">USD Price</span>
                          <span className="font-medium text-lats-text">${product.usdPrice.toFixed(2)}</span>
                        </div>
                      </GlassCard>
                    )}
                    {product.eurPrice && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">EUR Price</span>
                          <span className="font-medium text-lats-text">€{product.eurPrice.toFixed(2)}</span>
                        </div>
                      </GlassCard>
                    )}
                    {product.exchangeRate && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Exchange Rate</span>
                          <span className="font-medium text-lats-text">{product.exchangeRate.toFixed(4)}</span>
                        </div>
                      </GlassCard>
                    )}
                    {product.baseCurrency && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Base Currency</span>
                          <span className="font-medium text-lats-text">{product.baseCurrency.toUpperCase()}</span>
                        </div>
                      </GlassCard>
                    )}
                  </div>
              ...
              {(product.lastOrderDate || product.pendingQuantity || product.orderStatus) && (
                <GlassCard variant="elevated" padding="lg" className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-lats-info/20 rounded-lats-radius-md flex items-center justify-center">
                      <Receipt className="w-4 h-4 text-lats-info" />
                    </div>
                    <h4 className="text-lg font-semibold text-lats-text">Purchase Order Information</h4>
                  </div>
                  ...
                  <div className="space-y-3">
                    {product.lastOrderDate && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Last Order Date</span>
                          <span className="font-medium text-lats-text">
                    ...
                    {product.lastOrderQuantity && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Last Order Quantity</span>
                          <span className="font-medium text-lats-text">{product.lastOrderQuantity}</span>
                        </div>
                      </GlassCard>
                    )}
                    {product.pendingQuantity && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Pending Quantity</span>
                          <span className="font-medium text-lats-text">{product.pendingQuantity}</span>
                        </div>
                      </GlassCard>
                    )}
                    {product.orderStatus && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Order Status</span>
                          <GlassBadge 
                            variant={
                              product.orderStatus === 'received' ? 'success' :
                              product.orderStatus === 'shipped' ? 'info' :
                              product.orderStatus === 'cancelled' ? 'error' : 'warning'
                            } 
                            size="sm"
                          >
              ...
              {(product.shippingStatus || product.trackingNumber || product.expectedDelivery) && (
                <GlassCard variant="elevated" padding="lg" className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-lats-primary/20 rounded-lats-radius-md flex items-center justify-center">
                      <Truck className="w-4 h-4 text-lats-primary" />
                    </div>
                    <h4 className="text-lg font-semibold text-lats-text">Shipping Status</h4>
                  </div>
                  ...
                  <div className="space-y-3">
                    {product.shippingStatus && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          ...
                          <GlassBadge 
                            variant={
                              product.shippingStatus === 'delivered' ? 'success' :
                              product.shippingStatus === 'in_transit' ? 'info' :
                              product.shippingStatus === 'exception' ? 'error' : 'warning'
                            } 
                            size="sm"
                          >
                    ...
                    {product.trackingNumber && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Tracking Number</span>
                          <span className="font-medium text-lats-text font-mono">{product.trackingNumber}</span>
                        </div>
                      </GlassCard>
                    )}
                    {product.expectedDelivery && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Expected Delivery</span>
                          <span className="font-medium text-lats-text">
                    ...
                    {product.shippingAgent && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Shipping Agent</span>
                          <span className="font-medium text-lats-text">{product.shippingAgent}</span>
                        </div>
                      </GlassCard>
                    )}
                    {product.shippingCarrier && (
                      <GlassCard variant="subtle" padding="sm" className="hover:bg-lats-surface-hover">
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-lats-text-secondary">Carrier</span>
                          <span className="font-medium text-lats-text">{product.shippingCarrier}</span>
                        </div>
                      </GlassCard>
                    )}
                  </div>
            ...
            {/* Right Column - Quick Actions & Business Intelligence */}
            <div className="xl:col-span-1 space-y-6">
              {/* Business Intelligence */}
              <GlassCard variant="elevated" padding="lg" className="space-y-4">
                <div className="flex items-center gap-3">
              ...
              <GlassCard variant="elevated" padding="lg" className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-lats-primary/20 rounded-lats-radius-md flex items-center justify-center">
                    <Zap className="w-4 h-4 text-lats-primary" />
                  </div>
                  <h4 className="text-lg font-semibold text-lats-text">Quick Actions</h4>
                </div>
                
                <div className="grid grid-cols-1 gap-3">
                  <GlassButton
                    onClick={handleAddToCart}
                    className="bg-gradient-to-r from-green-500/80 to-emerald-500/80 hover:from-green-600/90 hover:to-emerald-600/90 text-white border-white/20 w-full"
                  >
                  ...
                  <GlassButton
                    ...
                    className="bg-gradient-to-r from-purple-500/80 to-violet-500/80 hover:from-purple-600/90 hover:to-violet-600/90 text-white border-white/20 w-full"
                  >
                  ...
                  <GlassButton
                    ...
                    className="bg-gradient-to-r from-blue-500/80 to-cyan-500/80 hover:from-blue-600/90 hover:to-cyan-600/90 text-white border-white/20 w-full"
                  >
                  ...
                  <GlassButton
                    ...
                    className="bg-gradient-to-r from-orange-500/80 to-red-500/80 hover:from-orange-600/90 hover:to-red-600/90 text-white border-white/20 w-full"
                  >
