      ...
      {product.specifications && Object.keys(product.specifications).length > 0 && (
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-500">
              {Object.keys(product.specifications).length} specification{Object.keys(product.specifications).length !== 1 ? 's' : ''}
            </span>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {Object.entries(product.specifications).map(([key, value]) => (
              <div key={key} className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200 hover:shadow-md transition-shadow">
                ...
                <div className="text-sm font-semibold text-gray-900 break-words">
                  {String(value) ? String(value).split(',').map((item, index) => (
                    <span key={index} className="inline-block bg-white px-2 py-1 rounded border border-gray-200 mr-1 mb-1">
                      {item.trim()}
                    </span>
                  )) : 'Not specified'}
                </div>
