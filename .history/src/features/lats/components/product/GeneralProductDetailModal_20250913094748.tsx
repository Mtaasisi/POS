        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <div className="text-xs font-medium text-blue-700 uppercase tracking-wide mb-1">Data Quality</div>
                    ...
                    <div className="text-center p-3 bg-purple-50 rounded-lg">
                      <div className="text-xs font-medium text-purple-700 uppercase tracking-wide mb-1">Days in Stock</div>
                      <div className="text-lg font-bold text-purple-900">{daysInStock} days</div>
                    </div>
                    <div className="text-center p-3 bg-orange-50 rounded-lg">
                      <div className="text-xs font-medium text-orange-700 uppercase tracking-wide mb-1">Avg Stock/Variant</div>
          ...
          {activeTab === 'details' && (
            <div className="space-y-6">
              ...
              {/* Physical Dimensions */}
              {(product.weight || product.length || product.width || product.height || (product as any).cbm) && (
                <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                    <Ruler className="w-5 h-5 text-green-600" />
                    <h3 className="text-sm font-semibold text-gray-800">Physical Dimensions</h3>
                  </div>
                  <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
                    ...
                    {(product as any).cbm && (
                      <div className="space-y-1">
                        <span className="text-xs text-gray-500 uppercase tracking-wide">Volume (CBM)</span>
                        <p className="text-sm font-medium text-gray-900">{(product as any).cbm} m³</p>
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                  ...
                  <h3 className="text-sm font-semibold text-gray-800">Storage Requirements</h3>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  {product.shippingClass && (
                    <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    <span className="text-xs text-gray-500 uppercase tracking-wide">Storage Priority</span>
                    <p className="text-sm font-medium text-gray-900">
                      {(product as any).isRefrigerated ? 'High' : 'Standard'}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <span className="text-xs text-gray-500 uppercase tracking-wide">Access Level</span>
                    <p className="text-sm font-medium text-gray-900">
                      {(product as any).requiresLadder ? 'High' : 'Standard'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                  ...
                  <h3 className="text-sm font-semibold text-gray-800">Product Codes</h3>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
              ...
              {product.variants && product.variants.length > 0 && (
                <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                    ...
                    <h3 className="text-sm font-semibold text-gray-800">Variant Codes ({product.variants.length} variants)</h3>
                  </div>
                  <div className="space-y-2">
                    {product.variants.map((variant, index) => (
                      <div key={variant.id || index} className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-2">
                          {variant.isPrimary && <div className="w-2 h-2 bg-blue-500 rounded-full"></div>}
                          <span className="text-sm font-medium text-gray-900">{variant.name || `Variant ${index + 1}`}</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm">
                          <span className="text-gray-600 font-mono">{variant.sku}</span>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {(product as any).brand && (
                    <div className="space-y-1">
                      ...
                      <p className="text-sm font-medium text-gray-900">{(product as any).brand.name}</p>
                    </div>
                  )}
                  <div className="space-y-1">
                    <span className="text-xs text-gray-500 uppercase tracking-wide">Product Type</span>
                    <p className="text-sm font-medium text-gray-900">
                      {product.variants && product.variants.length > 1 ? 'Multi-Variant' : 'Single Variant'}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <span className="text-xs text-gray-500 uppercase tracking-wide">Status</span>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors font-medium"
                  >
