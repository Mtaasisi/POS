      ...
      <div className={`sticky top-0 z-10 bg-white border-b border-gray-200 ${RESPONSIVE_OPTIMIZATIONS.spacing.padding.mobile} ${RESPONSIVE_OPTIMIZATIONS.spacing.padding.tablet} ${RESPONSIVE_OPTIMIZATIONS.spacing.padding.desktop} ${RESPONSIVE_OPTIMIZATIONS.spacing.padding.hd}`}>
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 ${RESPONSIVE_OPTIMIZATIONS.searchBar.mobile} ${RESPONSIVE_OPTIMIZATIONS.searchBar.tablet} ${RESPONSIVE_OPTIMIZATIONS.searchBar.desktop} ${RESPONSIVE_OPTIMIZATIONS.searchBar.hd} border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm`}
          />
        </div>
        ...
        <div className={`flex items-center ${RESPONSIVE_OPTIMIZATIONS.spacing.gap.mobile} ${RESPONSIVE_OPTIMIZATIONS.spacing.gap.tablet} ${RESPONSIVE_OPTIMIZATIONS.spacing.gap.desktop} ${RESPONSIVE_OPTIMIZATIONS.spacing.gap.hd}`}>
          ...
          {showFilters && (
            <button
              ...
              className={`flex items-center gap-1 ${RESPONSIVE_OPTIMIZATIONS.buttonSizes.mobile} ${RESPONSIVE_OPTIMIZATIONS.buttonSizes.tablet} ${RESPONSIVE_OPTIMIZATIONS.buttonSizes.desktop} ${RESPONSIVE_OPTIMIZATIONS.buttonSizes.hd} bg-gray-100 rounded-lg text-xs font-medium hover:bg-gray-200 transition-colors`}
            >
              <Filter size={16} />
              <DynamicProductText
                priority={true}
              ...
              className={
                viewMode === 'grid' 
                  ? enableDynamicGrid 
                    ...
                    : `grid ${RESPONSIVE_OPTIMIZATIONS.gridLayout.progressive.base} ${RESPONSIVE_OPTIMIZATIONS.gridLayout.progressive.wide} ${RESPONSIVE_OPTIMIZATIONS.gridLayout.progressive.ultra} ${RESPONSIVE_OPTIMIZATIONS.spacing.gap.mobile} ${RESPONSIVE_OPTIMIZATIONS.spacing.gap.tablet} ${RESPONSIVE_OPTIMIZATIONS.spacing.gap.desktop} ${RESPONSIVE_OPTIMIZATIONS.spacing.gap.hd}`
                  : 'space-y-3'
              }
            >
