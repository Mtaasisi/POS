...
import { X, Save, User, Phone, Mail, MapPin, Star, Crown, AlertCircle, CheckCircle, Calendar, MessageSquare, Users, Gift, CreditCard, Clock, FileText, UserPlus, Award, TrendingUp } from 'lucide-react';
