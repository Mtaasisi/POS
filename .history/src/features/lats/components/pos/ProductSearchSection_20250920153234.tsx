...
const ProductSearchSection: React.FC<ProductSearchSectionProps> = ({
  ...
  // Toggle category view mode
  const toggleCategoryViewMode = () => {
    setCategoryViewMode(prev => prev === 'horizontal' ? 'expandable' : 'horizontal');
    setIsCategoryExpanded(false); // Reset expanded state when switching modes
  };
