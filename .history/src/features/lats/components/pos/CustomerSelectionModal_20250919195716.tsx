...
const CustomerSelectionModal: React.FC<CustomerSelectionModalProps> = ({
  ...
  return (
    <>
      ...
      <div className="w-full max-w-5xl max-h-[95vh] overflow-hidden bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20">
        {/* Header */}
        <div className="flex items-center justify-between p-6 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 border-b border-white/30">
          <div>
        ...
        {/* Search Bar */}
        <div className="p-6 bg-gradient-to-r from-gray-50/80 to-blue-50/80 border-b border-white/30">
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-6 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/20 scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-transparent hover:scrollbar-thumb-blue-400 scroll-smooth">
          {loading && (
