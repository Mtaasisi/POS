  ...
  return (
    <>
      ...
      <div className="w-full max-w-5xl max-h-[95vh] overflow-hidden bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 flex flex-col">
        ...
        {/* Content */}
        <div className="relative flex-1 overflow-y-auto p-6 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/20 custom-scrollbar scroll-smooth min-h-0" style={{ maxHeight: 'calc(95vh - 200px)' }}>
          {/* Scroll indicators */}
