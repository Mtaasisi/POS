          ...
          <React.Fragment key={rowIndex}>
            {row.map((key) => (
              <button
                ...
                className="aspect-square bg-gray-50 hover:bg-gray-100 active:bg-gray-200 border border-gray-200 rounded text-lg font-medium text-gray-800 transition-colors focus:outline-none focus:ring-1 focus:ring-blue-500"
              >
                {key}
              </button>
            ))}
