          ...
          <>
            ...
            {hasMore && (
              <div className="mt-3 text-center">
                <button
                  onClick={loadMore}
                  className={`${RESPONSIVE_OPTIMIZATIONS.buttonSizes.mobile} ${RESPONSIVE_OPTIMIZATIONS.buttonSizes.tablet} ${RESPONSIVE_OPTIMIZATIONS.buttonSizes.desktop} ${RESPONSIVE_OPTIMIZATIONS.buttonSizes.hd} bg-blue-500 text-white font-medium rounded-md hover:bg-blue-600 transition-colors text-xs`}
                >
