      ...
      <div className="px-3 py-2 sm:px-6 sm:py-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          ...
          <div className="flex items-center justify-center w-full sm:w-auto">
            {cartItemsCount > 0 ? (
              <div className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200/60 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 min-h-[44px]">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm font-bold text-green-800">{cartItemsCount}</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm font-bold text-green-800">{formatMoney(totalAmount)}</div>
                  </div>
                </div>
                
                {/* Customer Badge */}
                {hasSelectedCustomer && (
                  <div className="flex items-center gap-1 px-2 py-1 bg-blue-500/10 border border-blue-200/50 rounded-lg">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-gray-50/80 border border-gray-200/60 rounded-lg min-h-[44px]">
                <ShoppingCart size={16} className="text-gray-400" />
                <span className="text-xs font-medium text-gray-500">Empty Cart</span>
              </div>
            )}
          </div>
