...
const ProductInfoModal: React.FC<ProductInfoModalProps> = ({
  ...
  React.useEffect(() => {
    if (isOpen && product) {
      console.log('🔍 [ProductInfoModal] Product data received:', {
        id: product.id,
        name: product.name,
        ...
        shelfInfo: {
          ...
          storeLocation: !!product.storeLocationName
        }
      });
    }
  }, [isOpen, product]);
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {product.attributes && Object.keys(product.attributes).length > 0 && (
                <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                    ...
                    <h3 className="text-sm font-semibold text-gray-800">Attributes</h3>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    {Object.keys(product.attributes).length > 6 && (
                      <div className="col-span-2 text-xs text-gray-500 text-center py-2 bg-gray-50 rounded-lg">
                        +{Object.keys(product.attributes).length - 6} more attributes
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm font-medium text-gray-900">
                        {product.supplier?.name || product.supplierName || 'Unknown Supplier'}
                      </p>
                    </div>
                    ...
                    {product.supplier?.address && (
                      <div className="col-span-2 space-y-1">
                        ...
                        <p className="text-sm font-medium text-gray-900">{product.supplier.address}</p>
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    {currentVariant.barcode && (
                      <div className="space-y-1">
                        ...
                        <p className="text-sm font-medium text-gray-900 font-mono">{currentVariant.barcode}</p>
                      </div>
                    )}
                    {currentVariant.isActive !== undefined && (
                      <div className="space-y-1">
                        <span className="text-xs text-gray-500 uppercase tracking-wide">Status</span>
                        <div className="flex items-center gap-2">
              ...
              {/* Product Metadata */}
              {(product.createdAt || product.updatedAt || product.tags?.length > 0) && (
                <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {product.createdAt && (
                      <div className="space-y-1">
                        ...
                        <p className="text-sm font-medium text-gray-900">
                          {new Date(product.createdAt).toLocaleDateString('en-TZ')}
                        </p>
                      </div>
                    )}
                    {product.updatedAt && (
                      <div className="space-y-1">
                        ...
                        <p className="text-sm font-medium text-gray-900">
                          {new Date(product.updatedAt).toLocaleDateString('en-TZ')}
                        </p>
                      </div>
                    )}
