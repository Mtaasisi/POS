      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-white sticky top-0 z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900 truncate max-w-[300px]">{product.name}</h2>
              <p className="text-xs text-gray-500">{currentVariant?.sku || 'No SKU'}</p>
            </div>
          </div>
          <button 
            onClick={onClose}
            className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-colors touch-target"
          >
            <X className="w-6 h-6" />
          </button>
        </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch gap-3">
            {onAddToCart && currentVariant && currentVariant.quantity > 0 && (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-green-600 active:bg-green-700 text-white rounded-lg transition-colors font-semibold text-base min-h-[48px] touch-button"
              >
                <ShoppingCart className="w-5 h-5" />
                <span className="hidden sm:inline">Add to Cart - {format.money(currentVariant.sellingPrice || 0)}</span>
            ...
            <button
              onClick={onClose}
              className="px-4 py-3 border border-gray-300 text-gray-700 active:bg-gray-50 rounded-lg transition-colors font-medium min-h-[48px] touch-button sm:w-auto w-full"
            >
              Close
            </button>
          </div>
