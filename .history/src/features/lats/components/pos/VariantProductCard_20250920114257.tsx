        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="text-right">
              <div className={`font-semibold text-base whitespace-nowrap overflow-hidden ${hasNoVariants ? 'text-gray-500' : theme.priceColor}`} title={getPriceDisplay()}>
                {getPriceDisplay()}
              </div>
              {showStockLevels && (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-2xl text-gray-700 mt-1 font-bold whitespace-nowrap overflow-hidden" title={getPriceDisplay()}>
