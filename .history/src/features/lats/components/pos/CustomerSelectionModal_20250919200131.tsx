        ...
        <div className="relative flex-1 overflow-y-auto p-6 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/20 custom-scrollbar scroll-smooth min-h-0" style={{ maxHeight: 'calc(95vh - 200px)', scrollbarWidth: 'thin', scrollbarColor: '#3b82f6 transparent' }}>
          ...
          {customers.length > 0 && (
            <div className="mb-6 mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-4" style={{ minHeight: '400px' }}>
...
const CustomerCard: React.FC<CustomerCardProps> = ({ customer, onSelect, isSelected, searchQuery }) => {
  ...
  return (
    <div
      ...
      className={`group relative overflow-hidden bg-white rounded-3xl border-2 cursor-pointer transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] hover:-translate-y-2 ${
        isSelected 
          ? 'border-blue-500 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 shadow-xl ring-4 ring-blue-500/30' 
          : 'border-gray-200 hover:border-blue-400 hover:bg-gradient-to-br hover:from-white hover:to-blue-50/30'
      }`}
    >
      {/* Background Pattern */}
      ...
      <div className="relative p-6">
        ...
        <div className="flex items-start gap-4 mb-5">
          ...
          <div className="relative">
            <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 flex items-center justify-center text-white font-bold text-xl shadow-xl group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="space-y-2 mb-5">
          {customer.phone && (
            <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-blue-50 to-blue-100/50 rounded-2xl border border-blue-200/50">
          ...
          {customer.email && (
            <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-green-50 to-green-100/50 rounded-2xl border border-green-200/50">
          ...
          {customer.city && (
            <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-purple-50 to-purple-100/50 rounded-2xl border border-purple-200/50">
        ...
        <div className="flex justify-between items-center pt-4 border-t border-gray-200/50">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-xl shadow-sm">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 to-purple-500/0 group-hover:from-blue-500/5 group-hover:to-purple-500/5 transition-all duration-300 rounded-3xl pointer-events-none"></div>
      </div>
    </div>
  );
};
