      ...
      <div className={`${RESPONSIVE_OPTIMIZATIONS.productCard.padding.mobile} ${RESPONSIVE_OPTIMIZATIONS.productCard.padding.tablet} ${RESPONSIVE_OPTIMIZATIONS.productCard.padding.desktop} ${RESPONSIVE_OPTIMIZATIONS.productCard.padding.hd}`}>
        {isTextLoaded ? (
          <>
            ...
            {product.sku && (
              <p className={`${RESPONSIVE_OPTIMIZATIONS.productCard.textSize.sku.mobile} ${RESPONSIVE_OPTIMIZATIONS.productCard.textSize.sku.tablet} ${RESPONSIVE_OPTIMIZATIONS.productCard.textSize.sku.desktop} ${RESPONSIVE_OPTIMIZATIONS.productCard.textSize.sku.hd} text-gray-500 mb-1`}>SKU: {product.sku}</p>
            )}
