...
import { formatTanzaniaPhoneNumber, isValidTanzanianMobile } from '../../../../lib/phoneUtils';
...
const CreateCustomerModal: React.FC<CreateCustomerModalProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    customerTag: 'new' as 'new' | 'vip' | 'complainer' | 'purchased',
    referralSource: '',
    birthMonth: '',
    birthDay: '',
    whatsapp: '',
  ...
  const validateForm = () => {
    ...
    } else if (!isValidTanzanianMobile(formData.phone)) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const customerData = {
        ...
        phone: formatTanzaniaPhoneNumber(formData.phone.trim()),
        email: formData.email.trim() || undefined,
        address: formData.address.trim() || undefined,
        city: formData.city.trim() || undefined,
        country: formData.country,
        loyaltyLevel: formData.loyaltyLevel,
        colorTag: formData.customerTag,
        referralSource: formData.referralSource.trim() || undefined,
        birthMonth: formData.birthMonth || undefined,
        birthDay: formData.birthDay || undefined,
        whatsapp: formData.whatsapp.trim() ? formatTanzaniaPhoneNumber(formData.whatsapp.trim()) : undefined,
