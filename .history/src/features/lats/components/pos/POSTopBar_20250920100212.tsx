          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-lats-pos-50 text-lats-pos-700 rounded-lg hover:bg-lats-pos-100 transition-all duration-200 border border-lats-pos-200 shadow-soft hover:shadow-medium"
              >
                <Scan size={16} />
          ...
          <div className="flex items-center gap-2">
            ...
            {onViewAnalytics && (
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-lats-analytics-50 text-lats-analytics-700 rounded-lg hover:bg-lats-analytics-100 transition-all duration-200 border border-lats-analytics-200 shadow-soft hover:shadow-medium"
            ...
            {onPaymentTracking && (
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-lats-finance-50 text-lats-finance-700 rounded-lg hover:bg-lats-finance-100 transition-all duration-200 border border-lats-finance-200 shadow-soft hover:shadow-medium"
            ...
            {onCustomers && (
              <button
                onClick={onCustomers}
                className="flex items-center gap-2 px-3 py-2 bg-lats-customer-care-50 text-lats-customer-care-700 rounded-lg hover:bg-lats-customer-care-100 transition-all duration-200 border border-lats-customer-care-200 shadow-soft hover:shadow-medium"
            ...
            {onReports && (
              <button
                onClick={onReports}
                className="flex items-center gap-2 px-4 py-2 bg-lats-analytics-500 text-white rounded-lg hover:bg-lats-analytics-600 transition-all duration-200 font-semibold shadow-glow"
                title="Sales Reports"
              >
                <BarChart3 size={16} />
            ...
            {cartItemsCount > 0 && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-lats-finance-500 text-white rounded-lg hover:bg-lats-finance-600 disabled:bg-neutral-400 transition-all duration-200 font-semibold shadow-glow-green hover:shadow-glow-green"
              >
                <CreditCard size={16} />
            ...
            {cartItemsCount > 0 && (
              <button
                onClick={onClearCart}
                className="flex items-center gap-2 px-3 py-2 bg-error-50 text-error-700 rounded-lg hover:bg-error-100 transition-all duration-200 border border-error-200 shadow-soft"
                title="Clear Cart"
              >
                <Trash2 size={16} />
            ...
            <div className="flex items-center gap-1">
              ...
              {onRefreshData && (
                <button
                  ...
                  className="p-2 text-neutral-600 hover:text-neutral-800 hover:bg-neutral-100 rounded-lg transition-all duration-200 shadow-soft"
                  title="Refresh Data"
                >
                  <RefreshCw size={16} />
                </button>
            ...
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-neutral-700 to-neutral-800 hover:from-neutral-600 hover:to-neutral-700 transition-all duration-300 shadow-soft border border-neutral-300"
              >
