              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      { value: 'bronze', label: 'Bronze', color: 'bg-orange-100 text-orange-700 border-orange-200 hover:bg-orange-200', activeColor: 'bg-orange-500 text-white border-orange-500' },
                      { value: 'silver', label: 'Silver', color: 'bg-gray-100 text-gray-700 border-gray-200 hover:bg-gray-200', activeColor: 'bg-gray-500 text-white border-gray-500' },
                      { value: 'gold', label: 'Gold', color: 'bg-yellow-100 text-yellow-700 border-yellow-200 hover:bg-yellow-200', activeColor: 'bg-yellow-500 text-white border-yellow-500' },
                      { value: 'platinum', label: 'Platinum', color: 'bg-purple-100 text-purple-700 border-purple-200 hover:bg-purple-200', activeColor: 'bg-purple-500 text-white border-purple-500' }
                    ].map((option) => (
                      <button
                        key={option.value}
                        type="button"
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      { value: 'new', label: 'New', color: 'bg-green-100 text-green-700 border-green-200 hover:bg-green-200', activeColor: 'bg-green-500 text-white border-green-500' },
                      { value: 'regular', label: 'Regular', color: 'bg-blue-100 text-blue-700 border-blue-200 hover:bg-blue-200', activeColor: 'bg-blue-500 text-white border-blue-500' },
                      { value: 'premium', label: 'Premium', color: 'bg-yellow-100 text-yellow-700 border-yellow-200 hover:bg-yellow-200', activeColor: 'bg-yellow-500 text-white border-yellow-500' },
                      { value: 'vip', label: 'VIP', color: 'bg-purple-100 text-purple-700 border-purple-200 hover:bg-purple-200', activeColor: 'bg-purple-500 text-white border-purple-500' }
                    ].map((option) => (
                      <button
                        key={option.value}
                        type="button"
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    >
                      <div className={`w-2 h-2 rounded-full ${formData.isActive ? 'bg-white' : 'bg-gray-400'}`}></div>
                      Active Customer
                    </button>
                    
                    <button
                      type="button"
                      onClick={() => handleInputChange('whatsappOptOut', !formData.whatsappOptOut)}
                      className={`px-3 py-1.5 text-xs font-medium rounded-md border transition-colors flex items-center gap-1.5 ${
                        formData.whatsappOptOut 
                          ? 'bg-red-500 text-white border-red-500' 
                          : 'bg-gray-100 text-gray-700 border-gray-200 hover:bg-gray-200'
                      }`}
                    >
                      <div className={`w-2 h-2 rounded-full ${formData.whatsappOptOut ? 'bg-white' : 'bg-gray-400'}`}></div>
                      WhatsApp Opt-out
                    </button>
                  </div>
                </div>
        ...
        <div className="flex items-center justify-between p-3 border-t border-gray-200 bg-gray-50">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              onClick={handleClose}
              disabled={isLoading}
              className="px-3 py-1.5 text-sm border border-gray-300 rounded-md hover:bg-gray-100 transition-colors disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              ...
              className="px-3 py-1.5 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors disabled:opacity-50 flex items-center gap-1"
            >
