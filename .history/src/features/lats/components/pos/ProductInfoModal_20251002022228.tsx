                ...
                <div className="aspect-square relative rounded-lg overflow-hidden bg-gray-50 border border-gray-200 max-w-xs mx-auto">
                  {productImages.length > 0 ? (
                    <>
                      ...
                      {(() => {
                        const imageUrl = productImages[selectedImageIndex]?.thumbnailUrl || productImages[selectedImageIndex]?.url || productImages[0]?.thumbnailUrl || productImages[0]?.url;
                      ...
                      <img
                        src={productImages[selectedImageIndex]?.thumbnailUrl || productImages[selectedImageIndex]?.url || productImages[0]?.thumbnailUrl || productImages[0]?.url}
                        alt={product.name}
