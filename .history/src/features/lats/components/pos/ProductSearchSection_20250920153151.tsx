...
import { Search, RefreshCw, Package, Command, QrCode, Filter, X, ChevronLeft, ChevronRight, List, Grid } from 'lucide-react';
...
const ProductSearchSection: React.FC<ProductSearchSectionProps> = ({
  ...
  const [categoryViewMode, setCategoryViewMode] = useState<'horizontal' | 'expandable'>('horizontal');
  ...
  // Sync current category index with selected category
  useEffect(() => {
    if (selectedCategory === '') {
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              ...
              <div className="flex gap-2">
                ...
                <div className="flex border border-gray-300 rounded-lg overflow-hidden bg-white">
                  ...
                  <button
                    onClick={() => setCategoryViewMode('expandable')}
                    className={`p-2 transition-colors ${
                      categoryViewMode === 'expandable' 
                        ? 'bg-blue-100 text-blue-600' 
                        : 'text-gray-600 hover:bg-gray-50'
                    }`}
                ...
                {/* Category Filter - Horizontal View */}
                {categoryViewMode === 'horizontal' && (
                  <div className="flex items-center gap-1 border border-gray-300 rounded-lg overflow-hidden bg-white">
                    ...
                    <div 
                      ...
                      className="flex overflow-x-auto scrollbar-hide min-w-0 flex-1"
                    ...
                    >
                      <div className="flex">
                        ...
                        <button
                          onClick={() => selectCategoryByIndex(0)}
                        ...
                        {categories.map((category, index) => (
                          <button
                            key={category}
                            onClick={() => selectCategoryByIndex(index + 1)}
                            className={`px-3 py-2 text-sm transition-colors whitespace-nowrap ${
                    ...
                    <button
                      ...
                      disabled={currentCategoryIndex >= categories.length}
                      className={`p-2 transition-colors ${
