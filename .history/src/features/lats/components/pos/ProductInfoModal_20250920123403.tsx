...
const ProductInfoModal: React.FC<ProductInfoModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col">
      ...
      >
        {/* Full Screen Header */}
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-100 bg-white sticky top-0 z-10 safe-area-pt">
          ...
          <button 
            onClick={onClose}
            className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-colors touch-target flex-shrink-0"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 mobile-scroll">
          ...
          <div className="mb-4 sm:mb-6">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4">
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-lg sm:rounded-xl p-3 sm:p-4">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg sm:rounded-xl p-3 sm:p-4">
                ...
                <div className="text-sm sm:text-lg font-bold text-blue-900 truncate">{getPriceRangeDisplay()}</div>
              </div>

              <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg sm:rounded-xl p-3 sm:p-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="aspect-square sm:aspect-square relative rounded-lg sm:rounded-xl overflow-hidden bg-gray-50 border border-gray-200">
                  ...
                  <div className="flex gap-2 overflow-x-auto pb-2">
                    {productImages.map((image, index) => (
                      <button
                        ...
                        className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-lg overflow-hidden border-2 transition-all touch-target ${
        ...
        {/* Action Buttons */}
        <div className="p-4 sm:p-6 border-t border-gray-100 bg-white sticky bottom-0 z-10 safe-area-pb">
          <div className="flex flex-col sm:flex-row items-center gap-3">
            {onAddToCart && currentVariant && currentVariant.quantity > 0 && (
              <button
                ...
                className="w-full sm:flex-1 flex items-center justify-center gap-3 px-4 sm:px-6 py-3 sm:py-4 bg-green-600 active:bg-green-700 text-white rounded-lg transition-colors font-semibold text-base sm:text-lg touch-button min-h-[48px] sm:min-h-[56px]"
              >
            ...
            {currentVariant && currentVariant.quantity <= 0 && (
              <div className="w-full sm:flex-1 flex items-center justify-center gap-3 px-4 sm:px-6 py-3 sm:py-4 bg-gray-100 text-gray-500 rounded-lg font-semibold text-base sm:text-lg min-h-[48px] sm:min-h-[56px]">
            ...
            <button
              onClick={onClose}
              className="w-full sm:w-auto px-4 sm:px-6 py-3 sm:py-4 border border-gray-300 text-gray-700 active:bg-gray-50 rounded-lg transition-colors font-medium touch-button min-h-[48px] sm:min-h-[56px]"
            >
              Close
            </button>
          </div>
        ...
        {showQRModal && (
          <div className="fixed inset-0 z-[10000] flex flex-col">
            <div className="relative bg-white w-full h-full overflow-hidden flex flex-col">
              ...
              {/* QR Modal Content */}
              <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 active:bg-blue-700 text-white rounded-lg transition-colors font-medium touch-button"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gray-600 active:bg-gray-700 text-white rounded-lg transition-colors font-medium touch-button"
                  >
                    <Copy className="w-4 h-4" />
                    Copy Link
                  </button>
