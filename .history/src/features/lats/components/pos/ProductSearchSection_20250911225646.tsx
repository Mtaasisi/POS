      ...
      <GlassCard className="p-3 sm:p-4 lg:p-6 h-full flex flex-col">
        ...
        <div className="flex-shrink-0 mb-6 space-y-4">
          ...
          <div className="relative">
            <Search className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 sm:w-6 sm:h-6 text-blue-500" />
            <input
              type="text"
              ...
              className="w-full pl-12 sm:pl-14 pr-20 sm:pr-24 py-3 sm:py-4 lg:py-5 text-base sm:text-lg border-2 border-blue-200 rounded-xl bg-white text-gray-900 placeholder-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-500/30 focus:border-blue-500 shadow-lg hover:shadow-xl transition-all duration-200"
              style={{ minHeight: '48px' }}
            />
            
            {/* Loading indicator */}
            {isSearching && (
              <div className="absolute left-12 sm:left-14 top-1/2 transform -translate-y-1/2">
            ...
            <div className="absolute right-2 sm:right-3 top-1/2 transform -translate-y-1/2 flex items-center gap-1 sm:gap-2">
              {canAddProducts && (
                <button
                  ...
                  className="p-2 sm:p-3 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg active:scale-95"
                ...
                <button
                  ...
                  className="p-2 sm:p-3 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg transition-colors duration-200"
              ...
              <button
                ...
                className="p-2 sm:p-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg active:scale-95"
