      ...
      <div className="px-3 py-2 sm:px-6 sm:py-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          ...
          <div className="flex items-center justify-center w-full sm:w-auto">
            {cartItemsCount > 0 ? (
              <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-6 py-2 bg-green-50 border border-green-200 rounded-xl shadow-sm">
                <ShoppingCart size={16} className="text-green-600 sm:hidden" />
                <ShoppingCart size={18} className="text-green-600 hidden sm:block" />
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="text-center">
                    <div className="text-xs font-medium text-green-700">Items</div>
                    <div className="text-sm font-bold text-green-800">{cartItemsCount}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xs font-medium text-green-700">Total</div>
