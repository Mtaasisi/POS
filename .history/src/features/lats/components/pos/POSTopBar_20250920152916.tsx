      ...
      <div className="px-3 py-2 sm:px-6 sm:py-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          ...
          <div className="flex items-center justify-center w-full sm:w-auto">
            {cartItemsCount > 0 ? (
              <div className="flex items-center gap-4 px-6 py-2 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200/60 rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 min-w-[280px] sm:min-w-[320px]">
                ...
                <div className="flex items-center gap-6 flex-1">
                  <div className="text-center flex-1">
                    <div className="text-xs font-medium text-green-600/80 uppercase tracking-wide">Items</div>
                    <div className="text-base font-bold text-green-800">{cartItemsCount}</div>
                  </div>
                  <div className="w-px h-8 bg-green-200"></div>
                  <div className="text-center flex-1">
                    <div className="text-xs font-medium text-green-600/80 uppercase tracking-wide">Total</div>
                    <div className="text-base font-bold text-green-800">{formatMoney(totalAmount)}</div>
                  </div>
                </div>
                
                {/* Customer Badge */}
                {hasSelectedCustomer && (
                  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-500/10 border border-blue-200/50 rounded-xl">
                    <User size={14} className="text-blue-600" />
                    <span className="text-xs font-medium text-blue-700 hidden sm:inline">Customer</span>
                    <span className="text-xs font-medium text-blue-700 sm:hidden">C</span>
                  </div>
                )}
              </div>
            ) : (
              <div className="flex items-center gap-3 px-6 py-2 bg-gray-50/80 border border-gray-200/60 rounded-2xl min-w-[200px]">
                <ShoppingCart size={18} className="text-gray-400" />
                <span className="text-sm font-medium text-gray-500">Empty Cart</span>
              </div>
            )}
          </div>
