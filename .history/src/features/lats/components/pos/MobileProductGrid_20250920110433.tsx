...
const MobileProductGrid: React.FC<MobileProductGridProps> = ({
  ...
  const ProductCard = ({ product }: { product: ProductSearchResult }) => {
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mobile-product-card">
        {/* Product Image */}
        <div className="relative h-24 sm:h-32 bg-gray-50">
          ...
          {product.stock_quantity !== undefined && (
            <div className={`absolute top-1 left-1 px-1.5 py-0.5 rounded-full text-xs font-medium ${
        ...
        <div className="p-2 sm:p-3">
          ...
          {product.variants && product.variants.length > 1 && (
            <div className="mb-1">
              <select
                ...
                className="w-full text-xs border border-gray-200 rounded-lg px-2 py-1 touch-input"
              >
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-1 rounded-full active:bg-gray-100 touch-target"
              >
                <Minus size={14} />
              </button>
          ...
          <button
            ...
            className="w-full py-2 bg-blue-500 text-white font-medium rounded-lg active:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors text-xs sm:text-sm touch-button"
          >
