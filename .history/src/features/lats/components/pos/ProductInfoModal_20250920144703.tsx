...
const ProductInfoModal: React.FC<ProductInfoModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      {/* Modal */}
      <div 
        className="relative bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[85vh] overflow-hidden mx-4"
      ...
      >
        ...
        {/* Content */}
        <div className="p-4 overflow-y-auto max-h-[calc(85vh-140px)] pb-20">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-100 rounded-b-2xl">
          <div className="flex items-center gap-3">
