  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-medium text-gray-900">{totalStock}</p>
                  </div>
                  <div className="space-y-1">
                    <span className="text-xs text-gray-500 uppercase tracking-wide">Images</span>
                    <p className="text-sm font-medium text-gray-900">{productImages.length} photo{productImages.length !== 1 ? 's' : ''}</p>
                  </div>
                </div>
              </div>
              ...
              {product.variants && product.variants.length > 0 && (
                <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  ...
                  <div className="space-y-2">
                    {(showAllVariants ? product.variants : product.variants.slice(0, 5)).map((variant, index) => {
                      const isSelected = selectedVariant?.id === variant.id;
                      return (
                        <div 
                          key={variant.id || index} 
                          className={`flex justify-between items-center py-2 px-3 rounded-lg cursor-pointer transition-all ${
                            isSelected 
                    ...
                    {product.variants.length > 5 && (
                      <button
                        ...
                        className="w-full text-xs text-blue-600 hover:text-blue-800 text-center py-2 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors font-medium"
                      >
                        {showAllVariants 
                          ? `Show Less (${product.variants.length - 5} hidden)` 
                          : `Show More (+${product.variants.length - 5} variants)`
                        }
                      </button>
                    )}
                  </div>
              ...
              {currentVariant && (
                <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    {currentVariant.costPrice && currentVariant.costPrice > 0 && (
                      <div className="space-y-1">
        ...
        {/* Action Buttons */}
        <div className="flex items-center justify-between pt-6 border-t border-gray-100 px-6 pb-6">
          <div className="flex items-center gap-2">
            ...
            {currentVariant && currentVariant.quantity <= 0 && (
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-500 rounded-lg font-medium">
