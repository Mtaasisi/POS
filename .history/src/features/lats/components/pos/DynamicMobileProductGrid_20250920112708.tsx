      ...
      <div className="flex-1 overflow-y-auto p-4 lg:p-6">
        {isLoading ? (
          ...
          <>
            <div className={
              viewMode === 'grid' 
                ? `grid ${HD_OPTIMIZATIONS.gridLayout.mobile} ${HD_OPTIMIZATIONS.gridLayout.tablet} ${HD_OPTIMIZATIONS.gridLayout.desktop} ${HD_OPTIMIZATIONS.gridLayout.hd} ${HD_OPTIMIZATIONS.gridLayout.ultraHd} ${HD_OPTIMIZATIONS.spacing.gap.mobile} ${HD_OPTIMIZATIONS.spacing.gap.desktop} ${HD_OPTIMIZATIONS.spacing.gap.hd}` 
                : 'space-y-4'
            }>
