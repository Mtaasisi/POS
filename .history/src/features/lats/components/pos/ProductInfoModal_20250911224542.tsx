                  ...
                  {product.variants.map((variant, index) => {
                    ...
                    return (
                      <div key={variant.id} className="border border-gray-200 rounded-lg p-4">
                        ...
                        {specifications && Object.entries(specifications).filter(([key, value]) => value !== null && value !== undefined && value !== '' && value !== 'null').length > 0 && (
                          <div className="grid grid-cols-2 gap-2">
                            {Object.entries(specifications)
                              .filter(([key, value]) => value !== null && value !== undefined && value !== '' && value !== 'null')
                              .map(([key, value]) => {
