      ...
      <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 max-w-4xl w-full p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            {/* Preview */}
            {discountValue && (
              <div className="p-4 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl border-2 border-blue-200 shadow-lg">
                <div className="text-base font-bold text-blue-800 mb-3">Discount Preview</div>
                <div className="space-y-2">
                  ...
                  <div className="border-t-2 border-blue-200 pt-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-bold text-green-600">{formatMoney(finalTotal)}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-3">Number Keyboard</label>
