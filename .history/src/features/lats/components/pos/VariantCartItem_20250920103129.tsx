...
const VariantCartItem: React.FC<VariantCartItemProps> = ({
  ...
  if (variant === 'compact') {
    return (
      <GlassCard className={`transition-all duration-200 ease-in-out backdrop-blur-sm relative bg-lats-surface border-lats-glass-border p-4 rounded-lats-radius-lg shadow-lats-glass-shadow border border-lats-glass-border overflow-visible ${className}`}>
  ...
  return (
    <GlassCard className={`transition-all duration-200 ease-in-out backdrop-blur-sm relative bg-lats-surface border-lats-glass-border p-6 rounded-lats-radius-lg shadow-lats-glass-shadow border border-lats-glass-border overflow-visible ${className}`}>
      {/* Product Header */}
