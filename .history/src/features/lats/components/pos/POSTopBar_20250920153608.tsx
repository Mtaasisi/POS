      ...
      <div className="px-3 py-2 sm:px-6 sm:py-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          ...
          <div className="flex items-center justify-center w-full sm:w-auto">
            <div className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/60 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 min-h-[44px]">
              {/* Sales Icon */}
              <DollarSign size={18} className="text-blue-600" />
              
              {/* Sales Info */}
              <div className="text-center">
                <div className="text-xs font-medium text-blue-600/80 uppercase tracking-wide">Today's Sales</div>
                <div className="text-sm font-bold text-blue-800">{formatMoney(todaysSales)}</div>
              </div>
            </div>
          </div>
