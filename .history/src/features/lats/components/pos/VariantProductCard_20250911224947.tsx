          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              {primaryVariant && primaryVariant.attributes && Object.keys(primaryVariant.attributes).length > 0 && (() => {
                ...
                const validSpecifications = Object.entries(primaryVariant.attributes).filter(([key, value]) => 
                ...
                return (
                  <div className="mt-1">
                    <div className="flex flex-wrap gap-1">
                      {validSpecifications.slice(0, 2).map(([key, value]) => {
      ...
      >
        ...
        <div className="p-6 cursor-pointer">
          ...
          {primaryVariant && primaryVariant.attributes && Object.keys(primaryVariant.attributes).length > 0 && (() => {
            ...
            // Filter out null/undefined/empty values
            const validSpecifications = Object.entries(specifications).filter(([key, value]) => 
              value !== null && value !== undefined && value !== '' && value !== 'null' && value !== 'undefined'
            );
            ...
            return (
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {validSpecifications
                    .slice(0, showAllSpecifications ? undefined : 2)
                    .map(([key, value]) => {
                      ...
                      >
                        {showAllSpecifications ? (
                          ...
                          <>
                            ...
                            Show {validSpecifications.length - 2} More Specifications
                          </>
                        )}
                      </button>
                    </div>
