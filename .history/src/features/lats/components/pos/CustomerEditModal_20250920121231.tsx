...
const CustomerEditModal: React.FC<CustomerEditModalProps> = ({
  ...
  const getMissingFields = () => {
    ...
    if (isFieldMissing(customer.email)) missingFields.push('Email');
    if (isFieldMissing(customer.whatsapp)) missingFields.push('WhatsApp');
    if (isFieldMissing(customer.city)) missingFields.push('City');
    if (isFieldMissing(customer.locationDescription)) missingFields.push('Location Description');
    if (isFieldMissing(customer.nationalId)) missingFields.push('National ID');
    if (isFieldMissing(customer.referralSource)) missingFields.push('Referral Source');
    ...
    if (isFieldMissing(customer.initialNotes)) missingFields.push('Initial Notes');
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                    ...
                    Email Address
                    {isFieldMissing(customer?.email) && <AlertCircle className="w-4 h-4 text-orange-500" />}
                  </label>
                  <input
                    type="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                    ...
                    {isFieldMissing(customer?.locationDescription) && <AlertCircle className="w-4 h-4 text-orange-500" />}
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                    ...
                    National ID
                    {isFieldMissing(customer?.nationalId) && <AlertCircle className="w-4 h-4 text-orange-500" />}
                  </label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                    ...
                    Referral Source
                    {isFieldMissing(customer?.referralSource) && <AlertCircle className="w-4 h-4 text-orange-500" />}
                  </label>
                  <input
                    type="text"
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                    <FileText className="w-4 h-4" />
                    Initial Notes
                    {isFieldMissing(customer?.initialNotes) && <AlertCircle className="w-4 h-4 text-orange-500" />}
                  </label>
                  <textarea
                    value={formData.initialNotes}
                    onChange={(e) => handleInputChange('initialNotes', e.target.value)}
                    rows={3}
                    placeholder="Initial notes when customer was registered..."
