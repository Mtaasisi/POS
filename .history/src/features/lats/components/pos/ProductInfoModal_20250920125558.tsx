        ...
        <div className="p-3 sm:p-6 overflow-y-auto max-h-[calc(95vh-100px)] sm:max-h-[calc(90vh-120px)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              {product.specification && Array.isArray(product.specification) && product.specification.length > 0 && (
                <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 space-y-2 sm:space-y-3">
                  <div className="flex items-center gap-2 pb-1.5 sm:pb-2 border-b border-gray-100">
                  ...
                  <div className="grid grid-cols-1 gap-2 sm:gap-3">
                    {Array.isArray(product.specification) && product.specification.slice(0, 4).map((spec: { name: string; value: string }, index: number) => (
                      <div key={index} className="flex items-center justify-between py-1.5 sm:py-2 px-2 sm:px-3 bg-gray-50 rounded-md sm:rounded-lg">
                        <div className="flex items-center gap-1.5 sm:gap-2">
                          <div className="w-4 h-4 text-gray-500">
                            {getSpecificationIcon(spec.name) ? React.createElement(getSpecificationIcon(spec.name), { className: "w-4 h-4" }) : <Tag className="w-4 h-4" />}
                          </div>
                          <span className="text-xs sm:text-sm font-medium text-gray-900 truncate">{spec.name}</span>
                        </div>
                    ...
                    {product.specification.length > 4 && (
                      <div className="text-xs text-gray-500 text-center py-1.5 sm:py-2 bg-gray-50 rounded-md sm:rounded-lg">
                        +{product.specification.length - 4} more specifications
                      </div>
                    )}
                  </div>
                </div>
