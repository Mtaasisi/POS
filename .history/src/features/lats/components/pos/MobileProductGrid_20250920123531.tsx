...
const MobileProductGrid: React.FC<MobileProductGridProps> = ({
  ...
  const ProductCard = ({ product }: { product: ProductSearchResult }) => {
    ...
    return (
      <div className="bg-white rounded-md shadow-sm border border-gray-100 overflow-hidden h-full flex flex-col">
        {/* Product Image */}
        <div className="relative h-16 sm:h-20 bg-gray-50 flex-shrink-0">
          <ProductImage
            ...
            fallback={
              <div className="w-full h-full flex items-center justify-center bg-gray-100">
                <Package size={16} className="text-gray-400 sm:hidden" />
          ...
          {product.stock_quantity !== undefined && (
            <div className={`absolute top-0.5 left-0.5 px-1 py-0.5 rounded-full text-xs font-medium shadow-sm ${
        ...
        <div className="p-1.5 sm:p-2 flex-1 flex flex-col">
          <div className="flex-1">
            <h3 className="font-semibold text-gray-900 text-xs sm:text-sm mb-0.5 line-clamp-2 leading-tight">
              {product.name}
            </h3>
            ...
            {product.variants && product.variants.length > 1 && (
              <div className="mb-0.5">
                <select
                  ...
                  className="w-full text-xs border border-gray-200 rounded-sm px-1.5 py-0.5 touch-input bg-white"
                >
            ...
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="flex items-center gap-0.5 bg-gray-50 rounded-sm p-0.5">
                ...
                <span className="px-1 py-0.5 bg-white rounded text-xs font-medium min-w-[1.25rem] text-center border">
                  {quantity}
                </span>
                <button
          ...
          <button
            ...
            className="w-full py-1.5 bg-blue-500 text-white font-medium rounded-sm active:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors text-xs touch-button shadow-sm"
          >
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* Products Grid/List */}
      <div className="flex-1 overflow-y-auto p-2 mobile-scroll">
        {isLoading ? (
          ...
          <div className={
            viewMode === 'grid' 
              ? 'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-1.5 sm:gap-2' 
