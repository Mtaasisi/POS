...
import { Search, RefreshCw, Package, Command, QrCode, Filter, X } from 'lucide-react';
      ...
      <GlassCard className="p-6 h-full flex flex-col">
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-1 text-xs border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/80"
                  />
                </div>
              </div>
        ...
        <div className="flex-1 overflow-y-auto scrollbar-transparent">
          {displayProducts.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-3 pb-4">
