      ...
      <div className="px-3 py-2 sm:px-6 sm:py-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          ...
          <div className="flex items-center justify-center w-full sm:w-auto">
            {cartItemsCount > 0 ? (
              <div className="flex items-center gap-3 px-4 py-2 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200/60 rounded-2xl shadow-sm hover:shadow-md transition-all duration-200">
                ...
                {/* Customer Badge */}
                {hasSelectedCustomer && (
                  <div className="flex items-center gap-1.5 px-2.5 py-1 bg-blue-500/10 border border-blue-200/50 rounded-xl">
              ...
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-50/80 border border-gray-200/60 rounded-2xl">
