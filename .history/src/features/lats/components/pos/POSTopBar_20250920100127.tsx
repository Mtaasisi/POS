          ...
          <div className="flex items-center gap-3">
            ...
            {cartItemsCount > 0 && (
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-lats-finance-500 text-white rounded-lg hover:bg-lats-finance-600 disabled:bg-neutral-400 transition-all duration-200 font-semibold shadow-glow-green hover:shadow-glow-green"
              >
                <CreditCard size={18} />
            ...
            {cartItemsCount > 0 && (
              <button
                onClick={onClearCart}
                className="flex items-center gap-2 px-4 py-2 bg-error-50 text-error-700 rounded-lg hover:bg-error-100 transition-all duration-200 border border-error-200 shadow-soft"
              >
                <Trash2 size={16} />
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-2 rounded-lg bg-neutral-100 text-neutral-700 hover:bg-neutral-200 transition-all duration-200 shadow-soft"
                title="Sales Reports"
              >
                <BarChart3 size={18} />
              </button>
