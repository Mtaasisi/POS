...
const ProductDetailModal: React.FC<ProductDetailModalProps> = ({
  ...
  useEffect(() => {
    if (isOpen && product) {
      ...
      const missingInfo = [];
      if (!product.categoryId) missingInfo.push('categoryId');
  ...
  // DEBUG: Log PO history data
  useEffect(() => {
    if (isOpen) {
      console.log('🔍 PO History Debug:', {
        productId: product?.id,
        historyCount: purchaseOrderHistory.length,
        isLoading: isLoadingPOHistory,
        stats: poStats,
        history: purchaseOrderHistory
      });
    }
  }, [isOpen, purchaseOrderHistory, isLoadingPOHistory, poStats, product?.id]);
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-lg font-semibold text-gray-800">Purchase Order History</h3>
                    </div>
                  ...
                  {isLoadingPOHistory ? (
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 p-6 shadow-sm">
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-400 mt-1">This will be the first order for this product</p>
                      </div>
                    </div>
                  ) : (
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 p-6 shadow-sm space-y-4">
                      {/* Statistics Grid */}
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
                          ...
                          <div className="text-2xl font-bold text-blue-900">{poStats.totalOrders}</div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
                          ...
                          <div className="text-2xl font-bold text-purple-900">{poStats.totalQuantityOrdered}</div>
                      ...
                      {showPOHistory && purchaseOrderHistory.length > 0 && (
                        <div className="space-y-2 max-h-64 overflow-y-auto">
                          <div className="text-sm font-medium text-gray-700 mb-2 sticky top-0 bg-white/80 backdrop-blur-sm py-2">
                              ...
                              <div className="grid grid-cols-2 gap-2 text-xs">
                                ...
                                <div className="col-span-2">
                                  ...
                                  <div className="font-bold text-gray-900">
                                    {formatMoney(order.costPrice, currency)} per unit
                                  </div>
                                </div>
                              </div>
                            </div>
