...
import { 
  ...
  Send, Package, AlertCircle, RefreshCw, FileText,
  XSquare, ShoppingCart, List, Grid, ChevronDown, ChevronUp, Ship, PackageCheck,
  Printer, ArrowLeft, Star, Archive, CreditCard
} from 'lucide-react';
...
// Simplified status options - main workflow uses 'sent' and 'received'
// 'draft' and 'cancelled' exist in database but are for internal use only
