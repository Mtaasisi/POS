...
type OrderStatus = 'draft' | 'pending_approval' | 'approved' | 'sent' | 'confirmed' | 'shipped' | 'received' | 'partial_received' | 'quality_checked' | 'completed' | 'cancelled';
...
const OrderCard: React.FC<OrderCardProps> = ({
  ...
  const getAvailableStatuses = (currentStatus: OrderStatus): OrderStatus[] => {
    switch (currentStatus) {
      ...
      case 'completed': return []; // No further actions needed
