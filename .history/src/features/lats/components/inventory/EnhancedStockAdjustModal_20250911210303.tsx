                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        {adjustmentTypeOptions.map((option) => (
                          <button
                            ...
                            className={`p-4 rounded-lats-radius-md border-2 transition-all duration-200 ${
                              field.value === option.value
                                ? option.value === 'in'
                                  ? 'border-green-500 bg-green-500/10 text-green-700'
                                  : option.value === 'out'
                                  ? 'border-red-500 bg-red-500/10 text-red-700'
                                  : 'border-lats-primary bg-lats-primary/10 text-lats-primary'
                                : 'border-lats-glass-border hover:border-lats-primary/50 hover:bg-lats-surface/50 text-lats-text'
                            }`}
                          >
