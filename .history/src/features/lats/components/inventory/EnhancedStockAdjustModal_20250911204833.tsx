...
import { z } from 'zod';
import { Package, TrendingUp, TrendingDown, Settings, Info, CheckCircle, AlertCircle } from 'lucide-react';
              ...
              render={({ field }) => (
                <div className="space-y-3">
                  ...
                  {errors.selectedVariantId && (
                    <p className="text-red-500 text-sm">{errors.selectedVariantId.message}</p>
                  )}
                </div>
              )}
            />
