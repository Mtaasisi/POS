            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200/50">
                  ...
                  <th className="text-right py-4 px-4 font-medium text-gray-700">Cost Price</th>
                  <th className="text-right py-4 px-4 font-medium text-gray-700">Selling Price</th>
                  <th className="text-right py-4 px-4 font-medium text-gray-700">Profit Margin</th>
                  <th className="text-right py-4 px-4 font-medium text-gray-700">Stock</th>
                  <th className="text-right py-4 px-4 font-medium text-gray-700">Total Value</th>
                  <th className="text-center py-4 px-4 font-medium text-gray-700">Variants</th>
              ...
              <tbody>
                {products.map((product) => {
                  ...
                  const costPrice = mainVariant?.costPrice || 0;
                  const sellingPrice = mainVariant?.sellingPrice || 0;
                  ...
                  const totalValue = product.variants?.reduce((sum: number, variant: any) => 
                    sum + ((variant.quantity || 0) * (variant.costPrice || 0)), 0) || 0;
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-4 px-4 text-right">
                        <span className="font-medium text-gray-900">{formatMoney(costPrice)}</span>
                      </td>
                      <td className="py-4 px-4 text-right">
                        <span className="font-semibold text-gray-900">{formatMoney(sellingPrice)}</span>
                      </td>
                      <td className="py-4 px-4 text-right">
