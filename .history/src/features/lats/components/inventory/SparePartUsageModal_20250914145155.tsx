          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{sparePart.part_number}</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium text-gray-900">{sparePart.min_quantity}</span>
              </div>
              <div>
                <span className="text-gray-500">Cost:</span>
                <span className="ml-2 font-medium text-gray-900">{format.currency(sparePart.cost_price)}</span>
              </div>
              <div>
                <span className="text-gray-500">Selling:</span>
                <span className="ml-2 font-medium text-gray-900">{format.currency(sparePart.selling_price)}</span>
              </div>
            </div>
          </div>
