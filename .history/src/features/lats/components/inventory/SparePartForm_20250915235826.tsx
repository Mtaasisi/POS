...
const SparePartForm: React.FC<SparePartFormProps> = ({ 
  ...
  const loadSparePartImages = async () => {
    ...
    try {
      ...
      console.log('🔍 [SparePartForm] Database images result:', dbImages);
      ...
      if (dbImages && dbImages.length > 0) {
        ...
        console.log('✅ [SparePartForm] Images loaded for editing:', formattedImages);
      } else {
        ...
        console.log('🔄 [SparePartForm] Spare part images array:', sparePartImages);
        ...
        if (sparePartImages.length > 0) {
          ...
          console.log('✅ [SparePartForm] Using fallback images:', fallbackImages);
        } else {
