          ...
          <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
            ...
            {selectedVariant && (
              <>
                ...
                <div className="space-y-3">
                  <label className="block text-base font-semibold text-lats-text mb-2">
                    Adjustment Type <span className="text-lats-error">*</span>
                  </label>
                  <Controller
                    name="adjustmentType"
                    control={control}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        {adjustmentTypeOptions.map((option) => (
                          <button
                            ...
                            className={`p-6 rounded-lats-radius-lg border-2 transition-all duration-300 hover:scale-[1.02] min-h-[120px] ${
                              field.value === option.value
                                ? option.value === 'in'
                                  ? 'border-lats-success bg-lats-success/20 text-white shadow-lg shadow-lats-success/30'
                                  : option.value === 'out'
                                  ? 'border-lats-error bg-lats-error/20 text-white shadow-lg shadow-lats-error/30'
                                  : 'border-lats-primary bg-lats-primary/20 text-white shadow-lg shadow-lats-primary/30'
                                : 'border-lats-glass-border hover:border-lats-primary/50 hover:bg-lats-surface/30 text-lats-text hover:shadow-md backdrop-blur-sm'
                            }`}
                          >
                            <div className="flex flex-col items-center gap-3">
                              <div className="text-3xl filter drop-shadow-sm">{option.icon}</div>
                  ...
                  {errors.adjustmentType && (
                    <p className="text-lats-error text-sm mt-2 flex items-center gap-1">
