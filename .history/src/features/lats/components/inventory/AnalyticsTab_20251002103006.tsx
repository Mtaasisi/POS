...
import { 
  ...
  TrendingDown, Users, Building, Clock,
  ShoppingCart, Activity, Award, Calendar,
  Hash, MapPin, Truck, QrCode, FileText,
  Layers, Info, CheckCircle2, Copy, Download
} from 'lucide-react';
      ...
      try {
        ...
        if (!salesError && sales) {
          ...
          setSalesData({
            ...
            averageOrderValue: sales.length > 0 ? sales.reduce((sum, sale) => sum + (sale.total_amount || 0), 0) / sales.length : 0
          });
        }
          ...
          <GlassCard className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Real sales data from the last 30 days</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
                ...
                <div className="text-2xl font-bold text-green-900">{formatMoney(salesData.totalRevenue)}</div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
                ...
                <div className="text-2xl font-bold text-blue-900">{salesData.totalTransactions}</div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
                ...
                <div className="text-2xl font-bold text-purple-900">{formatMoney(salesData.averageOrderValue)}</div>
              </div>
              
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4 border border-orange-200">
                <div className="flex items-center gap-2 mb-2">
                  <Target className="w-4 h-4 text-orange-600" />
                  <span className="text-sm font-medium text-orange-700">Top Products</span>
                </div>
                <div className="text-2xl font-bold text-orange-900">{salesData.topSellingProducts.length}</div>
              </div>
            </div>
