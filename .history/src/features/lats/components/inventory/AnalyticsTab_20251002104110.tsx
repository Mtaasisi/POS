...
const AnalyticsTab: React.FC<AnalyticsTabProps> = ({
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {salesData.topSellingProducts.slice(0, 5).map((product: any, index: number) => {
                  ...
                  return (
                    <div key={product.productId} className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center">
                          <span className="text-xs font-semibold text-blue-600">{index + 1}</span>
                        </div>
                        <div>
                          <span className="text-sm font-medium text-gray-900">{productInfo?.name || 'Unknown Product'}</span>
                          <div className="text-xs text-gray-500">{product.salesCount} sales</div>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="text-sm font-semibold text-gray-900">{product.totalSold} units</div>
                        <div className="text-xs text-gray-600">{formatMoney(product.totalRevenue)}</div>
                      </div>
                    </div>
                  );
                })}
      ...
      {/* Supplier Performance Analytics - Following GeneralProductDetailModal Design */}
      {supplierData && (
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
          <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
          ...
          <div className="text-xs text-gray-500 mb-3">Supplier analytics and ratings</div>
            
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1">
              <span className="text-xs text-gray-500 uppercase tracking-wide">Total Suppliers</span>
              <p className="text-lg font-bold text-orange-600">{supplierData.totalSuppliers}</p>
            </div>
            
            <div className="space-y-1">
              <span className="text-xs text-gray-500 uppercase tracking-wide">Avg Rating</span>
              <p className="text-lg font-bold text-yellow-600">{supplierData.averageRating.toFixed(1)}/5</p>
            </div>
            
            <div className="space-y-1">
              <span className="text-xs text-gray-500 uppercase tracking-wide">Top Rated</span>
              <p className="text-lg font-bold text-green-600">{supplierData.topSuppliers.length}</p>
            </div>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {supplierData.topSuppliers.map((supplier: any, index: number) => (
                  <div key={supplier.id} className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-3">
                    ...
                    <div className="text-right">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm font-semibold text-gray-900">{supplier.rating || 0}/5</span>
                      </div>
                      <div className="text-xs text-gray-600">{supplier.total_orders || 0} orders</div>
                    </div>
                  </div>
                ))}
              </div>
      ...
      {/* Recent Activity - Following GeneralProductDetailModal Design */}
      {recentActivity.length > 0 && (
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
          ...
          <div className="text-xs text-gray-500 mb-3">Latest sales and transactions</div>
          ...
          <div className="space-y-2">
            {recentActivity.slice(0, 5).map((activity: any) => (
              <div key={activity.id} className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg">
                ...
                <div className="text-right">
                  <div className="text-sm font-semibold text-gray-900">{formatMoney(activity.amount)}</div>
      ...
      {/* Advanced Business Intelligence - Following GeneralProductDetailModal Design */}
      <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
        <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
        ...
        <div className="text-xs text-gray-500 mb-3">Advanced analytics and insights</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-semibold text-gray-800">ABC Analysis</span>
            </div>
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                <span className="text-gray-600">A-Class (High Value)</span>
                <span className="font-semibold text-gray-900">
                  {analytics.categoryStats.slice(0, 1).length} categories
                </span>
              </div>
              <div className="flex justify-between text-xs">
                <span className="text-gray-600">B-Class (Medium Value)</span>
                <span className="font-semibold text-gray-900">
                  {analytics.categoryStats.slice(1, 3).length} categories
                </span>
              </div>
              <div className="flex justify-between text-xs">
                <span className="text-gray-600">C-Class (Low Value)</span>
                <span className="font-semibold text-gray-900">
          ...
          <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-semibold text-gray-800">Inventory Turnover</span>
            </div>
            <div className="space-y-1">
              <div className="text-lg font-bold text-green-600">
                {salesData ? (salesData.totalRevenue / analytics.totalValue).toFixed(2) : 'N/A'}
              </div>
              <div className="text-xs text-gray-600">Times per month</div>
              <div className="text-xs text-gray-500">
          ...
          <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-semibold text-gray-800">Profitability</span>
            </div>
            <div className="space-y-1">
              <div className="text-lg font-bold text-purple-600">
                {analytics.profitMargin.toFixed(1)}%
              </div>
              <div className="text-xs text-gray-600">Average margin</div>
              <div className="text-xs text-gray-500">
