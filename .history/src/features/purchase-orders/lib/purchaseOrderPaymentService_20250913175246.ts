...
class PurchaseOrderPaymentService {
  ...
  async createPurchaseOrderPayment(data: CreatePurchaseOrderPaymentData): Promise<PurchaseOrderPayment> {
    try {
      ...
      // Create payment record - temporarily omit created_by to avoid foreign key constraint issue
      // TODO: Fix the foreign key constraint to point to auth_users instead of auth.users
      ...
      const { data: paymentRecord, error: paymentError } = await supabase
        ...
        .insert({
          ...
          // Temporarily omitting created_by due to foreign key constraint issue
