    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="text-lg font-bold">Repair Parts</h2>
          ...
          <div className="grid grid-cols-4 gap-3">
            <GlassCard className="p-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-lg font-bold text-orange-600">{partsNeeded}</div>
            ...
            <GlassCard className="p-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-lg font-bold text-blue-600">{partsReceived}</div>
            ...
            <GlassCard className="p-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-lg font-bold text-green-600">{partsUsed}</div>
          ...
          {!showAddPart ? (
            ...
            <GlassCard className="p-4">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-base font-semibold">Add New Part</h3>
                <button
        ...
        <div className="bg-gray-50 px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <GlassButton variant="outline" onClick={onClose} className="text-sm">
              Close
            </GlassButton>
            <GlassButton
              onClick={() => {
