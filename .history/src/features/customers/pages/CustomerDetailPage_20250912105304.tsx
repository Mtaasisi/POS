...
const CustomerDetailPage: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-6">
      ...
      {/* Customer Info Card - Reorganized */}
      <GlassCard className="mb-6">
        {/* Header Section */}
        <div className="flex flex-col sm:flex-row items-start gap-4 mb-6">
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center border-2 border-white/30 flex-shrink-0">
            <Users className="w-8 h-8 sm:w-10 sm:h-10 text-blue-600" />
          </div>
          <div className="flex-1 min-w-0">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 truncate">{customer.name}</h2>
            <div className="flex flex-wrap items-center gap-2 mb-3">
              <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${customer.colorTag === 'vip' ? 'bg-emerald-500/20 text-emerald-700 border border-emerald-500/30' : customer.colorTag === 'complainer' ? 'bg-rose-500/20 text-rose-700 border border-rose-500/30' : customer.colorTag === 'purchased' ? 'bg-blue-500/20 text-blue-700 border border-blue-500/30' : customer.colorTag === 'new' ? 'bg-purple-500/20 text-purple-700 border border-purple-500/30' : 'bg-gray-500/20 text-gray-700 border border-gray-500/30'}`}>
                <Tag size={12} />
                <span className="capitalize">{customer.colorTag}</span>
              </span>
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-amber-500/20 text-amber-700 border border-amber-500/30">
                <Star size={12} />
                <span className="capitalize">{customer.loyaltyLevel}</span>
              </span>
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-emerald-500/20 text-emerald-700 border border-emerald-500/30">
                <Gift size={12} />
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-gray-600">
              ...
              <div className="flex items-center gap-1">
                ...
                {isCheckedInToday && (
                  <span className="ml-1 px-1.5 py-0.5 bg-green-100 text-green-700 rounded-full text-xs">Today</span>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white/10 rounded-lg p-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 p-3 bg-white/20 rounded-lg">
                  ...
                  <span className="text-gray-700">{customer.city || 'Location not set'}</span>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex items-center gap-3 p-3 bg-white/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium text-gray-900 capitalize">{customer.gender || 'Not provided'}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-white/20 rounded-lg">
                  ...
                  <div>
                    <div className="text-xs text-gray-500 uppercase tracking-wide">Birthday</div>
                ...
                <div className="flex items-center gap-3 p-3 bg-white/20 rounded-lg">
                  ...
                  <div>
                    <div className="text-xs text-gray-500 uppercase tracking-wide">Referral Source</div>
                    <div className="text-sm font-medium text-gray-900">{customer.referralSource || 'Not provided'}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-white/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium text-gray-900">{referrals} customers</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-xl p-4 border border-white/20 h-full">
              ...
              <div className="space-y-3">
                ...
                >
                  <CheckCircle size={16} />
                  {isCheckedInToday ? 'Checked In Today' : 'Manual Check-in'}
                </GlassButton>
              </div>
            </div>
          </div>
