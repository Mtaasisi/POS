  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        {searchLoading ? (
          <Loader2 size={18} className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 animate-spin opacity-60" />
        ) : (
        ...
        {searchLoading && (
          <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
            <div className="flex items-center gap-1 text-xs text-gray-500 opacity-70">
