                  ...
                  <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 space-y-2 sm:space-y-3">
                    ...
                    <div className="space-y-1.5 sm:space-y-2">
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors text-xs sm:text-sm font-medium"
                      >
