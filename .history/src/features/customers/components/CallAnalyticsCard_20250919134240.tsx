...
const CallAnalyticsCard: React.FC<CallAnalyticsCardProps> = ({ customer }) => {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-6">
      ...
      {/* Innovative Summary View (Always Visible) */}
      <div className="relative overflow-hidden bg-white border border-gray-200 rounded-xl p-4 mb-4">
        {/* Background Pattern */}
        ...
        <div className="relative">
          ...
          <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <div className="absolute -top-1 -right-1 w-4 h-4 bg-blue-100 rounded-full flex items-center justify-center">
                    <span className="text-xs font-bold text-blue-600">{customer.totalCalls}</span>
                  </div>
                </div>
                <div>
                  <div className="text-sm font-semibold text-gray-900">Total Calls</div>
            ...
            {/* Loyalty Badge */}
            <div className="flex items-center gap-2">
              <div className={`px-3 py-1 rounded-full text-xs font-semibold ${getLoyaltyLevelColor(customer.callLoyaltyLevel || 'Basic')}`}>
                {getLoyaltyLevelIcon(customer.callLoyaltyLevel || 'Basic')}
                {customer.callLoyaltyLevel || 'Basic'}
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">{customer.incomingCalls || 0}</span>
              ...
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-cyan-100 rounded-lg flex items-center justify-center">
                  <PhoneOutgoing className="w-3 h-3 text-cyan-600" />
                </div>
                <span className="text-sm font-medium text-gray-700">{customer.outgoingCalls || 0}</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">{customer.missedCalls || 0}</span>
              ...
              <div className="flex items-center gap-1">
                ...
                <span>
                  {customer.firstCallDate && customer.lastCallDate ? 
                    Math.ceil((new Date(customer.lastCallDate).getTime() - new Date(customer.firstCallDate).getTime()) / (1000 * 60 * 60 * 24)) : 0}d span
                </span>
              </div>
              <div className="flex items-center gap-1">
