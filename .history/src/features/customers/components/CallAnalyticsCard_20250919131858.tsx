      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-3">
          ...
          <div className="text-xl font-bold text-purple-900">
            {formatDuration(customer.avgCallDurationMinutes || 0)}
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg p-3">
          ...
          <div className="text-xs text-orange-600">calls/month</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            <Phone className="w-4 h-4 text-blue-600" />
            <span className="text-xs font-medium text-blue-700 uppercase tracking-wide">Total Calls</span>
          </div>
          <div className="text-2xl font-bold text-blue-900">{customer.totalCalls}</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            <Clock className="w-4 h-4 text-green-600" />
            <span className="text-xs font-medium text-green-700 uppercase tracking-wide">Total Duration</span>
          </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            <BarChart3 className="w-4 h-4 text-purple-600" />
            <span className="text-xs font-medium text-purple-700 uppercase tracking-wide">Avg Duration</span>
          </div>
        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            <TrendingUp className="w-4 h-4 text-orange-600" />
            <span className="text-xs font-medium text-orange-700 uppercase tracking-wide">Call Frequency</span>
          </div>
