...
const CustomerDetailModal: React.FC<CustomerDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
      ...
      {/* Modal */}
      <div 
        className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-7xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-hidden customer-modal-container"
      ...
      >
        ...
        <div className="flex items-center justify-between p-3 sm:p-4 lg:p-6 border-b border-gray-100">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-gray-900 customer-modal-title">{customer.name}</h2>
              <p className="text-xs sm:text-sm text-blue-600 font-medium customer-modal-subtitle">{customer.phone}</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="border-b border-gray-200 bg-white">
          <div className="flex space-x-4 sm:space-x-6 lg:space-x-8 px-3 sm:px-4 lg:px-6">
            <button
              onClick={() => setActiveTab('overview')}
              className={`py-2 sm:py-3 lg:py-4 px-1 border-b-2 font-medium text-xs sm:text-sm transition-colors ${
                activeTab === 'overview'
        ...
        <div className="p-3 sm:p-4 lg:p-6 overflow-y-auto max-h-[calc(95vh-100px)] sm:max-h-[calc(90vh-120px)]">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
              {/* Financial Overview */}
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3 lg:gap-4 customer-modal-grid">
                <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4 customer-modal-card">
                  <div className="text-xs font-medium text-emerald-700 uppercase tracking-wide mb-1 customer-modal-small-text">Total Spent</div>
                  <div className="text-sm sm:text-base lg:text-lg font-bold text-emerald-900 customer-modal-text">
                    {loadingEnhancedData ? '...' : formatCurrency(customerAnalytics?.totalSpent || 0)}
                  </div>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4">
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4">
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 border border-indigo-200 rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4">
                  <div className="text-xs font-medium text-indigo-700 uppercase tracking-wide mb-1">Calls</div>
                  <div className="text-sm sm:text-base lg:text-lg font-bold text-indigo-900">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center border-2 border-white/30">
                    ...
                    <div className="flex-1">
                      <h3 className="text-base sm:text-lg font-bold text-gray-900">{customer.name}</h3>
                      <div className="flex flex-wrap items-center gap-1 sm:gap-2 text-xs text-gray-600 mt-1">
                        <span className={`inline-flex items-center gap-1 px-1.5 sm:px-2 py-0.5 rounded-full text-xs font-medium ${
                          ...
                          <span className="hidden sm:inline">{customer.colorTag}</span>
                          <span className="sm:hidden">{customer.colorTag?.charAt(0).toUpperCase()}</span>
                        </span>
                        <span className="inline-flex items-center gap-1 px-1.5 sm:px-2 py-0.5 rounded-full text-xs font-medium bg-amber-500/20 text-amber-700">
                          <Star size={8} className="sm:w-2.5 sm:h-2.5" />
                          <span className="hidden sm:inline">{customer.loyaltyLevel}</span>
                          <span className="sm:hidden">{customer.loyaltyLevel?.charAt(0)}</span>
                        </span>
                        <span className="inline-flex items-center gap-1 px-1.5 sm:px-2 py-0.5 rounded-full text-xs font-medium bg-emerald-500/20 text-emerald-700">
                          <Gift size={8} className="sm:w-2.5 sm:h-2.5" />
                          <span className="hidden sm:inline">{customer.points || 0} pts</span>
                          <span className="sm:hidden">{customer.points || 0}</span>
                        </span>
                  ...
                  {/* Contact Information */}
                  <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                      <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
                      <h3 className="text-xs sm:text-sm font-semibold text-gray-800">Contact Information</h3>
                    </div>
                    <div className="grid grid-cols-1 gap-2 sm:gap-3">
                      <div className="flex items-center gap-2 sm:gap-3">
                        <Phone className="w-3 h-3 sm:w-4 sm:h-4 text-blue-500" />
                        <span className="text-xs sm:text-sm text-gray-600">Phone:</span>
                        <span className="text-xs sm:text-sm font-medium text-blue-600">{customer.phone || 'Not provided'}</span>
                      </div>
                      {customer.whatsapp && (
                        <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <span className="text-xs sm:text-sm font-medium text-green-600">{customer.whatsapp}</span>
                        </div>
                      )}
                      {customer.email && (
                        <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <span className="text-xs sm:text-sm font-medium text-gray-900">{customer.email}</span>
                        </div>
                      )}
                      {customer.city && (
                        <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <span className="text-xs sm:text-sm font-medium text-gray-900">{customer.city}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                      ...
                      <h3 className="text-xs sm:text-sm font-semibold text-gray-800">Personal Information</h3>
                    </div>
                ...
                <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                      ...
                      <h3 className="text-xs sm:text-sm font-semibold text-gray-800">Customer Status</h3>
                    </div>
                    <div className="grid grid-cols-2 gap-2 sm:gap-3">
                      <div className="space-y-1">
                        <span className="text-xs text-gray-500 uppercase tracking-wide">Loyalty Level</span>
                        <p className="text-xs sm:text-sm font-medium text-gray-900">{customer.loyaltyLevel}</p>
                      </div>
                      <div className="space-y-1">
                        <span className="text-xs text-gray-500 uppercase tracking-wide">Total Devices</span>
                        <p className="text-xs sm:text-sm font-medium text-gray-900">{devices.length}</p>
                      </div>
                      <div className="space-y-1">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                      ...
                      <h3 className="text-xs sm:text-sm font-semibold text-gray-800">Financial Summary</h3>
                    </div>
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-xs sm:text-sm text-gray-600">Loyalty Points</span>
                        <span className="text-xs sm:text-sm font-semibold text-blue-600">
                          {customer.loyaltyPoints || 0}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-xs sm:text-sm text-gray-600">Last Purchase</span>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                      ...
                      <h3 className="text-xs sm:text-sm font-semibold text-gray-800">Quick Actions</h3>
                    </div>
                    <div className="space-y-1.5 sm:space-y-2">
                      <button
                        onClick={() => setShowSmsModal(true)}
                        className="w-full flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors text-xs sm:text-sm font-medium customer-modal-button-touch"
                      >
                        <MessageSquare className="w-3 h-3 sm:w-4 sm:h-4 customer-modal-icon" />
                        <span className="hidden sm:inline">Send SMS</span>
                        <span className="sm:hidden">SMS</span>
                      </button>
                      <button
                        onClick={() => setShowPointsModal(true)}
                        className="w-full flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors text-xs sm:text-sm font-medium"
                      >
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-lg transition-colors text-xs sm:text-sm font-medium"
                      >
          ...
          {activeTab === 'activity' && (
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
              {/* Devices Section */}
              <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <Smartphone className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" />
                    <h3 className="text-base sm:text-lg font-semibold text-gray-800">Repair History</h3>
                  </div>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full text-xs sm:text-sm customer-modal-table-responsive">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-200">
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700 customer-modal-table-cell">Device</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700 customer-modal-table-cell">Status</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700 hidden sm:table-cell customer-modal-table-cell customer-modal-table-hide-mobile">Issue</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700 customer-modal-table-cell">Created</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700 hidden sm:table-cell customer-modal-table-cell customer-modal-table-hide-mobile">Total Paid</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700 customer-modal-table-cell">Points</th>
                      </tr>
                    </thead>
                    <tbody>
                      {devices.map(device => {
                        ...
                        return (
                          <tr key={device.id} className="border-b border-gray-100 hover:bg-gray-50">
                            <td className="p-2 sm:p-3">
                              <div>
                                <div className="font-medium text-xs sm:text-sm">{device.brand} {device.model}</div>
                            ...
                            <td className="p-2 sm:p-3">
                              <span className={`inline-flex items-center px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-xs font-medium ${
                                ...
                                <span className="hidden sm:inline">{device.status.replace(/-/g, ' ')}</span>
                                <span className="sm:hidden">{device.status.split('-')[0]}</span>
                              </span>
                            </td>
                            ...
                            <td className="p-2 sm:p-3 text-xs sm:text-sm">{new Date(device.createdAt).toLocaleDateString()}</td>
                            <td className="p-2 sm:p-3 hidden sm:table-cell">
                            ...
                            <td className="p-2 sm:p-3">
                              <span className="inline-flex items-center px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                <span className="hidden sm:inline">{calculatePointsForDevice(device, customer.loyaltyLevel)} pts</span>
                                <span className="sm:hidden">{calculatePointsForDevice(device, customer.loyaltyLevel)}</span>
                              </span>
                            </td>
                          </tr>
                        );
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between pt-3 sm:pt-4 border-t border-gray-100 bg-gray-50 px-3 sm:px-4 lg:px-6 py-3 sm:py-4 gap-3 sm:gap-0">
          <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3 flex-wrap">
            <button
              ...
              className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium text-xs sm:text-sm"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors font-medium text-xs sm:text-sm"
            >
            ...
            <button
              onClick={() => setShowPointsModal(true)}
              className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors font-medium text-xs sm:text-sm"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors font-medium text-xs sm:text-sm"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors font-medium text-xs sm:text-sm"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors font-medium text-xs sm:text-sm"
            >
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              onClick={onClose}
              className="px-3 sm:px-4 py-1.5 sm:py-2 border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors text-xs sm:text-sm font-medium"
            >
              Close
            </button>
            ...
            <button
              ...
              className="flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium text-xs sm:text-sm"
            >
