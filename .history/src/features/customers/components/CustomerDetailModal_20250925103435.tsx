          ...
          {activeTab === 'overview' && (
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3 lg:gap-4 customer-modal-grid">
                <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4">
                  <div className="text-xs font-medium text-emerald-700 uppercase tracking-wide mb-1">Total Spent</div>
                  <div className="text-sm sm:text-base lg:text-lg font-bold text-emerald-900">
