  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        {searchLoading ? (
          <Loader2 size={18} className="absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-500 animate-spin" />
        ) : (
        ...
        <input
          ...
          placeholder="Search customers by name, phone, email, city, referral source, or any information..."
