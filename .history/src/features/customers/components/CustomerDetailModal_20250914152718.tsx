      ...
      >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-2 text-xs text-gray-600 mt-1">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-emerald-500/20 text-emerald-700 hover:bg-emerald-500/30 transition-colors"
                          title="Manage Points"
                        >
                          <Gift size={10} />
        ...
        <div className="flex items-center justify-between pt-6 border-t border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => {/* TODO: Open customer history modal */}}
            ...
            <button
              onClick={() => {/* TODO: Open customer notes modal */}}
