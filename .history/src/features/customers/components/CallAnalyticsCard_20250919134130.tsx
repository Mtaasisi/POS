...
const CallAnalyticsCard: React.FC<CallAnalyticsCardProps> = ({ customer }) => {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-6">
      ...
      {/* Redesigned Summary View (Always Visible) */}
      <div className="bg-gradient-to-r from-slate-50 to-gray-50 border border-gray-200 rounded-lg p-3 mb-4">
        <div className="flex items-center justify-between">
          ...
          {/* Right: Loyalty & Quick Stats */}
          <div className="flex items-center gap-4">
            <div className="text-right">
              <div className="text-sm font-semibold text-gray-900">{customer.callLoyaltyLevel || 'Basic'}</div>
              <div className="text-xs text-gray-500">loyalty level</div>
            </div>
            ...
            <div className="flex items-center gap-3 text-xs text-gray-600">
              <div className="flex items-center gap-1">
                ...
                <span>{customer.incomingCalls || 0}</span>
              </div>
              <div className="flex items-center gap-1">
                <PhoneOutgoing className="w-3 h-3 text-blue-500" />
                <span>{customer.outgoingCalls || 0}</span>
              </div>
              <div className="flex items-center gap-1">
                <PhoneMissed className="w-3 h-3 text-red-500" />
                <span>{customer.missedCalls || 0}</span>
              </div>
            </div>
          </div>
        </div>
