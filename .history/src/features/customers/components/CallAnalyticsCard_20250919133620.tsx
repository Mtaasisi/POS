...
const CallAnalyticsCard: React.FC<CallAnalyticsCardProps> = ({ customer }) => {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-6">
      ...
      {/* Enhanced Summary View (Always Visible) */}
      <div className="space-y-4 mb-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-3">
            ...
            <div className="text-xl font-bold text-blue-900">{customer.totalCalls}</div>
            <div className="text-xs text-blue-600 mt-1">
              {customer.incomingCalls || 0} in • {customer.outgoingCalls || 0} out
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-medium text-green-700">Total Duration</span>
            </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-medium text-purple-700">Call Span</span>
            </div>
            <div className="text-xl font-bold text-purple-900">
              {customer.firstCallDate && customer.lastCallDate ? 
                Math.ceil((new Date(customer.lastCallDate).getTime() - new Date(customer.firstCallDate).getTime()) / (1000 * 60 * 60 * 24)) : 0}
            </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg p-3">
            ...
            <div className="text-xl font-bold text-orange-900">
              {customer.totalCalls > 0 ? Math.round(customer.totalCalls / Math.max(1, Math.ceil((Date.now() - new Date(customer.firstCallDate || customer.createdAt || Date.now()).getTime()) / (1000 * 60 * 60 * 24 * 30)))) : 0}
            </div>
            <div className="text-xs text-orange-600 mt-1">calls/month</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-lg p-3">
            ...
            <div className="text-lg font-bold text-emerald-900">{customer.incomingCalls || 0}</div>
          ...
          <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 border border-cyan-200 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              <PhoneOutgoing className="w-4 h-4 text-cyan-600" />
              <span className="text-xs font-medium text-cyan-700">Outgoing</span>
            </div>
            <div className="text-lg font-bold text-cyan-900">{customer.outgoingCalls || 0}</div>
          ...
          <div className="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-lg p-3">
            ...
            <div className="text-lg font-bold text-red-900">{customer.missedCalls || 0}</div>
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 border border-indigo-200 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-medium text-indigo-700">Loyalty</span>
            </div>
            <div className="text-lg font-bold text-indigo-900">{customer.callLoyaltyLevel || 'Basic'}</div>
            <div className="text-xs text-indigo-600 mt-1">call level</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-medium text-slate-700">First Call</span>
            </div>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              <Calendar className="w-4 h-4 text-slate-600" />
              <span className="text-xs font-medium text-slate-700">Last Call</span>
            </div>
            <div className="text-sm font-bold text-slate-900">
