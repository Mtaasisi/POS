                  ...
                  <table className="min-w-full text-xs sm:text-sm customer-modal-table-responsive">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-200">
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700">Device</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700">Status</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700 hidden sm:table-cell">Issue</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700">Created</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700 hidden sm:table-cell">Total Paid</th>
                        <th className="text-left p-2 sm:p-3 font-medium text-gray-700">Points</th>
                      </tr>
                    </thead>
                    <tbody>
                      {devices.map(device => {
