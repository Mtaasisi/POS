...
import { getCustomerStatus, trackCustomerActivity, reactivateCustomer } from '../../../lib/customerStatusService';
...
const CustomerDetailModal: React.FC<CustomerDetailModalProps> = ({
  ...
  const handleReactivateCustomer = async () => {
    ...
    try {
      ...
      await trackCustomerActivity(customer.id, 'manual_reactivation');
      
      // Refresh customer status
      await loadCustomerStatus();
      
      // Update the current customer state
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input type="checkbox" defaultChecked={customerPreferences.notification_preferences?.repair_updates} className="mr-2" />
                    <span className="text-sm text-gray-700">Repair Updates</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" defaultChecked={customerPreferences.notification_preferences?.appointment_reminders} className="mr-2" />
                    <span className="text-sm text-gray-700">Appointment Reminders</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" defaultChecked={customerPreferences.notification_preferences?.promotions} className="mr-2" />
