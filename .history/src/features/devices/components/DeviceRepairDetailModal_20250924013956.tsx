...
import { 
  ...
  Shield, Search, AlertCircle, ExternalLink, XCircle, DollarCircle
} from 'lucide-react';
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  {(currentUser?.role === 'admin' || currentUser?.role === 'customer-care') && (
                    <div className="bg-white border border-gray-200 rounded-xl p-3 sm:p-4 space-y-3">
                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                      <DollarCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" />
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center">
                    <DollarCircle className="w-4 h-4 text-white" />
                  </div>
