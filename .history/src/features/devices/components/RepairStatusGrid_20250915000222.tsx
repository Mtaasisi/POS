    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-xl p-6">
          ...
          <div className="w-full bg-orange-200 rounded-full h-4 mb-4 relative overflow-hidden">
            <div 
              className="bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 h-4 rounded-full transition-all duration-700 ease-out relative"
