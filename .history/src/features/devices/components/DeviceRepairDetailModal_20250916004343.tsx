...
import { getRepairParts, RepairPart } from '../../repair/services/repairPartsApi';
                    ...
                    {repairPartsLoading ? (
                      ...
                      <div className="text-center py-4">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Use status updater to request parts
                        </p>
                      </div>
                    )}
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Update device status and manage repair workflow
                </p>
                
                {/* Use RepairStatusUpdater in non-compact mode for full functionality */}
                <RepairStatusUpdater
                  device={device}
                  currentUser={currentUser}
                  onStatusUpdate={handleStatusUpdate}
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                {repairPartsLoading ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-500">
                      Use the status updater to request parts when needed
                    </p>
                  </div>
                )}
              </div>
