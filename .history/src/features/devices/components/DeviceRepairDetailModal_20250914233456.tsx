...
const DeviceRepairDetailModal: React.FC<DeviceRepairDetailModalProps> = ({
  ...
  // Simplified functions - removed complex database operations for now

  // Simplified work timer functions
  ...
  const stopWorkTimer = () => {
    if (workTimer.startTime) {
      const now = new Date();
      const duration = Math.floor((now.getTime() - workTimer.startTime.getTime()) / 60000);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {activeTab === 'attachments' && (
            <div className="space-y-6">
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">File Attachments</h3>
          ...
          {activeTab === 'timeline' && (
            <div className="space-y-6">
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">Activity Timeline</h3>
      ...
      {/* Simplified modals - functionality coming soon */}
    </div>
  );
};
