                          ...
                          <div className="text-center py-4">
                            ...
                            <div className="space-y-2">
                              <button
                                ...
                                className="block w-full text-xs text-blue-600 hover:text-blue-700 font-medium py-1"
                              >
                                Start Diagnostics →
                              </button>
                              <button
                                ...
                                className="block w-full text-xs text-gray-600 hover:text-gray-700 font-medium py-1"
                              >
                                Refresh Data
                              </button>
                            </div>
