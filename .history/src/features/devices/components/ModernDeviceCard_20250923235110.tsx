  ...
  if (variant === 'pos') {
    return (
      ...
      >
        ...
        {/* Top accent bar */}
        <div className={`absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r ${device.status === 'assigned' ? 'from-amber-400 to-orange-500' : device.status === 'diagnosis-started' ? 'from-blue-400 to-cyan-500' : device.status === 'done' ? 'from-emerald-400 to-green-500' : 'from-red-400 to-pink-500'}`} />
