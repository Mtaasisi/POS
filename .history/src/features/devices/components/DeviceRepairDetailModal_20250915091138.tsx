                                ...
                                <div key={payment.id} className="flex items-center justify-between p-2 bg-yellow-50 rounded-lg border border-yellow-200">
                                  <div className="flex-1">
                                    <div className="flex items-center gap-2">
                                      ...
                                      {payment.payment_type === 'payment' && payment.notes?.includes('Repair Cost') && (
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    {selectedPendingPayment.payment_type === 'payment' && selectedPendingPayment.notes?.includes('Repair Cost') && (
                      <span className="text-xs px-2 py-1 bg-blue-100 text-blue-700 rounded-full">
                        Repair Cost
                      </span>
                    )}
