                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1 col-span-2">
                        ...
                        <p className="text-sm font-medium text-gray-900">{device.issueDescription || 'N/A'}</p>
                      </div>
                      ...
                      {device.deviceCondition && (
                        <div className="space-y-1 col-span-2">
                          <span className="text-xs text-gray-500 uppercase tracking-wide">Device Condition</span>
                      ...
                      {device.diagnosticChecklist && (
                        <div className="space-y-1 col-span-2">
                          <span className="text-xs text-gray-500 uppercase tracking-wide">Diagnostic Progress</span>
                          <div className="text-sm font-medium text-gray-900 bg-blue-50 p-2 rounded">
                            {(() => {
                              try {
                                ...
                                if (checklist.summary) {
                                  ...
                                  return (
                                    <div className="flex items-center gap-4">
                                      <span className="text-blue-600 font-semibold">{total} Tests</span>
                                ...
                                return 'Diagnostic tests available';
                              } catch {
                                return 'Diagnostic data available';
                              }
                            })()}
                          </div>
                        </div>
                      ...
                      {device.repairChecklist && (
                        <div className="space-y-1 col-span-2">
                          <span className="text-xs text-gray-500 uppercase tracking-wide">Repair Progress</span>
                            ...
                            {(() => {
                              try {
                                ...
                                if (checklist.items) {
                                  ...
                                  return (
                                    <div className="flex items-center gap-4">
                                      <span className="text-green-600 font-semibold">{completed}/{total} Steps Complete</span>
                                ...
                                return 'Repair workflow available';
                              } catch {
                                return 'Repair data available';
                              }
                            })()}
                          </div>
                        </div>
