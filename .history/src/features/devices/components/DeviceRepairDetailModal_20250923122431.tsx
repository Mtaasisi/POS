                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-3 space-y-3">
                    ...
                    <div className="space-y-1.5">
                      ...
                      {device && (
                        <div className="relative space-y-3">
                          <div className="space-y-2">
                            ...
                            {device.status === 'diagnosis-started' && (
                              <button 
                                type="button" 
                                onClick={async () => {
                                  try {
                            ...
                            {/* Start Repair Button */}
                            {(device.status === 'parts-arrived' || (device.status === 'diagnosis-started' && repairParts.length === 0)) && (
                              <button 
                                type="button" 
                                onClick={async () => {
                                  try {
                      ...
                      {/* Fallback to RepairStatusUpdater for other statuses */}
                      {device && !['diagnosis-started', 'parts-arrived'].includes(device.status) && (
                        <RepairStatusUpdater
