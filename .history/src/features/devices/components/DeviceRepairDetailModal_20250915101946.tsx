                    ...
                    <div className="flex items-center justify-between pb-2 border-b border-gray-100">
                      ...
                      {customer && (
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-3 py-1.5 bg-green-50 text-green-700 rounded-lg text-xs font-medium border border-green-200 hover:bg-green-100 transition-colors duration-200"
                        >
