      ...
      actions.push(
        {
          ...
          color: 'bg-blue-500',
          action: () => onStatusUpdate(device.id, 'returned-to-customer-care')
        },
        {
          id: 'mark-done',
          title: 'Mark as Done',
          description: 'Repair process completed',
          icon: <CheckCircle className="w-6 h-6" />,
          color: 'bg-green-600',
          action: () => onStatusUpdate(device.id, 'done')
        }
      );
    }
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {availableActions.map((action) => (
            <div key={action.id} className="bg-white rounded-lg p-4 border border-gray-200 hover:shadow-md transition-all duration-300">
