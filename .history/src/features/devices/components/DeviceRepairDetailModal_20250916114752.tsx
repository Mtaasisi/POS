...
const DeviceRepairDetailModal: React.FC<DeviceRepairDetailModalProps> = ({
  ...
  // Debug logging for diagnostic checklist modal state
  useEffect(() => {
    console.log('[DeviceRepairDetailModal] Diagnostic checklist modal state:', { 
  ...
  const handleStatusUpdate = async (deviceId: string, newStatus: DeviceStatus, notes?: string) => {
    ...
    try {
      console.log('[DeviceRepairDetailModal] Updating status:', { 
        deviceId, 
      ...
      if (newStatus === 'diagnosis-started') {
        console.log('[DeviceRepairDetailModal] Opening diagnostic checklist modal...');
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {device && (
        <DiagnosticChecklistModal
          ...
          onClose={() => {
            console.log('[DeviceRepairDetailModal] Closing diagnostic checklist modal');
            setShowDiagnosticChecklist(false);
          }}
          deviceId={device.id}
