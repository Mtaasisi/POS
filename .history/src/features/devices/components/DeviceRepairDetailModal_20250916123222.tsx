...
const DeviceRepairDetailModal: React.FC<DeviceRepairDetailModalProps> = ({
  ...
  const processPayment = async () => {
    ...
    try {
      ...
      const referenceInput = document.querySelector('input[placeholder="Transaction reference"]') as HTMLInputElement;
      
      const amount = parseFloat(amountInput?.value || selectedPendingPayment.amount);
      const method = methodSelect?.value || selectedPendingPayment.method;
