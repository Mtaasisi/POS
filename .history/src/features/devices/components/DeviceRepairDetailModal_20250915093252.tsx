                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div className={`text-center p-3 rounded-lg border ${
                            (deviceCosts?.repairCost || 0) > (financialInfo?.totalPaid || 0) 
                            ...
                            <div className={`text-lg font-bold ${
                              ...
                              {formatCurrency(Math.max(0, (deviceCosts?.repairCost || 0) - (financialInfo?.totalPaid || 0)))}
                            </div>
                            <div className={`text-xs uppercase tracking-wide ${
                              ...
                              {(deviceCosts?.repairCost || 0) > (financialInfo?.totalPaid || 0) ? 'Repair Cost' : 'Fully Paid'}
                            </div>
                          </div>
