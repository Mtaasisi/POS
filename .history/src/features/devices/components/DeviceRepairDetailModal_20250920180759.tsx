...
const DeviceRepairDetailModal: React.FC<DeviceRepairDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      ...
      {/* Modal */}
      <div 
        className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-7xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col my-4 sm:my-8"
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center bg-gradient-to-br from-blue-500 to-indigo-600 flex-shrink-0">
          ...
          <div className="p-4 sm:p-6">
            {activeTab === 'overview' && (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                    <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-gray-50">
                      ...
                      <div className="min-w-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-900">Diagnosis</p>
                        <p className="text-xs text-gray-500 hidden sm:block">Initial assessment</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-gray-50">
                      ...
                      <div className="min-w-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-900">Parts Order</p>
                        <p className="text-xs text-gray-500 hidden sm:block">Components sourced</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-gray-50">
                      ...
                      <div className="min-w-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-900">Repair</p>
                        <p className="text-xs text-gray-500 hidden sm:block">Work in progress</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg bg-gray-50">
                      ...
                      <div className="min-w-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-900">Testing</p>
                        <p className="text-xs text-gray-500 hidden sm:block">Quality assurance</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      {device.assignedTo && (
                        <div className="space-y-2">
                          ...
                          <div className="mt-1">
                            <span className="inline-flex items-center gap-2 px-2 sm:px-3 py-1 sm:py-2 bg-blue-50 text-blue-700 rounded-lg text-xs sm:text-sm font-medium border border-blue-200">
                      ...
                      {device.estimatedHours && (
                        <div className="space-y-2 sm:col-span-2">
                          ...
                          <div className="mt-1">
                            <span className="inline-flex items-center gap-2 px-2 sm:px-3 py-1 sm:py-2 bg-green-50 text-green-700 rounded-lg text-xs sm:text-sm font-medium border border-green-200">
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-3 sm:p-4 space-y-3">
                    ...
                    <div className="space-y-3">
                      <div className="space-y-1">
                        ...
                        <div className="bg-red-50 p-2 sm:p-3 rounded-lg border border-red-100 max-h-32 overflow-y-auto">
                ...
                <div className="space-y-4 sm:space-y-6">
                  {/* Actions */}
                  <div className="bg-white border border-gray-200 rounded-xl p-3 sm:p-4 space-y-3 sm:space-y-4">
                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                    ...
                    <div className="space-y-2">
                              ...
                              <button
                                ...
                                onClick={async (e) => {
                                  ...
                                  try {
                                    ...
                                    console.error('Error updating status to process-payments:', error);
                                  }
                                }}
                      ...
                      {(isAssignedTechnician || currentUser?.role === 'admin' || currentUser?.role === 'customer-care') && (
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors font-medium text-xs sm:text-sm"
                        >
                          <Wrench className="w-3 h-3 sm:w-4 sm:h-4" />
                          <span className="hidden sm:inline">{showRepairChecklist ? 'Hide Checklist' : 'Repair Checklist'}</span>
      ...
      <div className="xl:hidden bg-white border-t border-gray-200 p-3 sm:p-4">
        <div className="flex gap-2">
          {(isAssignedTechnician || currentUser?.role === 'admin' || currentUser?.role === 'customer-care') && (
            <>
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors font-medium text-xs"
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors font-medium text-xs"
              >
          ...
          {currentUser?.role === 'customer-care' && customer && (
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium text-xs"
            >
