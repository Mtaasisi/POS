...
const RepairStatusGrid: React.FC<RepairStatusGridProps> = ({
  ...
  const getAvailableActions = () => {
    ...
    if (device.status === 'diagnosis-started') {
      ...
      const hasNeededParts = parts.some(part => part.status === 'needed' || part.status === 'ordered');
      const hasAvailableParts = parts.some(part => part.status === 'received' || part.status === 'used');
      ...
      if (hasNeededParts) {
        ...
        // No parts available - show message
        actions.push({
          id: 'no-parts',
