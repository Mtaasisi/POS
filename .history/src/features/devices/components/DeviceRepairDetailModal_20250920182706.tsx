    ...
    <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-4 overflow-y-auto" style={{ zIndex: 99999 }}>
      ...
      >
        ...
        <div className="border-b border-gray-200 bg-white overflow-x-auto">
          <div className="flex space-x-2 sm:space-x-4 px-3 sm:px-4 min-w-max">
            <button
              type="button"
              onClick={(e) => {
                e.preventDefault();
              ...
              className={`py-2 sm:py-3 px-2 border-b-2 font-medium text-xs sm:text-sm transition-colors whitespace-nowrap ${
                activeTab === 'overview'
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <div className="mb-3">
                    <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                      <div 
                        className="h-2 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full transition-all duration-1000 ease-out relative"
