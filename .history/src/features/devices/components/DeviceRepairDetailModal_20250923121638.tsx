...
const DeviceRepairDetailModal: React.FC<DeviceRepairDetailModalProps> = ({
  ...
  // Get available repair status actions for overview tab
  const getAvailableActions = () => {
    ...
    if (device.status === 'awaiting-parts') {
      ...
      const partsReady = allPartsReady(repairParts);
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
          <div className="p-3 sm:p-4">
            {activeTab === 'overview' && (
              ...
              {/* Quick Action Buttons - Status Actions */}
              {(() => {
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                      {availableActions.map((action) => (
                        <div key={action.id} className="bg-gray-50 border border-gray-200 rounded-lg p-3 sm:p-4 hover:bg-gray-100 transition-colors">
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <div className="min-w-0 flex-1">
                              <h4 className="font-semibold text-gray-900 text-sm sm:text-base truncate">{action.title}</h4>
                    ...
                    <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                      <p className="text-xs sm:text-sm text-blue-700 flex items-center gap-2">
                        ...
                        <span>Click any action to update the device status. For detailed repair management, switch to the Repair tab.</span>
                      </p>
                    </div>
                  </div>
                );
