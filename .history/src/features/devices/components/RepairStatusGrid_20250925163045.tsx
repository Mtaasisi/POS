  ...
  const getAvailableActions = useMemo(() => {
    ...
    if (device.status === 'diagnosis-started') {
      ...
      const needsParts = hasNeededParts(parts);
        ...
        console.log('🔍 [DEBUG] Validating repair progress:', {
          parts: parts,
    ...
    // Send SMS to Customer - Available for customer care and admin on any status
    if (isCustomerCare || isAdmin) {
      // Only show if device has a customer
