...
const DeviceRepairDetailModal: React.FC<DeviceRepairDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-4">
                    ...
                    {/* Primary Actions */}
                    <div className="space-y-2">
                      {/* Update Status Button - Moved to top */}
                      <button
                      ...
                      >
                        ...
                        {showStatusUpdater ? 'Hide Status Update' : 'Update Status'}
                      </button>
                    ...
                    {/* Inline Status Updater within Action Card */}
                    {device && showStatusUpdater && (
                      <div className="mt-4 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-sm font-semibold text-gray-800">Update Device Status</h4>
                          <button 
      ...
      {/* Inline Repair Checklist */}
      {device && showRepairChecklist && (
        <div className="mt-6 p-4 bg-white border border-gray-200 rounded-xl">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Repair Checklist</h3>
            <button 
              onClick={() => setShowRepairChecklist(false)}
              className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-colors"
            >
