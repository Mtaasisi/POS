          ...
          {activeTab === 'overview' && (
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="backdrop-blur-xl rounded-xl border shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-blue-500/10 to-blue-400/5 border-blue-200/30">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center py-2 border-b border-blue-100/50">
                        ...
                        <span className="
                          bg-gradient-to-r from-blue-500/80 to-blue-600/80 text-white px-3 py-1 rounded-full text-sm font-medium
                  ...
                  <div className="backdrop-blur-xl rounded-xl border shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-green-500/10 to-green-400/5 border-green-200/30">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center py-2 border-b border-green-100/50">
                        ...
                        <span className="text-sm font-semibold text-gray-900 bg-green-50 px-3 py-1 rounded-lg">{customer?.name || 'N/A'}</span>
                      </div>
                      <div className="flex justify-between items-center py-2 border-b border-green-100/50">
                        <span className="text-sm font-medium text-gray-600">Phone</span>
                        <span className="text-sm font-semibold text-gray-900 bg-green-50 px-3 py-1 rounded-lg">{customer?.phone || 'N/A'}</span>
                      </div>
                      <div className="flex justify-between items-center py-2 border-b border-green-100/50">
                        <span className="text-sm font-medium text-gray-600">Email</span>
                        <span className="text-sm font-semibold text-gray-900 bg-green-50 px-3 py-1 rounded-lg">{customer?.email || 'N/A'}</span>
                      </div>
                ...
                <div className="space-y-6">
                  {/* Actions */}
                  <div className="backdrop-blur-xl rounded-xl border shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-purple-500/10 to-purple-400/5 border-purple-200/30">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center">
                        <Zap className="w-5 h-5 text-white" />
                      </div>
                      <h3 className="text-lg font-bold text-purple-900">Actions</h3>
                    </div>
