...
import { 
  ...
  Plus, Edit, Trash2, ShoppingCart, Truck, User, Activity, Info, CheckSquare, UserCheck, CreditCard, X
} from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-slate-50 to-blue-50 border border-slate-200 rounded-2xl p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-xl font-bold text-slate-800">Status Actions</h3>
            <p className="text-sm text-slate-600">Available actions for this device</p>
          </div>
        </div>
          ...
          {availableActions.map((action) => (
            <button
              ...
              className={`
                ...
                ${updatingAction !== null ? 'opacity-50 cursor-not-allowed' : 'hover:scale-[1.02] hover:shadow-lg'}
