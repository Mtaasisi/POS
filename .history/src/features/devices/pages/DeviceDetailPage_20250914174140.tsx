    ...
    if (!loadedTabs.has(tabName)) {
      ...
      switch (tabName) {
        ...
        case 'history':
          ...
          break;
        case 'customer':
          // Load customer performance data
          break;
        case 'repairs':
          // Load repair history
          setRepairHistory(deviceHistory);
          break;
        default:
          break;
      }
          ...
          {activeTab === 'overview' && (
            <>
              ...
              <div className="mb-8">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-5 shadow-sm">
                    ...
                    <div className="text-xs font-medium text-blue-700 uppercase tracking-wide mb-1">Time Spent</div>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-5 shadow-sm">
                    ...
                    <div className="text-xs font-medium text-purple-700 uppercase tracking-wide mb-1">Attachments</div>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm font-medium text-gray-900">{formatDate(safeDevice.createdAt)}</p>
                      </div>
                      <div className="space-y-1">
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                    ...
                    {(customer || dbCustomer) ? (
                      ...
                      <p className="text-sm text-gray-500 text-center py-4">No customer information available</p>
                    )}
                  </div>
                </div>

                {/* Middle Row - Actions & Repair Status */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {/* Actions */}
                ...
                {/* Bottom Row - Analytics & Issue Description */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {/* Analytics Summary */}
                  <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                    <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                      <BarChart3 className="w-5 h-5 text-green-600" />
                      <h3 className="text-sm font-semibold text-gray-800">Analytics Summary</h3>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="text-center p-3 bg-purple-50 rounded-lg">
                        ...
                        <div className="text-xs text-purple-700 uppercase tracking-wide">Total Time</div>
                      </div>
                      <div className="text-center p-3 bg-orange-50 rounded-lg">
                        <div className="text-lg font-bold text-orange-600">{workTimer.sessions.length}</div>
                        <div className="text-xs text-orange-700 uppercase tracking-wide">Sessions</div>
                      </div>
                    </div>
                  </div>
          ...
          {activeTab === 'repairs' && (
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                  <Wrench className="w-5 h-5 text-indigo-600" />
                  <h3 className="text-sm font-semibold text-gray-800">Current Repair Status</h3>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    <span className="text-xs text-gray-500 uppercase tracking-wide">Status</span>
              ...
              {isAssignedTechnician && (
                <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                    ...
                    <h3 className="text-sm font-semibold text-gray-800">Work Timer</h3>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <span className="text-xs text-gray-500 uppercase tracking-wide">Current Session</span>
                      <p className="text-sm font-medium text-gray-900">
                        {workTimer.isRunning ? formatDuration(workTimer.elapsedTime) : 'Not running'}
                      </p>
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                  ...
                  <h3 className="text-sm font-semibold text-gray-800">Time Analysis</h3>
                </div>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="text-center p-3 bg-green-50 rounded-lg">
                    <div className="text-xs font-medium text-green-700 uppercase tracking-wide mb-1">Total Time</div>
                    <div className="text-lg font-bold text-green-900">
                      {workTimer.sessions.reduce((total, session) => total + (session.duration || 0), 0)}m
                    </div>
                  </div>
                  <div className="text-center p-3 bg-blue-50 rounded-lg">
                    <div className="text-xs font-medium text-blue-700 uppercase tracking-wide mb-1">Sessions</div>
                    <div className="text-lg font-bold text-blue-900">{workTimer.sessions.length}</div>
                  </div>
                  <div className="text-center p-3 bg-purple-50 rounded-lg">
                    <div className="text-xs font-medium text-purple-700 uppercase tracking-wide mb-1">Avg Session</div>
                    <div className="text-lg font-bold text-purple-900">
                      {workTimer.sessions.length > 0 
                        ? Math.round(workTimer.sessions.reduce((total, session) => total + (session.duration || 0), 0) / workTimer.sessions.length)
                        : 0}m
                    </div>
                  </div>
                  <div className="text-center p-3 bg-orange-50 rounded-lg">
                    <div className="text-xs font-medium text-orange-700 uppercase tracking-wide mb-1">Current</div>
                    <div className="text-lg font-bold text-orange-900">
                      {workTimer.isRunning ? formatDuration(workTimer.elapsedTime) : '0m'}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-2 pb-2 border-b border-gray-100">
                  ...
                  <h3 className="text-sm font-semibold text-gray-800">Payment Analysis</h3>
                </div>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="text-center p-3 bg-green-50 rounded-lg">
                    <div className="text-xs font-medium text-green-700 uppercase tracking-wide mb-1">Total Paid</div>
                    <div className="text-lg font-bold text-green-900">{formatCurrency(totalPaid)}</div>
                  </div>
                  <div className="text-center p-3 bg-blue-50 rounded-lg">
                    <div className="text-xs font-medium text-blue-700 uppercase tracking-wide mb-1">Payment Count</div>
                    <div className="text-lg font-bold text-blue-900">{allPayments.length}</div>
                  </div>
                  <div className="text-center p-3 bg-purple-50 rounded-lg">
                    <div className="text-xs font-medium text-purple-700 uppercase tracking-wide mb-1">Avg Payment</div>
                    <div className="text-lg font-bold text-purple-900">
                      {allPayments.length > 0 ? formatCurrency(totalPaid / allPayments.length) : 'TZS 0'}
                    </div>
                  </div>
                  <div className="text-center p-3 bg-orange-50 rounded-lg">
                    <div className="text-xs font-medium text-orange-700 uppercase tracking-wide mb-1">Last Payment</div>
                    <div className="text-lg font-bold text-orange-900">
