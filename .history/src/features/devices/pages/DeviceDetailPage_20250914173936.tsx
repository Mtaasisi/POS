                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center p-3 bg-gray-50 rounded-lg">
                          ...
                          <div className="text-xs text-gray-600 uppercase tracking-wide">Payments</div>
                        </div>
                        <div className="text-center p-3 bg-gray-50 rounded-lg">
                          <div className="text-2xl font-bold text-orange-600">
                            {workTimer.sessions.reduce((total, session) => total + (session.duration || 0), 0)}
                          </div>
                      ...
                      <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
                        <div className="text-2xl font-bold text-green-600">{getRepairProgress()}%</div>
                        <div className="text-xs text-green-700 uppercase tracking-wide">Repair Progress</div>
                      </div>
                      
                      <div className="pt-3 border-t border-gray-100">
                        <div className="text-center">
                          <div className="text-lg font-bold text-gray-900 mb-1">Total Paid</div>
