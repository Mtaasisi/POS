              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200/50 bg-gray-50/50">
                    ...
                    <th className="text-left py-4 px-4 font-medium text-gray-700">Serial</th>
                    ...
                    <th className="text-center py-4 px-4 font-medium text-gray-700">Diagnostic</th>
                ...
                <tbody>
                  {filteredAndSortedDevices.map((device, index) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-4">
                        <div className="text-center">
                          {device.diagnosticChecklist && device.diagnosticChecklist.summary ? (
                            <div className="space-y-1">
                              <div className={`text-xs font-medium ${
                                device.diagnosticChecklist.summary.failed > 0 ? 'text-red-600' :
                                device.diagnosticChecklist.summary.pending > 0 ? 'text-yellow-600' :
                                'text-green-600'
                              }`}>
                                {device.diagnosticChecklist.summary.passed}/{device.diagnosticChecklist.summary.total}
                              </div>
                              {device.diagnosticChecklist.summary.failed > 0 && (
                                <div className="text-xs text-red-600">
                                  {device.diagnosticChecklist.summary.failed} failed
                                </div>
                              )}
                              {device.diagnosticChecklist.summary.pending > 0 && (
                                <div className="text-xs text-yellow-600">
                                  {device.diagnosticChecklist.summary.pending} pending
                                </div>
                              )}
                            </div>
                          ) : (
