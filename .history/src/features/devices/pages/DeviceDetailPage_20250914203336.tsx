...
import RepairStatusDashboard from '../components/RepairStatusDashboard';
import RepairStatusDisplay from '../components/RepairStatusDisplay';
import RepairStatusUpdater from '../components/RepairStatusUpdater';
import RepairStatusHistory from '../components/RepairStatusHistory';
      ...
      >
        ...
        <div className="border-b border-gray-200 bg-white">
          <div className="flex space-x-8 px-6">
            ...
            <button
              onClick={() => handleTabChange('repair-status')}
              className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors ${
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          {activeTab === 'repair-status' && (
            <RepairStatusDashboard
              ...
              onRefresh={() => {
                // Refresh device data
                if (id) {
                  const refreshedDevice = getDeviceById(id);
                  if (refreshedDevice) {
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate('/devices')}
              className="px-3 py-2 border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors text-sm font-medium"
            >
              Close
            </button>
