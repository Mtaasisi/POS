          ...
          {activeTab === 'overview' && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                  ...
                  <div className="backdrop-blur-xl rounded-xl border shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-blue-500/10 to-blue-400/5 border-blue-200/30">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center py-2 border-b border-blue-100/50">
                        ...
                        <span className="text-sm font-semibold text-gray-900 bg-blue-50 px-3 py-1 rounded-lg">{device.brand}</span>
                      </div>
                      
                      <div className="flex justify-between items-center py-2 border-b border-blue-100/50">
                        <span className="text-sm font-medium text-gray-600">Model</span>
                        <span className="text-sm font-semibold text-gray-900 bg-blue-50 px-3 py-1 rounded-lg">{device.model}</span>
                      </div>
                      
                      <div className="flex justify-between items-center py-2 border-b border-blue-100/50">
                        <span className="text-sm font-medium text-gray-600">Serial Number</span>
                        <span className="text-sm font-mono font-semibold text-gray-900 bg-gray-50 px-3 py-1 rounded-lg">{device.serialNumber}</span>
                      </div>
                      ...
                      {device.unlockCode && (
                        <div className="flex justify-between items-center py-2 border-b border-blue-100/50">
                          <span className="text-sm font-medium text-gray-600">Unlock Code</span>
                          <span className="text-sm font-mono font-semibold text-gray-900 bg-amber-50 px-3 py-1 rounded-lg">{device.unlockCode}</span>
                        </div>
                      )}
                      ...
                      {device.expectedReturnDate && (
                        <div className="flex justify-between items-center py-2">
                          ...
                          <span className="text-sm font-semibold text-gray-900 bg-green-50 px-3 py-1 rounded-lg">
                  ...
                  <div className="backdrop-blur-xl rounded-xl border shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-green-500/10 to-green-400/5 border-green-200/30">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center">
                        <User className="w-5 h-5 text-white" />
                      </div>
                      <h3 className="text-lg font-bold text-green-900">Customer Information</h3>
                    </div>
                    ...
                    {customer ? (
                      <div className="space-y-4">
                        <div className="flex justify-between items-center py-2 border-b border-green-100/50">
                          ...
                          <span className="text-sm font-semibold text-gray-900 bg-green-50 px-3 py-1 rounded-lg">{customer.name}</span>
                        </div>
                        
                        {customer.phone && (
                          <div className="flex justify-between items-center py-2 border-b border-green-100/50">
                            <span className="text-sm font-medium text-gray-600">Phone</span>
                            <span className="text-sm font-semibold text-gray-900 bg-blue-50 px-3 py-1 rounded-lg">{customer.phone}</span>
                          </div>
                        )}
                        ...
                        {customer.email && (
                          <div className="flex justify-between items-center py-2 border-b border-green-100/50">
                            ...
                            <span className="text-sm font-semibold text-gray-900 bg-purple-50 px-3 py-1 rounded-lg">{customer.email}</span>
                          </div>
                        )}
                        ...
                        {customer.color_tag && (
                          <div className="flex justify-between items-center py-2">
                            ...
                            <span className={`inline-flex items-center px-3 py-1 rounded-lg text-xs font-semibold ${
                              customer.color_tag === 'vip' ? 'bg-purple-100 text-purple-700 border border-purple-200' :
                              customer.color_tag === 'complainer' ? 'bg-red-100 text-red-700 border border-red-200' :
                              customer.color_tag === 'purchased' ? 'bg-green-100 text-green-700 border border-green-200' :
                  ...
                  {/* Financial Summary */}
                  <div className="backdrop-blur-xl rounded-xl border shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-emerald-500/10 to-emerald-400/5 border-emerald-200/30">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center">
                        <DollarSign className="w-5 h-5 text-white" />
                      </div>
                      <h3 className="text-lg font-bold text-emerald-900">Financial Summary</h3>
                    </div>
                    
                    <div className="space-y-4">
                      <div className="flex justify-between items-center py-3 border-b border-emerald-100/50">
                        <span className="text-sm font-medium text-gray-600">Repair Cost</span>
                        <span className="text-lg font-bold text-emerald-600 bg-emerald-50 px-4 py-2 rounded-lg">
                      ...
                      <div className="flex justify-between items-center py-3 border-b border-emerald-100/50">
                        ...
                        <span className="text-lg font-bold text-blue-600 bg-blue-50 px-4 py-2 rounded-lg">
                          {formatCurrency(device.totalPaid || 0)}
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between items-center py-3">
                        ...
                        <span className={`text-lg font-bold px-4 py-2 rounded-lg ${
                          (device.repairCost || 0) - (device.totalPaid || 0) > 0 
                  ...
                  {device.issueDescription && (
                    <div className="backdrop-blur-xl rounded-xl border shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-amber-500/10 to-amber-400/5 border-amber-200/30">
                      <div className="flex items-center gap-3 mb-6">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center">
                          <FileText className="w-5 h-5 text-white" />
                        </div>
                        <h3 className="text-lg font-bold text-amber-900">Issue Description</h3>
                      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <button
                        onClick={() => toast.success('Diagnostic feature coming soon')}
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium text-sm"
                      >
                      ...
                      <button
                        onClick={() => toast.success('Repair checklist feature coming soon')}
