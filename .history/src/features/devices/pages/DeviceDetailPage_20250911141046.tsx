...
import { ChevronDown, CheckCircle, XCircle, Smartphone, Barcode, Calendar, Loader2, Image as ImageIcon, FileText, File as FileIcon, CreditCard, DollarSign, AlertTriangle, Star, Award, Activity, Gift, MessageSquare, Clock, User, Upload, Trash2, ArrowLeft, Phone, Printer, Send, RefreshCw, ArrowRight, Key, Wrench, Hash, Settings, History, QrCode, Stethoscope, Timer, Stopwatch, Play, Pause, Square, Tool, Zap, Target, CheckSquare } from 'lucide-react';
                    ...
                    <div className="bg-white/20 backdrop-blur-md rounded-lg p-4 border border-white/30">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          <Stopwatch className="h-5 w-5 text-blue-600" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <GlassButton
                      ...
                      disabled={safeDevice.status !== 'in-repair'}
                    >
                      Testing
                    </GlassButton>
                    ...
                    <GlassButton
                      ...
                      disabled={safeDevice.status !== 'reassembled-testing'}
                    >
                      Complete
                    </GlassButton>
                  </div>
