...
import {
  ...
  X, Calendar, Clock, DollarSign as Dollar, CreditCard,
  Shield as Warranty, Key, CheckCircle2, AlertTriangle as Warning,
  Star, MessageSquare as Chat, PhoneCall, Mail,
  Wrench as Repair, TestTube, Clipboard, FileText,
  TrendingUp as Trending, Target as Goal, Award,
                ...
                {filteredDevices.map((device) => (
                  <div 
                    ...
                    className={`border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow ${
                      selectedDevices.has(device.id) ? 'ring-2 ring-blue-500 bg-blue-50' : ''
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-4 gap-4 mt-2 pt-2 border-t border-gray-100">
                              ...
                              <div className="flex items-center space-x-1">
                                <Trending className="w-3 h-3 text-purple-500" />
                                <div>
