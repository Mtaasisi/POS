...
import {
  ...
  Layers, LayoutGrid, Grid3x3, List, MoreHorizontal, Download,
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            {filteredDevices.length > 0 ? (
              <div className={viewMode === 'grid' 
                ...
                {viewMode === 'list' && (
                  <div className="grid grid-cols-12 gap-4 items-center py-3 px-4 bg-gray-50 border border-gray-200 rounded-lg font-medium text-sm text-gray-700">
                      ...
                      <>
                        ...
                        <div className="space-y-2 mb-3">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm text-blue-600 font-medium">{device.phoneNumber}</span>
                          </div>
                      ...
                      <div className="grid grid-cols-12 gap-4 items-center w-full">
                        ...
                        <div className="col-span-1">
                          <div className="flex justify-center gap-1">
                            ...
                            <button
                              onClick={() => handleNavigation(`/devices/${device.id}`)}
                              className="px-2 py-1.5 text-xs text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-lg font-medium transition-colors"
                            >
                              View
                            </button>
                          </div>
