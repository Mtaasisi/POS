        ...
        <div className="p-6 space-y-6">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6 max-w-md mx-auto">
                  {searchQuery || statusFilter !== 'all' 
                    ...
                    : 'You have no assigned devices at the moment. Check back later for new assignments.'
                  }
                </p>
                {(searchQuery || statusFilter !== 'all') && (
                  <button
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <button
                onClick={() => handleNavigation('/devices')}
                className="group flex items-center space-x-4 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200/50 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
              >
                ...
                <div className="text-left">
                  <p className="font-bold text-gray-900">All Devices</p>
              ...
              <button
                ...
                className="group flex items-center space-x-4 p-6 bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200/50 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
              >
                ...
                <div className="text-left">
                  <p className="font-bold text-gray-900">Spare Parts</p>
              ...
              <button
                ...
                className="group flex items-center space-x-4 p-6 bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200/50 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
              >
