...
export const RESPONSIVE_OPTIMIZATIONS = {
  ...
  // Optimized grid layouts for 4-column display
  gridLayout: {
    // Base responsive breakpoints - optimized for 4-column layout
    mobile: 'grid-cols-1',
    smallMobile: 'grid-cols-2',
    tablet: 'sm:grid-cols-2 md:grid-cols-3',
    desktop: 'lg:grid-cols-4 xl:grid-cols-4',
    hd: 'xl:grid-cols-4 2xl:grid-cols-4',
    ultraHd: '2xl:grid-cols-4 3xl:grid-cols-5',
    // Adaptive sizing for different screen widths - 4-column priority
    adaptive: {
      xs: 'grid-cols-1',      // < 640px
      sm: 'grid-cols-2',      // 640px - 768px
      md: 'grid-cols-3',      // 768px - 1024px
      lg: 'grid-cols-4',      // 1024px - 1280px
      xl: 'grid-cols-4',      // 1280px - 1536px
      '2xl': 'grid-cols-4',   // 1536px - 1920px
      '3xl': 'grid-cols-5',   // 1920px - 2560px
      '4xl': 'grid-cols-5'    // > 2560px
    }
  },
  ...
  // Button sizes for different screens - ultra compact
  buttonSizes: {
    mobile: 'py-1 px-2',
    tablet: 'sm:py-1 sm:px-2',
    desktop: 'lg:py-1 lg:px-2',
    hd: 'xl:py-1 xl:px-2',
    compact: 'py-1 px-2'
  },

  // Search bar sizing - ultra compact
  searchBar: {
    mobile: 'py-1 px-2',
    tablet: 'sm:py-1 sm:px-2',
    desktop: 'lg:py-1 lg:px-2',
  ...
  // Dynamic card sizing based on container width
  dynamicCard: {
    // Ultra compact for very small cards
    ultraCompact: {
      imageHeight: 'h-20',
      padding: 'p-1',
      textSize: {
  ...
  // Global component size reductions
  globalSizes: {
    // Input fields
    input: {
      mobile: 'py-1 px-2 text-xs',
      tablet: 'sm:py-1 sm:px-2 sm:text-xs',
      desktop: 'lg:py-1 lg:px-2 lg:text-xs',
      hd: 'xl:py-1 xl:px-2 xl:text-xs'
    },
