...
export const RESPONSIVE_OPTIMIZATIONS = {
  ...
  // Dynamic grid layouts that scale with screen width
  gridLayout: {
    // Base responsive breakpoints - dynamic scaling
    mobile: 'grid-cols-1',
    smallMobile: 'grid-cols-2',
    tablet: 'sm:grid-cols-2 md:grid-cols-3',
    desktop: 'lg:grid-cols-3 xl:grid-cols-4',
    hd: 'xl:grid-cols-4 2xl:grid-cols-5',
    ultraHd: '2xl:grid-cols-5 3xl:grid-cols-6',
    // Dynamic adaptive sizing for different screen widths
    adaptive: {
      ...
      '2xl': 'grid-cols-6',   // 1536px - 1920px
      '3xl': 'grid-cols-7',   // 1920px - 2560px
      '4xl': 'grid-cols-8'    // > 2560px
    },
    // Progressive scaling for ultra-wide screens
    progressive: {
      base: 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3',
      wide: 'lg:grid-cols-4 xl:grid-cols-5',
      ultra: '2xl:grid-cols-6 3xl:grid-cols-7 4xl:grid-cols-8'
    }
  },
