...
const CustomerCareDashboard: React.FC<CustomerCareDashboardProps> = ({
  ...
  // Auto-refresh dashboard data every 60 seconds (disabled to prevent page reloads)
  // Note: Real-time updates are handled by Supabase subscriptions below
  // useEffect(() => {
  //   const interval = setInterval(() => {
  //     // Refresh data without reloading the page
  //     console.log('Auto-refreshing dashboard data...');
  //     // Data will be refreshed through Supabase real-time subscriptions
  //   }, 60000); // 60 seconds
