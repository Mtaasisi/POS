          ...
          return (
            ...
            >
              <div className={`grid gap-4 items-center ${
                ...
                {/* Device Info */}
                <div 
                  className="col-span-2 cursor-pointer hover:bg-gray-100 rounded-lg p-2 -m-2 transition-colors"
                ...
                {/* Status */}
                <div 
                  className="col-span-1 cursor-pointer hover:bg-gray-100 rounded-lg p-2 -m-2 transition-colors"
                  onClick={() => navigate(`/devices/${device.id}`)}
                >
                ...
                {/* Issue */}
                <div 
                  className="col-span-3 cursor-pointer hover:bg-gray-100 rounded-lg p-2 -m-2 transition-colors"
                  onClick={() => navigate(`/devices/${device.id}`)}
                >
                ...
                <div className="col-span-2">
                  <div className="flex items-center gap-1.5">
                    ...
                    {currentUser?.role === 'customer-care' && (
                      <>
                        <button
                          onClick={() => handleCallCustomer(device.phoneNumber || '')}
                        ...
                        <button
                          onClick={() => handleSendSMS(device.phoneNumber || '')}
                        ...
                        <button
                          onClick={() => handleCopyDeviceInfo(device)}
