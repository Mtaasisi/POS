...
const ProductAdTemplate: React.FC<ProductAdTemplateProps> = ({ 
  ...
  return (
    <>
      ...
      <div className="absolute bottom-0 left-0 w-12 h-32 z-10">
        <div className="w-full h-full bg-black">
          <div className="w-3 h-full bg-red-600 absolute left-0 top-0"></div>
          <div className="w-3 h-1/3 bg-red-600 absolute left-0 top-1/3"></div>
          <div className="w-3 h-1/3 bg-red-600 absolute left-0 top-2/3"></div>
        </div>
      </div>
    </>
  );
