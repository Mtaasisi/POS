...
const CustomerCareStatsCard: React.FC<CustomerCareStatsCardProps> = ({
  ...
  return (
    <div
      className={`mb-4 flex flex-col gap-0 justify-between py-4 px-6 ${CARD_COLORS.primary} ${BORDER_RADIUS.md} ${ANIMATION_DURATIONS.slow} cursor-pointer ${
        expanded ? `${SHADOWS['2xl']} scale-[1.03]` : ''
      }`}
