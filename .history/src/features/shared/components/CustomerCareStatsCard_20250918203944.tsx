  ...
  return (
    ...
    >
      ...
      <div className={`overflow-hidden transition-all duration-300 ${
        expanded ? 'max-h-[400px] mt-6 opacity-100' : 'max-h-0 opacity-0'
      }`}>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Checked In Today */}
          <div className="flex flex-col items-center justify-center bg-gray-50 rounded-lg p-4 border border-gray-200">
            <span className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-yellow-100 mb-2">
              <UserCheck size={20} className="text-yellow-500" />
            </span>
            <span className="text-2xl font-bold text-gray-900 mb-1">{Object.keys(checkinStats).length}</span>
            <span className="text-xs font-medium text-gray-500 mb-2">Checked In</span>
          ...
          {/* New Customers Today */}
          <div className="flex flex-col items-center justify-center bg-gray-50 rounded-lg p-4 border border-gray-200">
            <span className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-blue-100 mb-2">
              <Users size={20} className="text-blue-500" />
            </span>
            <span className="text-2xl font-bold text-gray-900 mb-1">{newCustomersToday.length}</span>
            <span className="text-xs font-medium text-gray-500 mb-2">New Customers</span>
            <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden">
              <div 
          ...
          <div className="flex flex-col items-center justify-center bg-gray-50 rounded-lg p-4 border border-gray-200">
            <span className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-green-100 mb-2">
              <ClipboardList size={20} className="text-green-500" />
            </span>
            <span className="text-2xl font-bold text-gray-900 mb-1">{devicesToday.length}</span>
            <span className="text-xs font-medium text-gray-500 mb-2">Devices Received</span>
            <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden">
              <div 
          ...
          <div className="flex flex-col items-center justify-center bg-gray-50 rounded-lg p-4 border border-gray-200">
            <span className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-pink-100 mb-2">
              <Gift size={20} className="text-pink-500" />
            </span>
            <span className="text-2xl font-bold text-gray-900 mb-1">{birthdaysThisMonth.length}</span>
            <span className="text-xs font-medium text-gray-500 mb-2">Birthdays</span>
            <div className="w-full h-1 bg-gray-200 rounded-full overflow-hidden">
              <div 
                className="h-1 bg-pink-500 rounded-full transition-all duration-1000" 
