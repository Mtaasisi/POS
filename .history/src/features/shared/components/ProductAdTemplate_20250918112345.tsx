    ...
    <>
      ...
      <div className="absolute top-20 left-8 right-8 z-10">
        ...
        <div className="text-center">
          <p className="text-lg text-black font-medium leading-relaxed font-inter">
            {specifications}
          </p>
        </div>
      </div>
      ...
      {/* Product Image */}
      <div className="absolute bottom-8 left-0 right-0 h-1/2 flex items-center justify-center">
        {image ? (
