  ...
  useEffect(() => {
    if (isOpen && device) {
      ...
      if (device.diagnostic_checklist && device.diagnostic_checklist.items) {
        ...
        console.log('[DiagnosticChecklist] Creating new diagnostic checklist for model:', device.model);
        const newDiagnostics = getDiagnosticChecklist(device.model);
        console.log('[DiagnosticChecklist] Generated diagnostic items:', newDiagnostics);
