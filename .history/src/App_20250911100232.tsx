...
// import { RepairProvider, RepairDashboard } from './features/repair';
// import RepairDeviceList from './features/repair/pages/RepairDeviceList';
// import NewRepairDevice from './features/repair/pages/NewRepairDevice';
// import RepairDeviceDetail from './features/repair/pages/RepairDeviceDetail';
// import RepairStatistics from './features/repair/pages/RepairStatistics';
// import RepairSettings from './features/repair/pages/RepairSettings';
// import RepairTestPage from './features/repair/pages/RepairTestPage';
...
const ShippingSettingsPage = lazy(() => import('./features/lats/pages/ShippingSettingsPage'));
const ShippingAgentsPage = lazy(() => import('./features/lats/pages/ShippingAgentsPage'));
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          {/* Repair Module Routes - Temporarily Disabled */}
          {/* <Route path="/repair" element={<Suspense fallback={<PageLoadingSpinner />}><RepairDashboard /></Suspense>} />
          <Route path="/repair/devices" element={<Suspense fallback={<PageLoadingSpinner />}><RepairDeviceList /></Suspense>} />
          <Route path="/repair/devices/new" element={<Suspense fallback={<PageLoadingSpinner />}><NewRepairDevice /></Suspense>} />
          <Route path="/repair/devices/:id" element={<Suspense fallback={<PageLoadingSpinner />}><RepairDeviceDetail /></Suspense>} />
          <Route path="/repair/statistics" element={<RoleProtectedRoute allowedRoles={['admin']}><Suspense fallback={<PageLoadingSpinner />}><RepairStatistics /></Suspense></RoleProtectedRoute>} />
          <Route path="/repair/settings" element={<RoleProtectedRoute allowedRoles={['admin']}><Suspense fallback={<PageLoadingSpinner />}><RepairSettings /></Suspense></RoleProtectedRoute>} />
          <Route path="/repair/test" element={<Suspense fallback={<PageLoadingSpinner />}><RepairTestPage /></Suspense>} /> */}
        ...
        <Route path="/product-export" element={<RoleProtectedRoute allowedRoles={['admin']}><ProductExportPage /></RoleProtectedRoute>} />
          ...
          <Route path="/lats/shipping/settings" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><Suspense fallback={<PageLoadingSpinner />}><ShippingSettingsPage /></Suspense></RoleProtectedRoute>} />
          <Route path="/lats/shipping/agents" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><Suspense fallback={<PageLoadingSpinner />}><ShippingAgentsPage /></Suspense></RoleProtectedRoute>} />
