...
import TouchPOS from './components/pos/TouchPOS';
...
<Route path="/inventory/products/:id" element={<ProductDetailPage />} />
          ...
          <Route path="/pos/touch" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><TouchPOS /></RoleProtectedRoute>} />
