...
import POSProcessPage from './pages/POSProcessPage';
import POSSuccessPage from './pages/POSSuccessPage';
...
<Route path="/inventory/products/:id" element={<ProductDetailPage />} />
          ...
          <Route path="/audit-logs" element={<RoleProtectedRoute allowedRoles={['admin']}><AuditLogsPage /></RoleProtectedRoute>} />
            ...
            <Route path="/pos/payment" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><POSPaymentPage /></RoleProtectedRoute>} />
            <Route path="/pos/process" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><POSProcessPage /></RoleProtectedRoute>} />
            <Route path="/pos/success" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><POSSuccessPage /></RoleProtectedRoute>} />
