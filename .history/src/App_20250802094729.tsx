...
import InventoryFormTestPage from './pages/InventoryFormTestPage';
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="/wallpaper-preview" element={<WallpaperPreviewPage />} />
...
<Route path="/inventory/test-form" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><InventoryFormTestPage /></RoleProtectedRoute>} />
