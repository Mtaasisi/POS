    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="/repair" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care', 'technician']}><Suspense fallback={<PageLoadingSpinner />}><SimpleRepairPage /></Suspense></RoleProtectedRoute>} />
