            ...
            {showNewCategory && (
              <GlassCard className="mb-6">
                ...
                <div className="flex gap-2 mt-4">
                  <GlassButton onClick={handleCreateCategory}>
                    <Save size={16} />
                    Create Category
                  </GlassButton>
                  <GlassButton
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <GlassButton onClick={handleUpdateCategory} size="sm">
                            <Save size={14} />
                            Save
                          </GlassButton>
                          <GlassButton
          ...
          <div>
            ...
            {showNewSupplier && (
              <GlassCard className="mb-6">
                ...
                <div className="flex gap-2 mt-4">
                  <GlassButton onClick={handleCreateSupplier}>
                    <Save size={16} />
                    Create Supplier
                  </GlassButton>
                  <GlassButton
                  ...
                  {editingSupplier?.id === supplier.id ? (
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <GlassButton onClick={handleUpdateSupplier} size="sm">
                            <Save size={14} />
                            Save
                          </GlassButton>
                          <GlassButton
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <GlassCard>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900">Product Templates</h3>
                </div>
                <p className="text-sm text-gray-600 mb-4">
                  Create reusable templates for common product types.
                </p>
                <GlassButton variant="secondary" onClick={() => toast.info('Product templates coming soon!')}>
                  Manage Templates
                </GlassButton>
              </GlassCard>
              ...
              <GlassCard>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Configure inventory reports and analytics settings.
                </p>
                <GlassButton variant="secondary" onClick={() => toast.info('Reports settings coming soon!')}>
                  Configure Reports
                </GlassButton>
              </GlassCard>
            </div>
