      ...
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            <GlassCard className="p-4">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-gray-900">Cart ({cart.length})</h3>
            ...
            {/* Payment & Delivery - Combined Compact */}
            <GlassCard className="p-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-base font-semibold text-gray-900">Payment & Delivery</h3>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`flex-1 py-2 px-3 text-xs rounded border-2 transition-colors ${
                        paymentMethod === 'cash' 
                          ? 'border-blue-500 bg-blue-50 text-blue-700' 
                          : 'border-gray-300 bg-white text-gray-700 hover:border-gray-400'
                      }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full py-2 px-3 text-sm border-2 border-gray-300 rounded focus:border-blue-500 focus:outline-none"
                    placeholder="0"
                  />
                </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      Pickup
                                         ...
                                         <button
                       type="button"
                       onClick={() => setDeliveryMethod('local_transport')}
                       className={`flex-1 py-2 px-3 text-xs rounded border-2 transition-colors ${
            ...
            <GlassCard className="p-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Order totals</p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  onClick={holdOrder}
                  disabled={cart.length === 0}
                  className="py-2 px-3 border-2 border-yellow-300 text-yellow-700 rounded-lg hover:bg-yellow-50 transition-colors disabled:opacity-50 text-sm"
                >
                ...
                <button
                  ...
                  onClick={cancelOrder}
                  disabled={cart.length === 0}
                  className="py-2 px-3 border-2 border-red-300 text-red-700 rounded-lg hover:bg-red-50 transition-colors disabled:opacity-50 text-sm"
                >
                  <div className="flex items-center justify-center gap-1">
                    <X className="w-3 h-3" />
                    Cancel
