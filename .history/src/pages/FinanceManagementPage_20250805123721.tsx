...
const FinanceManagementPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-6 py-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <GlassCard className="bg-gradient-to-br from-blue-500/10 to-blue-400/5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-blue-600">Across {summary.totalAccounts} accounts</p>
                </div>
            ...
            {(
              <>
                ...
                <GlassCard className="bg-gradient-to-br from-cyan-500/10 to-cyan-400/5 cursor-pointer hover:shadow-lg transition-shadow" onClick={() => navigate('/payments-accounts')}>
                  <div className="flex items-center justify-between">
                    <div>
      ...
      {/* Accounts Tab - Redirect to Payments Accounts Page */}
      {activeTab === 'accounts' && (
        <div className="space-y-6">
          <GlassCard>
            <div className="text-center py-12">
              <Wallet className="w-16 h-16 text-blue-600 mx-auto mb-4" />
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Accounts Management</h3>
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                Manage your financial accounts, track balances, and monitor transactions in our dedicated Accounts page.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4">
                  ...
                  <div className="text-sm font-medium text-blue-800">Account Overview</div>
                  <div className="text-xs text-blue-600">View all accounts</div>
                </div>
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4">
                  <div className="text-2xl font-bold text-green-600">💰</div>
                  <div className="text-sm font-medium text-green-800">Balance Tracking</div>
                  <div className="text-xs text-green-600">Monitor balances</div>
                </div>
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4">
                  <div className="text-2xl font-bold text-purple-600">📈</div>
                  <div className="text-sm font-medium text-purple-800">Transaction History</div>
                  <div className="text-xs text-purple-600">Track movements</div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="accounts-page">View in Payments Accounts</option>
                </select>
              </div>
