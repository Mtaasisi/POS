          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                <GlassButton
                  ...
                  className="flex items-center gap-2 bg-gradient-to-r from-green-500 to-blue-600 text-white"
                >
                  <Tag size={16} />
                  Manage Categories
                </GlassButton>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-semibold text-green-900">Category Management</h3>
              </div>
              <p className="text-green-700 mb-4">
                Use the dedicated Category Management page for advanced features like search, filtering, 
                bulk operations, and detailed editing with custom colors.
              </p>
              <GlassButton
                onClick={() => navigate('/category-management')}
          ...
          <div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-semibold text-blue-900">Brand & Category Management</h3>
              </div>
              <p className="text-blue-700 mb-4">
                Use the dedicated management pages for full control over brands and categories. 
                These pages provide advanced features like search, filtering, bulk operations, and detailed editing.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 border border-blue-200">
                  <h4 className="font-semibold text-gray-900 mb-2">Brand Management</h4>
                  <p className="text-sm text-gray-600 mb-3">
                    Manage device brands with logo URLs, descriptions, and category assignments.
                  </p>
                  <GlassButton
                    onClick={() => navigate('/brand-management')}
                ...
                <div className="bg-white rounded-lg p-4 border border-blue-200">
                  <h4 className="font-semibold text-gray-900 mb-2">Category Management</h4>
                  <p className="text-sm text-gray-600 mb-3">
                    Manage product categories with custom colors and descriptions.
                  </p>
                  <GlassButton
                    onClick={() => navigate('/category-management')}
                    className="w-full flex items-center justify-center gap-2"
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex gap-1">
                      <button
                        onClick={() => navigate('/brand-management')}
                        className="p-1 text-gray-400 hover:text-blue-600"
                        title="Edit in Brand Management"
                      >
                        <Edit size={14} />
                      </button>
                      <button
                        onClick={() => navigate('/brand-management')}
                        className="p-1 text-gray-400 hover:text-red-600"
                        title="Delete in Brand Management"
                      >
                        <Trash2 size={14} />
                      </button>
                    </div>
