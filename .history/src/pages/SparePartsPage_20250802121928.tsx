  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-6">
      ...
      {outOfStockParts.length > 0 && (
        <GlassCard className="bg-gradient-to-br from-orange-50 via-orange-100 to-red-50 border-l-4 border-l-orange-500 shadow-lg">
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-orange-900 mb-1">Out of Stock Alert</h3>
                <p className="text-orange-700 font-medium">{outOfStockParts.length} parts are completely out of stock</p>
                <p className="text-sm text-orange-600 mt-1">These items require immediate reordering to resume operations</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="px-3 py-1 bg-orange-100 rounded-full">
                <span className="text-orange-800 font-semibold text-sm">CRITICAL</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            {outOfStockParts.slice(0, 6).map((part, index) => (
              <div key={part.id} className="group relative bg-white/80 backdrop-blur-sm p-4 rounded-xl border border-orange-200 hover:border-orange-300 transition-all duration-300 hover:shadow-md hover:scale-105">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-orange-600">{part.stock_quantity}</span>
                  </div>
                  <div className="flex items-center justify-between">
          ...
          {outOfStockParts.length > 6 && (
            <div className="flex items-center justify-between pt-4 border-t border-orange-200">
              <div className="flex items-center gap-2 text-sm text-orange-700">
                ...
                <span>Showing 6 of {outOfStockParts.length} out of stock items</span>
              </div>
              <GlassButton
