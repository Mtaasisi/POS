...
const POSPage: React.FC = () => {
  ...
  const loadCustomerHistory = async (customerId: string) => {
    try {
      ...
      console.log('Customer purchase history:', history);
      // You can use this data to show customer insights
    } catch (error) {
  ...
  const exportPOSData = () => {
    ...
    toast.success('POS data exported successfully');
  };
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <GlassButton
                ...
                variant="outline"
                className="border-2 border-green-200 hover:border-green-300 text-green-600"
              >
          ...
          <GlassCard className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{allProducts.length}</p>
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{allCategories.length}</p>
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{allSuppliers.length}</p>
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{lowStockProducts.length}</p>
              </div>
            </div>
          </GlassCard>
        </div>
