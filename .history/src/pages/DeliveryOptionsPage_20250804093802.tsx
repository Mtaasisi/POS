      ...
      <div className="max-w-7xl mx-auto px-4 py-4 pb-20">
        <div className="grid grid-cols-12 gap-4 h-[calc(100vh-200px)]">
            ...
            <GlassCard className="p-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Choose how the customer will receive their order</p>
                </div>
              </div>
              ...
              <GlassCard className="p-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Enter delivery details</p>
                  </div>
                </div>
              ...
              <GlassCard className="p-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-medium text-blue-900 text-sm">Pickup Information</h4>
                  </div>
          ...
          <div className="col-span-4 space-y-4">
            {/* Order Summary */}
            <GlassCard className="bg-white/90 p-4">
              ...
              <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900 text-sm">{orderSummary.customer.name}</p>
                {orderSummary.customer.phone && (
                  <p className="text-xs text-gray-600">{orderSummary.customer.phone}</p>
                )}
              </div>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-gray-900 text-sm">Items</span>
                </div>
            ...
            <GlassCard className="p-4">
              <GlassButton
                ...
                className="w-full bg-blue-500 text-white py-2 text-base font-medium"
              >
                {isProcessing ? (
                  <div className="flex items-center gap-2">
