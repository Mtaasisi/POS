...
const POSPage: React.FC = () => {
  ...
  // Step Management
  const [currentStep, setCurrentStep] = useState(0); // 0 = original layout, 1-4 = step mode
  const steps = [
    { id: 1, title: 'Customer', description: 'Select customer', icon: Users },
    { id: 2, title: 'Products', description: 'Add items to cart', icon: ShoppingCart },
    { id: 3, title: 'Payment', description: 'Process payment', icon: CreditCard },
    { id: 4, title: 'Complete', description: 'Finish sale', icon: CheckCircle }
  ];
                  ...
                  <div key={step.id} className="flex items-center">
                    ...
                    >
                      <div className={`p-2 rounded-xl ${
                        isActive ? 'bg-white/20' : isCompleted ? 'bg-white/20' : 'bg-gray-100'
                      }`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-12">
              <GlassCard className="p-8">
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Step 1: Select Customer</h2>
                  <p className="text-gray-600">Choose a customer to proceed with the sale</p>
                </div>
                ...
                <div className="max-w-2xl mx-auto">
                  <div className="space-y-6">
                    ...
                    {showCustomerSearch && customerSearchResults.length > 0 && (
                      <div className="bg-white/95 backdrop-blur-xl border border-white/30 rounded-2xl shadow-2xl max-h-48 overflow-y-auto">
                        <div className="p-2">
                    ...
                    {selectedCustomer && (
                      <div className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200/50 rounded-2xl">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <span className="font-semibold text-green-800">Customer Selected!</span>
                        </div>
          ...
          {currentStep === 2 && (
            <div className="lg:col-span-12">
              <GlassCard className="p-8">
                <div className="text-center mb-8">
                  <div className="p-4 bg-gradient-to-br from-orange-500 to-red-600 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                    <ShoppingCart className="w-10 h-10 text-white" />
                  </div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Step 2: Add Products</h2>
                  <p className="text-gray-600">Search and add items to your cart</p>
                </div>
          ...
          {currentStep === 3 && (
            <div className="lg:col-span-12">
              <GlassCard className="p-8">
                <div className="text-center mb-8">
                  <div className="p-4 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                    <CreditCard className="w-10 h-10 text-white" />
                  </div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Step 3: Payment & Delivery</h2>
                  <p className="text-gray-600">Complete payment and delivery details</p>
                </div>
          ...
          {currentStep === 4 && (
            <div className="lg:col-span-12">
              <GlassCard className="p-8">
                <div className="text-center mb-8">
                  <div className="p-4 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                    <CheckCircle className="w-10 h-10 text-white" />
                  </div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Step 4: Complete Sale</h2>
                  <p className="text-gray-600">Review and finalize the transaction</p>
                </div>
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="p-4 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl">
                        ...
                        <div className="p-4 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl">
                          <h4 className="font-semibold text-gray-900 mb-2">Items ({cart.length})</h4>
                          <div className="space-y-2">
                            {cart.map((item) => (
                  ...
                  <div className="mt-8 text-center space-y-4">
                    <GlassButton
                      ...
                      className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white py-4 text-lg font-bold"
                    >
                      {loading ? (
                        <>
          ...
          {/* Original Layout - Hidden when steps are active */}
          {currentStep === 0 && (
            <>
