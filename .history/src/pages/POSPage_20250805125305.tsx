            ...
            <GlassCard className="bg-white/90">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium text-gray-900 text-sm truncate">{selectedCustomer.name}</h3>
                        <p className="text-xs text-gray-600 truncate">{selectedCustomer.phone || 'No phone'}</p>
                        {selectedCustomer.loyalty?.isLoyaltyMember && (
              ...
              {cart.length === 0 ? (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-xs">Search and add products to get started</p>
                </div>
              ) : (
                        ...
                        <div className="flex items-center gap-2 ml-2">
                          ...
                          <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-1">
                            ...
                            {editingCartIndex === idx ? (
                              ...
                              <span
                                className="w-8 text-center text-xs font-medium cursor-pointer hover:bg-blue-50 rounded px-1"
                                tabIndex={0}
                                onClick={() => setEditingCartIndex(idx)}
                                onKeyDown={e => {
                          ...
                          <div className="text-right min-w-0">
                            ...
                            <p className="font-semibold text-gray-900 text-sm">Tsh{item.total.toLocaleString()}</p>
                          </div>
