          ...
          <div className="flex items-center justify-center">
            <div className="flex items-center space-x-4">
              <div className={`flex items-center px-4 py-2 rounded-full transition-all ${
                ...
                cart.length > 0 ? 'bg-green-500 text-white' : 'bg-white text-gray-600 border-2 border-gray-200'
              }`}>
              ...
              <div className={`flex items-center px-4 py-2 rounded-full transition-all ${
                activeTab === 'customers' ? 'bg-blue-500 text-white' : 
                selectedCustomer ? 'bg-green-500 text-white' : 'bg-white text-gray-600 border-2 border-gray-200'
              }`}>
              ...
              <div className="w-8 h-0.5 bg-gray-300"></div>
              <div className={`flex items-center px-4 py-2 rounded-full transition-all ${
                activeTab === 'payment' ? 'bg-blue-500 text-white' : 
                paymentSelected ? 'bg-green-500 text-white' : 'bg-white text-gray-600 border-2 border-gray-200'
              }`}>
