      ...
      <div className="bg-gradient-to-r from-blue-50 via-white to-purple-50 backdrop-blur-xl border-b border-gray-200/50 sticky top-[88px] z-10 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200/50 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 pb-24">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-4 space-y-6">
            {/* Order Summary */}
            <div className="p-3 rounded-xl bg-white/60 border border-gray-200/50 hover:bg-white/80 hover:border-gray-300/50 transition-all duration-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-700">Total</span>
                <span className="text-lg font-bold text-green-600">Tsh{totals.total.toLocaleString()}</span>
              </div>
              <div className="flex items-center justify-between text-xs text-gray-500">
                <span>Items: {cart.length}</span>
                <span>Tax: Tsh{totals.tax.toLocaleString()}</span>
              </div>
            </div>
