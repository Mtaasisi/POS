    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg">Streamlined sales processing</p>
              </div>
            </div>
            
            {/* Stats Dashboard */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="p-4 bg-white/80 backdrop-blur-xl rounded-2xl border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-green-100 rounded-xl">
                    <TrendingUpIcon className="w-5 h-5 text-green-600" />
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{formatCurrency(posStats.todaySales)}</p>
              ...
              <div className="p-4 bg-white/80 backdrop-blur-xl rounded-2xl border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{posStats.todayOrders}</p>
          ...
          {/* Action Bar */}
          <div className="flex items-center justify-between mt-6 p-4 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/30 shadow-lg">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 px-4 py-2 bg-green-100/80 backdrop-blur-sm rounded-xl border border-green-200/30">
                ...
                <span className="font-semibold text-green-800">POS Active</span>
              </div>
              
              <div className="flex items-center gap-2 px-4 py-2 bg-blue-100/80 backdrop-blur-sm rounded-xl border border-blue-200/30">
                <TargetIcon className="w-4 h-4 text-blue-600" />
                <span className="font-semibold text-blue-800">Inventory System</span>
              </div>
            </div>
            ...
            <GlassButton
              ...
              disabled={loading}
              variant="outline"
              className="px-6 py-3 border-2 border-gray-200 hover:border-blue-300 transition-all duration-200"
            >
              {loading ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
          {/* Left Column - Product Search & Cart (8 columns on xl screens) */}
            ...
            <GlassCard className="p-8 relative overflow-hidden">
              ...
              <div className="flex items-center gap-6 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Find spare parts by name, brand, or part number</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 mt-6">
                ...
                <GlassButton
                  ...
                  className="border-2 border-gray-200 hover:border-blue-300 px-6 py-3"
                >
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{cart.length} items • {formatCurrency(subtotal)}</p>
                  </div>
                </div>
                ...
                <GlassButton
                  ...
                  className="text-red-600 border-red-200 hover:bg-red-50 px-6 py-3"
                >
            ...
            <GlassCard className="p-8">
              ...
              {recentOrders.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-700 mb-2">No recent orders</h3>
                  <p className="text-gray-500">Complete your first sale to see orders here</p>
                </div>
              ) : (
                <div className="space-y-4 max-h-64 overflow-y-auto">
                  {recentOrders.map((order) => (
                    <div
                      key={order.id}
                      className="p-6 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl hover:shadow-lg transition-all duration-300 hover:scale-[1.02]"
                    >
          ...
          {/* Right Column - Customer, Payment & Delivery (4 columns on xl screens) */}
          <div className="xl:col-span-4 space-y-8">
            ...
            <GlassCard className="p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <span className="text-xs text-gray-500">({customers.length} loaded)</span>
                    </div>
                    <GlassButton
                      onClick={async () => {
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-6 py-4 border-2 border-gray-200 rounded-2xl bg-white/80 backdrop-blur-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-lg"
                      onChange={(e) => {
                        setCustomerSearchQuery(e.target.value);
                        handleCustomerSearch(e.target.value);
                      }}
                    />
                    <Users className="w-6 h-6 text-gray-400 absolute right-4 top-1/2 transform -translate-y-1/2" />
                  </div>
                  ...
                  {showCustomerSearch && customerSearchQuery.length >= 2 && customerSearchResults.length === 0 && (
                    <div className="absolute top-full left-0 right-0 mt-2 bg-white/95 backdrop-blur-xl border border-white/30 rounded-2xl shadow-2xl z-50 p-6">
                ...
                {selectedCustomer && (
                  <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/50 rounded-2xl">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="p-3 bg-blue-100 rounded-xl">
                        <User className="w-6 h-6 text-blue-600" />
                      </div>
                      <span className="font-semibold text-blue-800 text-lg">Selected Customer</span>
                    </div>
            ...
            <GlassCard className="p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-semibold text-lg">{formatCurrency(shippingCost)}</span>
                </div>
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-semibold text-lg">{formatCurrency(amountPaid)}</span>
                </div>
                
                <div className="flex justify-between items-center py-2">
                  <span className="text-gray-600">Balance Due:</span>
                  <span className={`font-semibold text-lg ${balanceDue > 0 ? 'text-red-600' : 'text-green-600'}`}>
            ...
            <div className="space-y-4">
              <GlassButton
                ...
                className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white py-6 text-xl font-bold rounded-2xl"
              >
                {loading ? (
                  <>
              ...
              <div className="grid grid-cols-2 gap-4">
                <GlassButton
                  ...
                  onClick={holdOrder}
                  disabled={cart.length === 0}
                  className="border-2 border-yellow-200 hover:border-yellow-300 text-yellow-700 py-4"
                >
                ...
                <GlassButton
                  ...
                  onClick={cancelOrder}
                  disabled={cart.length === 0}
                  className="border-2 border-red-200 hover:border-red-300 text-red-700 py-4"
                >
        ...
        {currentOrder && (
          <div className="p-8">
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold text-gray-900 mb-2">Sale Receipt</h3>
              <p className="text-gray-600 text-lg">Order #{currentOrder.id.slice(0, 8)}</p>
            </div>
