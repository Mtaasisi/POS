        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 relative">
              {activeTab === 'payment' && selectedCustomer ? (
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white/90 backdrop-blur-xl rounded-xl border-2 border-gray-200/50 hover:border-blue-300/50 transition-all duration-300 shadow-lg">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-green-50 to-green-100 rounded-xl border border-green-200/50 shadow-sm">
