      ...
      <div className="bg-white/80 backdrop-blur-xl border-b border-gray-200/50 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Right Side - Enhanced Info Display */}
            <div className="flex items-center gap-3">
              ...
              <div className="text-right">
                ...
                <p className="font-semibold text-green-600">${todaySales.toFixed(2)}</p>
              </div>
              <div className="w-px h-8 bg-gray-300"></div>
              ...
              <div className="text-right">
                ...
                <p className="font-semibold text-gray-900">{todayOrders}</p>
              </div>
              <div className="w-px h-8 bg-gray-300"></div>
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-medium">{weatherInfo.city}, {weatherInfo.temp}°C</span>
              </div>
              <div className="w-px h-8 bg-gray-300"></div>
