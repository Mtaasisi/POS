...
import { Brand, BrandCategory, getActiveBrands, getBrands, createBrand, updateBrand, deleteBrand, restoreBrand, searchBrands } from '../lib/brandApi';
...
interface BrandFormData {
  ...
  categories: BrandCategory[]; // For UI compatibility
}
