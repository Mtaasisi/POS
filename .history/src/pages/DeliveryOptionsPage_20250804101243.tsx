          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                onClick={handleBack}
                className="flex items-center justify-center gap-2 backdrop-blur-md rounded-lg border transition-all duration-300 bg-transparent border-2 border-red-400 text-red-600 hover:bg-red-50 hover:border-red-500 py-3 px-4 text-base hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] focus:ring-2 focus:ring-red-300 hover:border-red-400 backdrop-blur-xl"
              >
                <Power size={24} />
              </button>
            </div>
