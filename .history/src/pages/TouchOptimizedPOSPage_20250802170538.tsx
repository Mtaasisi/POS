            ...
            <div className="p-4 border-b border-gray-200">
              ...
              <div className="relative mb-4">
                <input
                  ...
                  className="w-full px-4 py-3 pl-12 border-2 border-gray-200 rounded-2xl bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-base"
                />
