...
const UnifiedImportPage: React.FC = () => {
  ...
  const [importMode, setImportMode] = useState<'excel' | 'manual'>('excel');
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Select Excel import or manual entry based on your needs</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">For Excel: Use CSV format with headers. For manual: Fill out the form</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Preview your data and confirm the import</p>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">
                        {import_.mode === 'excel' ? 'Excel Import' : 'Manual Entry'} completed
                      </p>
