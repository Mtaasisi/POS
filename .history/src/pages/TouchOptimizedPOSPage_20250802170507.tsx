      ...
      <div className="flex-shrink-0 p-4 bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Touch POS</h1>
              <p className="text-sm text-gray-600">Fast & Easy Sales</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              ...
              <div className="text-lg font-bold text-green-600">{formatCurrency(posStats.todaySales)}</div>
            </div>
            ...
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600">Quick selection</p>
                </div>
              </div>
              ...
              <div className="relative mb-6">
                <input
                  ...
                  className="w-full px-6 py-4 pl-14 border-2 border-gray-200 rounded-3xl bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-lg"
                />
                <Search className="w-7 h-7 text-gray-400 absolute left-4 top-1/2 transform -translate-y-1/2" />
              </div>
            </div>
