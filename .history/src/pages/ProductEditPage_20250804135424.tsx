...
import { ArrowLeft, Save, Package, Edit, Image as ImageIcon } from 'lucide-react';
...
import ThumbnailTest from '../components/ui/ThumbnailTest';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updateData = {
        ...
        tags: formData.tags,
        images: productImages.map(img => img.image_url), // Convert to string array for backward compatibility
          ...
          <div className="border-b border-gray-200 pb-6 mb-6">
            ...
            {product && (
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                <ThumbnailTest productId={product.id} />
              </div>
            )}
          </div>
