                ...
                {safeDevice.assignedTo && (
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-gray-900 font-semibold">{getUserName(safeDevice.assignedTo)}</p>
                    </div>
                  </div>
                )}
                ...
                {safeDevice.issueDescription && (
                  <div className="flex items-center gap-2 md:col-span-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm sm:text-base text-gray-900">{safeDevice.issueDescription}</p>
                    </div>
                  </div>
                )}
                ...
                {safeDevice.expectedReturnDate && (
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-gray-900 font-semibold">{formatDate(safeDevice.expectedReturnDate)}</p>
                    </div>
                  </div>
                )}
