...
const DeviceDetailPage: React.FC = () => {
  ...
  const fetchDeviceDetails = async () => {
    ...
    try {
      ...
      console.log('🔍 Fetching device details for ID:', safeDevice.id);
      ...
      if (deviceError) {
        ...
        console.log('📊 Device data fetched:', {
          ...
          unlock_code: deviceData?.unlock_code,
          repair_cost: deviceData?.repair_cost,
          deposit_amount: deviceData?.deposit_amount,
          diagnosis_required: deviceData?.diagnosis_required,
          device_notes: deviceData?.device_notes,
          device_cost: deviceData?.device_cost,
          estimated_hours: deviceData?.estimated_hours,
