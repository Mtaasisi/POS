    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-8">
          ...
          {activeSection !== 'general' && activeSection !== 'appearance' && activeSection !== 'notifications' && activeSection !== 'integrations' && activeSection !== 'data-management' && activeSection !== 'user-management' && activeSection !== 'advanced' && (
