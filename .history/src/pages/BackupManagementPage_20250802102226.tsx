        ...
        <GlassCard className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 bg-orange-50 rounded-lg">
              ...
              <div className="text-xs text-green-600 mt-1">✅ Local backups working</div>
              <div className="text-xs text-orange-500 mt-1">
                <button 
                  onClick={() => {
                    alert('DNS Issue Solutions:\n\n1. Check your internet connection\n2. Try using a different DNS server (8.8.8.8 or 1.1.1.1)\n3. Check if api.hostinger.com is blocked by firewall\n4. Verify your Hostinger API token is correct\n\n✅ Local backups will continue working regardless of DNS issues.\n📁 Backup files are saved locally in ./backups/\n🔄 System will retry Hostinger upload on next backup');
                  }}
