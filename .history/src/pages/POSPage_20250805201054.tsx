      ...
      <div className="max-w-7xl mx-auto px-4 py-6 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6">
          ...
          <div className="lg:col-span-4 sticky top-6 h-[calc(100vh-120px)] flex flex-col">
            ...
            <div className="p-3 rounded-xl bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-200/60 hover:border-emerald-300/70 hover:shadow-lg transition-all duration-300 relative overflow-hidden mb-4 flex-shrink-0">
              {/* Background Pattern */}
