      ...
      try {
        ...
        if (posSalesError) {
          ...
          if (simplePosSalesError) {
            ...
            finalPosSalesError = null;
            console.log(`✅ Loaded ${finalPosSalesData.length} POS sales (without joins)`);
          }
        } else {
          finalPosSalesData = posSalesData || [];
          finalPosSalesError = null;
          console.log(`✅ Loaded ${finalPosSalesData.length} POS sales`);
        }
      } catch (error) {
