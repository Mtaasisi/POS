...
let globalAuthProviderMountCount = 0;
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    globalAuthProviderMountCount++;
    logInfo('AuthProvider', `Initializing (mount #${globalAuthProviderMountCount})`);
    ...
    return () => {
      ...
      globalAuthProviderMountCount--;
      // Reset global flag only when all instances are unmounted
      if (globalAuthProviderMountCount <= 0) {
        globalAuthProviderInitialized = false;
        globalAuthProviderMountCount = 0;
      }
    };
