                              ...
                              <div className="space-y-3">
                                ...
                                <div>
                                  <div className="flex items-center justify-between mb-1">
                                    ...
                                    <button
                                      onClick={() => {
                                        const currentValue = entry.reference || '';
                                        updatePaymentEntry(index, 'reference', currentValue ? '' : '');
                                      }}
                                      className="text-xs text-blue-600 hover:text-blue-700 font-medium"
                                    >
                                      {entry.reference ? 'Remove' : 'Add'}
                                    </button>
                                  </div>
                                ...
                                <div>
                                  <div className="flex items-center justify-between mb-1">
                                    ...
                                    <button
                                      onClick={() => {
                                        const currentValue = entry.notes || '';
                                        updatePaymentEntry(index, 'notes', currentValue ? '' : '');
                                      }}
                                      className="text-xs text-blue-600 hover:text-blue-700 font-medium"
                                    >
                                      {entry.notes ? 'Remove' : 'Add'}
                                    </button>
                                  </div>
