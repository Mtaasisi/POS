        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
              ...
              {isEditingAmount ? (
                <div className="space-y-3">
                  <input
                    ...
                    className="text-3xl font-bold text-green-600 text-center bg-white border-2 border-green-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
          ...
          <div className="mb-6">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-400/20 to-orange-500/20 rounded-3xl blur-xl"></div>
              <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-orange-200/50 p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-gray-900">Payment Currency</div>
                      <div className="text-xs text-gray-500">Choose your preferred currency</div>
                    </div>
                  </div>
                  <div className="w-32">
                    <CurrencySelector
                            ...
                            <div>
                              ...
                              <div className="flex gap-3">
                                <input
                                  ...
                                  className="flex-1 px-4 py-3 bg-white border-2 border-gray-200 rounded-2xl text-sm focus:ring-4 focus:ring-orange-100 focus:border-orange-400 transition-all duration-300 hover:shadow-md"
                                />
                                <div className="relative group">
                                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400/20 to-orange-500/20 rounded-2xl blur-sm group-hover:blur-md transition-all duration-300"></div>
                                  <div className="relative px-4 py-3 bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl text-white font-bold text-sm flex items-center min-w-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
