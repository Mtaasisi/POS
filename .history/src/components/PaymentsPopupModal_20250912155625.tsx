        ...
        <div className="bg-gradient-to-br from-white/15 via-white/10 to-white/5 backdrop-blur-xl border border-white/30 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            <GlassButton
              ...
              className="w-full bg-gradient-to-r from-green-500/20 to-emerald-500/20 hover:from-green-500/30 hover:to-emerald-500/30 border-green-400/30 text-green-100 font-medium"
            ...
            {paymentEntries.length > 0 && (
              <div className="space-y-2">
                <div className="text-white/90 text-sm font-medium">Payments</div>
            ...
            <div className="flex gap-3 pt-2">
              <GlassButton
                onClick={onClose}
                variant="secondary"
                className="flex-1 bg-gradient-to-r from-gray-500/20 to-slate-500/20 hover:from-gray-500/30 hover:to-slate-500/30 border-gray-400/30 text-gray-100 font-medium"
                disabled={isProcessing}
              >
                Cancel
              </GlassButton>
              ...
              <GlassButton
                ...
                className="flex-1 bg-gradient-to-r from-purple-500/20 to-pink-500/20 hover:from-purple-500/30 hover:to-pink-500/30 border-purple-400/30 text-purple-100 font-medium"
