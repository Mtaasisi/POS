        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
          ...
          <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-blue-800">Payment Amount</h3>
            </div>
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium text-blue-800 mb-2">
                  Enter Payment Amount (TZS)
                </label>
                <input
                  type="number"
                  value={customAmount}
              ...
              {customAmount && (
                <div className="text-sm text-blue-600">
                  Customer will pay: <span className="font-semibold">TZS {Number(customAmount).toLocaleString()}</span>
                </div>
              )}
            </div>
          </div>
          ...
          {allowPriceEdit && (
            <div className="mt-4 p-3 bg-gray-100 rounded-lg text-xs">
              <p>Debug Info:</p>
              <p>allowPriceEdit: {allowPriceEdit.toString()}</p>
              <p>deviceId: {deviceId || 'undefined'}</p>
              <p>totalPaid: {totalPaid}</p>
              <p>amount: {amount}</p>
              <p>totalPaid > amount: {(totalPaid > amount).toString()}</p>
              <p>customerPaymentAmount > amount: {(customerPaymentAmount > amount).toString()}</p>
              <p>Should show price edit: {(allowPriceEdit && deviceId && customerPaymentAmount > amount).toString()}</p>
            </div>
          )}
                ...
                <div className="p-3 bg-white/50 rounded-lg">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-green-600">TZS {customerPaymentAmount.toLocaleString()}</p>
                    </div>
                  </div>
                </div>
                ...
                {!showPriceEdit ? (
                  <div className="space-y-3">
                    <p className="text-sm text-amber-700">
                      Customer paid <span className="font-semibold">TZS {(customerPaymentAmount - amount).toLocaleString()}</span> more than the original price.
                    </p>
                    <button
