      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm rounded-xl p-6 border-2 border-white/20 text-center">
              <div className="text-white/80 text-sm font-medium mb-2">Total Amount</div>
              <div className="text-white text-4xl font-bold mb-1">${amount.toFixed(2)}</div>
              <div className="text-white/60 text-xs">Payment Required</div>
            </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-green-400 text-lg font-bold">${totalPaid.toFixed(2)}</div>
                    <div className="text-white/60 text-xs">Paid</div>
                  </div>
                  <div className="text-center">
                    <div className="text-orange-400 text-lg font-bold">${remainingAmount.toFixed(2)}</div>
            ...
            {isMultiplePaymentMode && (
              <div className="space-y-3">
                ...
                <div className="bg-orange-500/20 border border-orange-400/30 rounded-lg p-3">
                  ...
                  <div className="text-orange-100 text-lg font-bold">${remainingAmount.toFixed(2)}</div>
                </div>
