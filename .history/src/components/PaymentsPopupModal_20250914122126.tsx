                            ...
                            <div>
                              ...
                              <div className="flex gap-1">
                                <input
                                  ...
                                  className="flex-1 px-2 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                                <div className="px-2 py-2 bg-gray-100 border border-gray-300 rounded-lg text-xs text-gray-600 flex items-center min-w-0">
                                  {entry.currency}
                                </div>
                              </div>
                            </div>
