              ...
              {isEditingAmount ? (
                <div className="space-y-4">
                  <div className="max-w-sm mx-auto">
                    <div className="flex items-center bg-white border border-gray-300 rounded-lg focus-within:border-orange-500 transition-colors">
                      {/* Currency Selector */}
                      <div className="flex items-center gap-2 px-3 py-2 border-r border-gray-200">
                        ...
                        <select
                          ...
                          className="bg-transparent border-none text-gray-700 text-sm focus:outline-none focus:ring-0 cursor-pointer"
                        >
                      ...
                      <div className="flex-1 px-3 py-2">
                        <input
                          ...
                          className="w-full border-0 focus:outline-none focus:ring-0 text-lg font-semibold text-gray-900 placeholder-gray-400 bg-transparent"
                          placeholder="0.00"
                          autoFocus
                          step="0.01"
                          min="0"
