  ...
  const processExcelFile = async (file: File) => {
    try {
      ...
      for (let i = 0; i < rawData.length; i++) {
        ...
        const rawBirthMonth = extractValue(Object.values(rowData), 'birthMonth', detected);
        ...
        const rawReferralSourceCustom = extractValue(Object.values(rowData), 'referralSourceCustom', detected);
        const rawBirthday = extractValue(Object.values(rowData), 'birthday', detected);
        ...
        const customer: ImportedCustomer = {
          ...
          colorTag: (rawColorTag || 'new') as 'new' | 'vip' | 'complainer' | 'purchased',
      ...
      if (validationErrors.length > 0) {
        toast.error(`Found ${validationErrors.length} validation errors. Please review before importing.`);
      } else {
