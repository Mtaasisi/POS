          ...
          <div className="hidden md:flex items-center gap-3 flex-1 max-w-md mx-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-2 rounded-lg bg-white/70 border border-white/40 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 backdrop-blur-sm font-medium text-gray-800 placeholder-gray-500 shadow-sm"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="flex items-center gap-2 p-2 rounded-lg bg-white/30 hover:bg-white/50 transition-all duration-300 backdrop-blur-sm border border-white/30 shadow-sm"
              >
