        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
              ...
              {isEditingAmount ? (
                <div className="space-y-4">
                  <div className="relative">
                    <div className="flex items-center bg-white rounded-2xl border-2 border-green-200 shadow-lg hover:shadow-xl hover:border-green-300 focus-within:border-green-500 focus-within:shadow-xl transition-all duration-300 overflow-hidden">
                      {/* Currency Selector */}
                      <div className="flex-shrink-0 bg-gradient-to-r from-green-50 to-emerald-50 border-r border-green-200">
                        <div className="flex items-center gap-3 px-4 py-3">
                          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center shadow-md">
                            <span className="text-white text-sm font-bold">{selectedCurrency.flag}</span>
                          </div>
                          <select
                            ...
                            className="bg-transparent border-none text-gray-800 font-semibold text-sm focus:outline-none focus:ring-0 cursor-pointer hover:text-green-700 transition-colors pr-8 appearance-none"
                          >
                      ...
                      <div className="flex-1 px-6 py-4">
                        <input
                          ...
                          className="w-full border-0 focus:outline-none focus:ring-0 text-3xl font-bold text-green-700 placeholder-green-300 bg-transparent text-center"
                          placeholder="0.00"
                          autoFocus
                          step="0.01"
                          min="0"
                      ...
                      {/* Currency Symbol */}
                      <div className="flex-shrink-0 px-4 py-3 bg-gradient-to-l from-green-50 to-transparent">
                    ...
                    {/* Floating Label */}
                    <div className="absolute -top-2 left-4 bg-white px-2 text-xs font-medium text-green-600">
                      Payment Amount
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 justify-center">
                    <button
                      ...
                      className="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white rounded-xl text-sm font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
                      ✓ Save Amount
                    </button>
                    <button
                      ...
                      className="px-6 py-3 bg-gradient-to-r from-gray-400 to-gray-500 hover:from-gray-500 hover:to-gray-600 text-white rounded-xl text-sm font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
                      ✕ Cancel
                    </button>
                  </div>
          ...
          <div className="mb-6">
            <div className="text-center mb-3">
              <h5 className="text-md font-semibold text-gray-900">Select Currency</h5>
              <p className="text-sm text-gray-600">Choose the currency for this payment</p>
            </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                              ...
                              <div className="flex gap-2">
                                ...
                                />
                                <div className="px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm text-gray-600 flex items-center">
                                  {entry.currency}
                                </div>
                              </div>
                            </div>
