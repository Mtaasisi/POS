                            ...
                            <div>
                              ...
                              <div className="flex gap-2">
                                <input
                                  ...
                                  className="flex-1 px-3 py-2 bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-400 focus:border-blue-300 transition-all duration-200"
                                />
                                <div className="px-3 py-2 bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-xl text-xs font-semibold text-orange-800 flex items-center min-w-0 shadow-sm">
                                  {entry.currency}
                                </div>
                              </div>
                            </div>
