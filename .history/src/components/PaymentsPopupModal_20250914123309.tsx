            ...
            <div className="text-center">
              ...
              {isEditingAmount ? (
                <div className="space-y-3">
                  <div className="flex items-center gap-2 p-2 bg-white border-2 border-green-300 rounded-lg hover:border-green-400 focus-within:border-green-500 transition-all duration-200">
                    {/* Currency Selector */}
                    <div className="flex-shrink-0 flex items-center gap-2 p-2 bg-gray-100 rounded-md">
                      <select
                        ...
                        className="bg-transparent border-none text-gray-700 font-medium text-sm focus:outline-none focus:ring-0 cursor-pointer hover:text-green-600 transition-colors pr-6"
                      >
                    ...
                    <div className="flex-1">
                      <input
                        ...
                        className="w-full border-0 focus:outline-none focus:ring-0 text-2xl font-bold text-green-600 placeholder-green-400 bg-transparent text-center"
