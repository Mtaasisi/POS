                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full py-3 pl-16 pr-12 bg-white/30 backdrop-blur-md border-2 rounded-lg focus:outline-none ${fieldErrors.stock_quantity ? 'border-red-500 focus:border-red-600' : formData.stock_quantity < 0 ? 'border-yellow-300 focus:border-yellow-500' : 'border-gray-300 focus:border-blue-500'}`}
                      placeholder="0"
                      autoComplete="off"
                      autoCorrect="off"
                      spellCheck={false}
                    ...
                    <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center rounded-md bg-gray-100 hover:bg-gray-200 text-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      ...
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center rounded-md bg-blue-100 hover:bg-blue-200 text-blue-600 transition-colors"
                      >
                        <Plus size={16} />
                      </button>
                    </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full py-3 pl-16 pr-12 bg-white/30 backdrop-blur-md border-2 rounded-lg focus:outline-none ${fieldErrors.min_stock_level ? 'border-red-500 focus:border-red-600' : formData.min_stock_level < 0 ? 'border-yellow-300 focus:border-yellow-500' : 'border-gray-300 focus:border-blue-500'}`}
                      placeholder="5"
                      autoComplete="off"
                      autoCorrect="off"
                      spellCheck={false}
                    ...
                    <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                      <button
                        ...
                        className="w-6 h-6 flex items-center justify-center rounded-md bg-gray-100 hover:bg-gray-200 text-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        disabled={formData.min_stock_level <= 0}
                      >
                        <Minus size={12} />
                      </button>
                      <button
                        ...
                        className="w-6 h-6 flex items-center justify-center rounded-md bg-orange-100 hover:bg-orange-200 text-orange-600 transition-colors"
                      >
                        <Plus size={12} />
                      </button>
                    </div>
