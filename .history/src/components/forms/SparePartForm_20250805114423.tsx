                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center p-3 bg-white rounded-lg border border-green-200">
                      <div className="text-2xl font-bold text-green-600">
                        {formatNumber((formData.price - formData.cost) || 0)}
                      </div>
                      <div className="text-sm text-gray-600">Profit per Unit</div>
                    </div>
                    <div className="text-center p-3 bg-white rounded-lg border border-blue-200">
                      <div className="text-2xl font-bold text-blue-600">
                        {formData.cost > 0 ? formatNumber(((formData.price - formData.cost) / formData.cost) * 100) : '0'}%
                      </div>
                      <div className="text-sm text-gray-600">Markup %</div>
                    </div>
                    <div className="text-center p-3 bg-white rounded-lg border border-purple-200">
                      <div className="text-2xl font-bold text-purple-600">
                        {formData.price > 0 ? formatNumber(((formData.price - formData.cost) / formData.price) * 100) : '0'}%
                      </div>
                    ...
                    <div className="mt-3 p-3 bg-white rounded-lg border border-gray-200">
                      <div className="text-center">
                        <div className="text-lg font-semibold text-gray-900">
                          Total Potential Profit: {formatNumber((((formData.price - formData.cost) || 0) * formData.stock_quantity))}
                        </div>
                        <div className="text-sm text-gray-600">
