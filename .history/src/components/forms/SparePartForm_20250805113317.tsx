                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      min="0"
                      max="60"
                      value={formData.warranty_period || 0}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      { value: 'refurbished', label: 'Refurbished', color: '#3B82F6' },
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 px-3 py-2 border rounded-lg transition-all duration-200 focus:outline-none ${
                          formData.condition === condition.value
                            ? 'bg-gradient-to-br from-gray-100 to-gray-200 border-gray-500 ring-2 ring-gray-400 scale-105'
                            : 'bg-white border-gray-200 hover:shadow-lg hover:scale-105'
                        }`}
                        style={{
                          borderColor: formData.condition === condition.value ? condition.color : undefined
                        }}
                      >
                        <div 
