  ...
  return (
    <div className="p-4 sm:p-6 h-full overflow-y-auto pt-8">
      <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
        {/* Progress Indicator */}
        <div className="bg-white/50 backdrop-blur-md rounded-lg p-3 border border-gray-200">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-base font-semibold text-gray-900">Spare Part Form</h2>
          ...
          <div className="flex items-center space-x-3">
            <div className={`flex items-center space-x-1 ${formData.name ? 'text-green-600' : 'text-gray-400'}`}>
              <div className={`w-6 h-6 rounded-full flex items-center justify-center ${formData.name ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-500'}`}>
                {formData.name ? (
            ...
            <div className="flex-1 h-0.5 bg-gray-200 rounded">
              <div className={`h-0.5 rounded transition-all duration-300 ${formData.name ? 'bg-green-500' : 'bg-gray-200'}`} style={{ width: formData.name ? '100%' : '0%' }}></div>
            </div>
            
            <div className={`flex items-center space-x-1 ${formData.price > 0 && formData.cost > 0 ? 'text-green-600' : 'text-gray-400'}`}>
              <div className={`w-6 h-6 rounded-full flex items-center justify-center ${formData.price > 0 && formData.cost > 0 ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-500'}`}>
            ...
            <div className="flex-1 h-0.5 bg-gray-200 rounded">
              <div className={`h-0.5 rounded transition-all duration-300 ${formData.price > 0 && formData.cost > 0 ? 'bg-green-500' : 'bg-gray-200'}`} style={{ width: formData.price > 0 && formData.cost > 0 ? '100%' : '0%' }}></div>
            </div>
            
            <div className={`flex items-center space-x-1 ${formData.stock_quantity >= 0 && formData.min_stock_level >= 0 ? 'text-green-600' : 'text-gray-400'}`}>
              <div className={`w-6 h-6 rounded-full flex items-center justify-center ${formData.stock_quantity >= 0 && formData.min_stock_level >= 0 ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-500'}`}>
          ...
          <div className="mt-1">
            ...
            <div className="w-full bg-gray-200 rounded-full h-1">
              <div className="bg-blue-500 h-1 rounded-full transition-all duration-300" style={{ width: `${completionPercentage}%` }}></div>
            </div>
          </div>
        </div>
