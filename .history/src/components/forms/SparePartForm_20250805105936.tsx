                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full py-3 px-12 bg-white/30 backdrop-blur-md border-2 rounded-lg focus:outline-none ${fieldErrors.stock_quantity ? 'border-red-500 focus:border-red-600' : formData.stock_quantity < 0 ? 'border-yellow-300 focus:border-yellow-500' : 'border-gray-300 focus:border-blue-500'}`}
                      placeholder="0"
                      autoComplete="off"
                      autoCorrect="off"
                      spellCheck={false}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full py-3 px-12 bg-white/30 backdrop-blur-md border-2 rounded-lg focus:outline-none ${fieldErrors.min_stock_level ? 'border-red-500 focus:border-red-600' : formData.min_stock_level < 0 ? 'border-yellow-300 focus:border-yellow-500' : 'border-gray-300 focus:border-blue-500'}`}
                      placeholder="5"
                      autoComplete="off"
                      autoCorrect="off"
                      spellCheck={false}
