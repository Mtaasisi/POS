              ...
              <div className="grid grid-cols-2 gap-4">
                {paymentMethods.map((method) => {
                  ...
                  const getMethodButtonColor = (methodName: string, selected: boolean) => {
                    const baseColors = {
                      'Cash': selected 
                        ? 'bg-green-500/30 border-green-400/50 text-green-100 ring-4 ring-green-300/50' 
                        : 'bg-green-500/20 border-green-400/30 text-green-200 hover:bg-green-500/30',
                      'Bank Transfer': selected 
                        ? 'bg-blue-500/30 border-blue-400/50 text-blue-100 ring-4 ring-blue-300/50' 
                        : 'bg-blue-500/20 border-blue-400/30 text-blue-200 hover:bg-blue-500/30',
                      'Airtel Money': selected 
                        ? 'bg-red-500/30 border-red-400/50 text-red-100 ring-4 ring-red-300/50' 
                        : 'bg-red-500/20 border-red-400/30 text-red-200 hover:bg-red-500/30',
                      'M-Pesa': selected 
                        ? 'bg-yellow-500/30 border-yellow-400/50 text-yellow-100 ring-4 ring-yellow-300/50' 
                        : 'bg-yellow-500/20 border-yellow-400/30 text-yellow-200 hover:bg-yellow-500/30',
                      'Tigo Pesa': selected 
                        ? 'bg-purple-500/30 border-purple-400/50 text-purple-100 ring-4 ring-purple-300/50' 
                        : 'bg-purple-500/20 border-purple-400/30 text-purple-200 hover:bg-purple-500/30',
                      'HaloPesa': selected 
                        ? 'bg-orange-500/30 border-orange-400/50 text-orange-100 ring-4 ring-orange-300/50' 
