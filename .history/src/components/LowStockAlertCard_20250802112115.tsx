...
import { AlertTriangle, Package, Clock, TrendingDown, Plus, Eye, X } from 'lucide-react';
  ...
  return (
    ...
    `}>
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {lowStockParts.slice(0, 4).map((part, index) => {
                ...
                <div 
                  className={`
                    ...
                    ${urgencyLevel === 'critical' ? 'bg-red-600' : 
                      ...
                      urgencyLevel === 'warning' ? 'bg-yellow-500' : 'bg-orange-400'}
                  `}
              ...
              <div className="mt-2 flex items-center justify-between text-xs">
                <span className={`
                  ${urgencyLevel === 'critical' ? 'text-red-700' : 
                    ...
                    urgencyLevel === 'warning' ? 'text-yellow-600' : 'text-orange-600'}
                  font-medium
                `}>
                  {urgencyLevel === 'critical' ? 'CRITICAL' :
                   urgencyLevel === 'urgent' ? 'URGENT' :
                   urgencyLevel === 'warning' ? 'WARNING' : 'LOW'}
                </span>
