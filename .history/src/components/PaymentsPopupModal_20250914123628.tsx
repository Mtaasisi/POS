            ...
            <div className="text-center">
              ...
              {isEditingAmount ? (
                <div className="space-y-4">
                  <div className="flex items-center gap-2 p-2 bg-white border border-gray-300 rounded-lg hover:border-gray-400 focus-within:border-orange-500 transition-colors">
                    {/* Currency Selector */}
                    ...
                    <div className="flex-1">
                      <input
                        ...
                        className="w-full border-0 focus:outline-none focus:ring-0 text-2xl font-bold text-green-600 placeholder-gray-400 bg-transparent text-center"
