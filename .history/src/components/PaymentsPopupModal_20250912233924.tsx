        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            {(customerName || description) && (
              <div className="relative overflow-hidden rounded-2xl bg-white/6 backdrop-blur-xl border border-white/20 shadow-2xl">
                {/* Top accent bar */}
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 shadow-lg flex items-center justify-center">
                          <span className="text-white text-sm font-bold">
                            {customerName ? customerName.charAt(0).toUpperCase() : 'C'}
                          </span>
                        </div>
                        <div className="absolute -top-1 -right-1 w-3 h-3 rounded-full bg-green-400 border border-white"></div>
                      </div>
                      <div>
