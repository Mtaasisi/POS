      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            {/* Amount Input - Show in both modes */}
            <div className="space-y-4">
              <div className="space-y-3">
                ...
                <GlassInput
                  ...
                  onChange={(e) => {
                    ...
                    if (isMultiplePaymentMode) {
                      ...
                      // For single payment mode, we can't change the total amount
                      // This input is just for display
                    }
                  }}
                  placeholder="0"
                  min="0"
                ...
                {/* Quick Amounts - Only show in multiple payment mode */}
                {isMultiplePaymentMode && (
              ...
              {/* Virtual Keyboard - Always show */}
              <div className="mt-4">
                <div className="text-white/70 text-xs mb-2">Virtual Keyboard</div>
                <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-4">
                  <div className="text-white/50 text-xs mb-2">Number Input Keyboard</div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-3">
                    {['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '.', '00'].map((key) => (
                      <button
                        ...
                        disabled={isProcessing || !isMultiplePaymentMode}
                        className="h-12 bg-white/20 hover:bg-white/30 border border-white/30 rounded-lg text-white font-semibold text-lg transition-all duration-200 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {key}
                      </button>
                    ))}
