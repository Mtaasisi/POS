            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4">
                {paymentMethods.map((method) => {
                  ...
                  // Define colors for each payment method - Enhanced visibility
                  const getMethodButtonColor = (methodName: string, selected: boolean) => {
                    const baseColors = {
                      'Cash': selected 
                        ? 'bg-green-500/50 border-green-400/70 text-green-50 ring-4 ring-green-300/70 shadow-lg shadow-green-500/30' 
                        : 'bg-green-500/35 border-green-400/50 text-green-100 hover:bg-green-500/45 hover:border-green-400/60',
                      'Bank Transfer': selected 
                        ? 'bg-blue-500/50 border-blue-400/70 text-blue-50 ring-4 ring-blue-300/70 shadow-lg shadow-blue-500/30' 
                        : 'bg-blue-500/35 border-blue-400/50 text-blue-100 hover:bg-blue-500/45 hover:border-blue-400/60',
                      'Airtel Money': selected 
                        ? 'bg-red-500/50 border-red-400/70 text-red-50 ring-4 ring-red-300/70 shadow-lg shadow-red-500/30' 
                        : 'bg-red-500/35 border-red-400/50 text-red-100 hover:bg-red-500/45 hover:border-red-400/60',
                      'M-Pesa': selected 
                        ? 'bg-yellow-500/50 border-yellow-400/70 text-yellow-50 ring-4 ring-yellow-300/70 shadow-lg shadow-yellow-500/30' 
                        : 'bg-yellow-500/35 border-yellow-400/50 text-yellow-100 hover:bg-yellow-500/45 hover:border-yellow-400/60',
                      'Tigo Pesa': selected 
                        ? 'bg-purple-500/50 border-purple-400/70 text-purple-50 ring-4 ring-purple-300/70 shadow-lg shadow-purple-500/30' 
                        : 'bg-purple-500/35 border-purple-400/50 text-purple-100 hover:bg-purple-500/45 hover:border-purple-400/60',
                      'HaloPesa': selected 
                        ? 'bg-orange-500/50 border-orange-400/70 text-orange-50 ring-4 ring-orange-300/70 shadow-lg shadow-orange-500/30' 
                        : 'bg-orange-500/35 border-orange-400/50 text-orange-100 hover:bg-orange-500/45 hover:border-orange-400/60'
                    };
