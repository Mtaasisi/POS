        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            {(customerName || description) && (
              <div className="bg-lats-surface border border-lats-glass-border rounded-lats-radius-lg backdrop-blur-sm shadow-lats-glass-shadow p-4 hover:bg-lats-surface-hover transition-all duration-200">
                <div className="flex items-center gap-3">
                  {/* Customer avatar */}
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-lats-primary/20 border border-lats-primary/30 flex items-center justify-center">
                    <span className="text-lats-primary text-xs font-semibold">
                  ...
                  <div className="flex-1 min-w-0">
                    {customerName && (
                      <div className="text-lats-text text-sm font-medium mb-0.5 truncate">
                        {customerName}
                      </div>
                    )}
                    {description && (
                      <div className="text-lats-text-secondary text-xs">
                        {description}
                      </div>
                    )}
                  </div>
