          ...
          <div className="p-6 space-y-6">
            ...
            {(customerName || description) && (
              <div className="space-y-3">
                {/* Customer Name Card */}
                {customerName && (
                  <div className="bg-gradient-to-r from-white/12 to-white/6 backdrop-blur-lg rounded-xl border border-white/20 p-4 shadow-lg">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500/30 to-purple-500/30 border border-white/20 flex items-center justify-center">
                ...
                {description && (
                  <div className="bg-white/8 backdrop-blur-md rounded-lg border border-white/15 p-3">
                    <div className="flex items-center gap-2">
