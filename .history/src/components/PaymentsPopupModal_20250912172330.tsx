...
const PaymentsPopupModal: React.FC<PaymentsPopupModalProps> = ({
  ...
  const addPayment = () => {
    ...
    if (isMultiplePaymentMode) {
      ...
      // Single payment mode - add to entries (user will click Complete to process)
      setPaymentEntries([newPayment]);
      setReference('');
      setNotes('');
      toast.success('Payment ready - click Complete to process');
    }
  };
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <GlassInput
                ...
                placeholder="0.00"
                min="0"
                max={paymentEntries.length > 0 ? remainingAmount : amount}
