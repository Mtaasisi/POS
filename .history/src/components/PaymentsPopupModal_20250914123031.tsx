              ...
              {isEditingAmount ? (
                ...
                <div className="text-3xl font-bold text-green-600 mb-2 flex items-center justify-center gap-2">
                  <button
                    ...
                    className="hover:bg-green-100 rounded-full p-1 transition-colors cursor-pointer"
                    title="Click to change currency"
                  >
                    <span className="text-3xl">{selectedCurrency.flag}</span>
                  </button>
                  <span>
                    {selectedCurrency.symbol} {(customAmount ? Number(customAmount) : amount).toLocaleString()}
                  </span>
                </div>
              )}
              {isMultipleMode && (
