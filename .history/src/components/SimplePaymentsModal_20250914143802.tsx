...
const SimplePaymentsModal: React.FC<SimplePaymentsModalProps> = ({
  ...
  const getMethodIcon = (type: string, name: string, currency?: string) => {
    return <PaymentMethodIcon type={type} name={name} className="w-6 h-6" currency={currency} />;
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            {/* Currency Selection */}
            <div className="bg-white/8 backdrop-blur-md rounded-xl border border-white/20 p-4">
              <div className="text-white/90 text-sm font-medium text-center mb-3">Select Currency</div>
              <CurrencySelector
                    ...
                    >
                      <div className="flex flex-col items-center gap-2">
                        <div className="text-2xl text-white/80">
                          {getMethodIcon(method.type, method.name, method.currency)}
                        </div>
