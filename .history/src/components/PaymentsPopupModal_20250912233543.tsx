          ...
          <div className="p-6 space-y-6">
            ...
            {(customerName || description) && (
              <div className="relative overflow-hidden">
                {/* Background gradient */}
                <div className="absolute inset-0 bg-gradient-to-br from-white/8 via-white/5 to-white/3 rounded-xl"></div>
                
                {/* Glass effect overlay */}
                <div className="relative backdrop-blur-md rounded-xl p-5 border border-white/15 shadow-lg">
                  {/* Content */}
                  <div className="flex items-start gap-3">
                    {/* Customer avatar/icon */}
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/20 flex items-center justify-center">
                    ...
                    <div className="flex-1 min-w-0">
                      {customerName && (
                        <div className="text-white/95 text-sm font-medium mb-1 truncate">
                          {customerName}
                        </div>
                      )}
                      {description && (
