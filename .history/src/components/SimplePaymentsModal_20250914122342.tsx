        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-400/30 to-orange-500/30 rounded-3xl blur-lg"></div>
              <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl border border-white/30 p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-orange-400/80 to-orange-500/80 backdrop-blur-sm flex items-center justify-center shadow-lg border border-white/20">
                      <span className="text-lg">💱</span>
                    </div>
                    <div>
                      <div className="text-sm font-bold text-white">Payment Currency</div>
                      <div className="text-xs text-white/70">Select your currency</div>
                    </div>
                  </div>
                  <div className="w-28">
                    <CurrencySelector
