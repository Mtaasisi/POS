              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Enter a direct image URL (PNG, JPG, SVG). Leave empty to use default icon.
                    <br />
                    <span className="text-blue-600">Examples:</span> https://cdn.example.com/visa.png, https://example.com/mpesa.jpg
                  </p>
                </div>
