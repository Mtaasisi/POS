...
const PaymentSelectionModal: React.FC<PaymentSelectionModalProps> = ({
  ...
  const handleConfirmPayment = () => {
    console.log('🔧 Confirm Payment clicked, selectedAccount:', selectedAccount, 'amountPaid:', amountPaid);
    if (selectedAccount) {
      console.log('🔧 Calling onPaymentSelect with:', selectedAccount, 'amountPaid:', amountPaid);
      ...
      <GlassCard className="max-w-2xl w-full mx-4">
        ...
        <div className="bg-gray-50 rounded-xl p-4 mb-6">
          ...
          <div className="mt-2 flex justify-between text-sm">
            ...
            <span className={totalAmount - amountPaid > 0 ? 'text-red-600 font-semibold' : 'text-green-600 font-semibold'}>
              Tsh{(totalAmount - amountPaid).toFixed(2)}
            </span>
          </div>
        </div>
