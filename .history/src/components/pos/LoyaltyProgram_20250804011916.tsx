...
interface LoyaltyProgramProps {
  ...
  initialTab?: 'customers' | 'rewards' | 'analytics';
}
...
const LoyaltyProgram: React.FC<LoyaltyProgramProps> = ({ 
  ...
  const [activeTab, setActiveTab] = useState<'customers' | 'rewards' | 'analytics'>(initialTab);
                      ...
                      {customer.isLoyaltyMember ? (
                        <div className="space-y-2 mb-4">
                          ...
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-medium">Tsh{customer.totalSpent.toLocaleString()}</span>
                          </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-orange-50 rounded-lg p-4 text-center">
                  ...
                  <p className="text-2xl font-bold text-orange-700">
                    Tsh{customers.filter(c => c.isLoyaltyMember).reduce((sum, c) => sum + c.totalSpent, 0).toLocaleString()}
                  </p>
                </div>
              </div>
