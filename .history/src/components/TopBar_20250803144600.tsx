...
const TopBar: React.FC<TopBarProps> = ({ onMenuToggle, isMenuOpen, isNavCollapsed }) => {
  ...
  return (
    <header className={`sticky top-0 z-20 topbar topbar-enter transition-all duration-500 ${isNavCollapsed ? 'md:ml-[5.5rem]' : 'md:ml-72'}`}>
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="hidden md:flex items-center gap-4 flex-1 max-w-md mx-8">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/70 border-2 border-white/40 focus:outline-none focus:ring-4 focus:ring-blue-500/30 focus:border-blue-500 backdrop-blur-sm font-medium text-gray-800 placeholder-gray-500 shadow-lg"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={notificationsRef}>
            ...
            {showNotifications && (
              <div className="absolute right-0 top-full mt-2 w-80 topbar-dropdown rounded-lg z-50">
                <div className="p-4">
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            {/* User Menu Dropdown */}
            {showUserMenu && (
              <div className="absolute right-0 top-full mt-2 w-64 topbar-dropdown rounded-lg z-50">
                <div className="p-4">
