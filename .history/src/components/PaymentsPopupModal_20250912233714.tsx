          ...
          <div className="p-6 space-y-6">
            ...
            {(customerName || description) && (
              <div className="relative">
                ...
                <div className="bg-white/8 backdrop-blur-md rounded-lg border border-white/15 p-3 transition-all duration-200 hover:bg-white/12 hover:border-white/25">
                  <div className="flex items-center gap-3">
                    {/* Minimalist avatar */}
                    ...
                    {/* Simple status dot */}
                    <div className="w-2 h-2 rounded-full bg-green-400/80 flex-shrink-0"></div>
                  </div>
                </div>
              </div>
            )}
