  ...
  const handlePayment = async () => {
    ...
    try {
      if (isMultipleMode) {
        ...
        console.log('🔍 Multiple payments - totalPaid:', totalPaid, 'paymentEntries:', paymentEntries.map(p => p.amount));
        ...
        console.log('🔍 Single payment - totalPaid:', singlePaymentTotalPaid, 'amount:', amount);
