          ...
          <div className="p-6 space-y-6">
            ...
            {(customerName || description) && (
              <div className="relative group">
                {/* Main card */}
                <div className="relative overflow-hidden rounded-2xl border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl p-5 transition-all duration-300 hover:border-white/30 hover:shadow-2xl hover:shadow-blue-500/10">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 shadow-lg flex items-center justify-center">
                            <span className="text-white text-sm font-bold">
                              {customerName ? customerName.charAt(0).toUpperCase() : 'C'}
                            </span>
                          </div>
                          {/* Status indicator */}
                          <div className="absolute -bottom-1 -right-1 w-4 h-4 rounded-full bg-green-400 border-2 border-white shadow-sm"></div>
                        </div>
                        
                        {/* Customer details */}
                        <div className="space-y-1">
                          {customerName && (
                            <div className="text-white/95 text-base font-semibold tracking-tight">
                              {customerName}
                            </div>
                          )}
                          {description && (
                      ...
                      <div className="flex items-center gap-2">
                        <div className="px-3 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm">
