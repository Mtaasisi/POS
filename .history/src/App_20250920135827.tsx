    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="/ad-generator" element={<RoleProtectedRoute allowedRoles={['admin']}><Suspense fallback={<DynamicPageLoader />}><ProductAdGeneratorPage /></Suspense></RoleProtectedRoute>} />
        ...
        <Route path="/product-export" element={
          ...
          {/* POS Route */}
          <Route path="/pos" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><Suspense fallback={<DynamicPageLoader />}><POSPage /></Suspense></RoleProtectedRoute>} />
