    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/product-export" element={<RoleProtectedRoute allowedRoles={['admin']}><ProductExportPage /></RoleProtectedRoute>} />
          ...
          <Route path="/lats/products/:id" element={<RoleProtectedRoute allowedRoles={['admin']}><ProductDetailPage /></RoleProtectedRoute>} />
          ...
          {/* Edit Product Route */}
          <Route path="/lats/products/:productId/edit" element={<RoleProtectedRoute allowedRoles={['admin']}><Suspense fallback={<PageLoadingSpinner />}><EditProductPage /></Suspense></RoleProtectedRoute>} />
