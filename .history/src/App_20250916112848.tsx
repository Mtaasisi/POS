    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="/repair" element={<Suspense fallback={<PageLoadingSpinner />}><DeviceRepairPage /></Suspense>} />
          <Route path="/repair/simple" element={<Suspense fallback={<PageLoadingSpinner />}><SimpleRepairPage /></Suspense>} />
