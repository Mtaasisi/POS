...
const StockValueDebugger = lazy(() => import('./components/StockValueDebugger'));
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/product-export" element={
          ...
          <Route path="/stock-debug" element={<RoleProtectedRoute allowedRoles={['admin', 'manager']}><Suspense fallback={<DynamicPageLoader />}><StockValueDebugger /></Suspense></RoleProtectedRoute>} />
