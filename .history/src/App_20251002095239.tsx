...
const StockValuePage = lazy(() => import('./pages/StockValuePage'));
const StockDebugPage = lazy(() => import('./pages/StockDebugPage'));
const InventoryManagerPage = lazy(() => import('./pages/InventoryManagerPage'));
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/product-export" element={
          ...
          {/* Stock Value Calculator Route */}
          <Route path="/stock-value" element={<RoleProtectedRoute allowedRoles={['admin', 'manager']}><Suspense fallback={<DynamicPageLoader />}><StockValuePage /></Suspense></RoleProtectedRoute>} />
          
          {/* Stock Value Debugger Route */}
          <Route path="/stock-debug" element={<RoleProtectedRoute allowedRoles={['admin', 'manager']}><Suspense fallback={<DynamicPageLoader />}><StockDebugPage /></Suspense></RoleProtectedRoute>} />
          
          {/* Inventory Value Manager Route */}
          <Route path="/inventory-manager" element={<RoleProtectedRoute allowedRoles={['admin', 'manager']}><Suspense fallback={<DynamicPageLoader />}><InventoryManagerPage /></Suspense></RoleProtectedRoute>} />
