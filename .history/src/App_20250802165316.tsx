...
import TouchOptimizedPOSPage from './pages/TouchOptimizedPOSPage';
...
<Route path="/inventory/products/:id" element={<ProductDetailPage />} />
        ...
        <Route path="/touch-pos" element={<RoleProtectedRoute allowedRoles={['admin', 'customer-care']}><TouchOptimizedPOSPage /></RoleProtectedRoute>} />
