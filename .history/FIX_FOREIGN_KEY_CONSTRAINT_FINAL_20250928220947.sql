-- =====================================================
-- FINAL FIX: FOREIGN KEY CONSTRAINT ERROR IN RECEIVE FUNCTION
-- =====================================================
-- This completely fixes the "violates foreign key constraint purchase_order_audit_user_id_fkey" error
-- by making user_id nullable and updating the function to handle invalid user_ids gracefully
