-- Create Admin Settings Tables (Simplified Version)
...
('performanceMonitoring', 'realTimeMetrics', 'true', 'boolean', 'Enable real-time metrics collection'),
('performanceMonitoring', 'alertThresholds_cpuUsage', '80', 'number', 'CPU usage alert threshold (%)'),
('performanceMonitoring', 'alertThresholds_memoryUsage', '80', 'number', 'Memory usage alert threshold (%)'),
('performanceMonitoring', 'alertThresholds_diskUsage', '80', 'number', 'Disk usage alert threshold (%)'),
('performanceMonitoring', 'alertThresholds_responseTime', '2000', 'number', 'Response time alert threshold (ms)'),
('performanceMonitoring', 'alertThresholds_errorRate', '0.5', 'number', 'Error rate alert threshold (%)'),
('performanceMonitoring', 'alertThresholds_activeConnections', '100', 'number', 'Active connections alert threshold'),
('performanceMonitoring', 'autoScaling_enabled', 'false', 'boolean', 'Enable auto scaling'),
('performanceMonitoring', 'autoScaling_minInstances', '1', 'number', 'Minimum number of instances'),
('performanceMonitoring', 'autoScaling_maxInstances', '10', 'number', 'Maximum number of instances'),
('performanceMonitoring', 'autoScaling_scaleUpThreshold', '90', 'number', 'Scale up threshold (%)'),
('performanceMonitoring', 'autoScaling_scaleDownThreshold', '70', 'number', 'Scale down threshold (%)'),
('performanceMonitoring', 'resourceLimits_maxCpu', '100', 'number', 'Maximum CPU usage (%)'),
('performanceMonitoring', 'resourceLimits_maxMemory', '100', 'number', 'Maximum memory usage (%)'),
('performanceMonitoring', 'resourceLimits_maxDisk', '100', 'number', 'Maximum disk usage (%)'),
('performanceMonitoring', 'resourceLimits_maxBandwidth', '100', 'number', 'Maximum bandwidth (MB/s)'),
('performanceMonitoring', 'resourceLimits_maxRequestsPerMinute', '1000', 'number', 'Maximum requests per minute'),
('performanceMonitoring', 'monitoringIntervals_metricsCollection', '60', 'number', 'Metrics collection interval (seconds)'),
('performanceMonitoring', 'monitoringIntervals_alertCheck', '60', 'number', 'Alert check interval (seconds)'),
('performanceMonitoring', 'monitoringIntervals_healthCheck', '60', 'number', 'Health check interval (seconds)'),
('performanceMonitoring', 'performanceAlerts_emailNotifications', 'true', 'boolean', 'Enable email notifications'),
('performanceMonitoring', 'performanceAlerts_slackNotifications', 'true', 'boolean', 'Enable Slack notifications'),
('performanceMonitoring', 'performanceAlerts_smsNotifications', 'true', 'boolean', 'Enable SMS notifications'),
('performanceMonitoring', 'performanceAlerts_alertCooldown', '15', 'number', 'Alert cooldown period (minutes)'),
...
BEGIN
  ...
  IF reason IS NOT NULL AND setting_id IS NOT NULL THEN
    ...
    AND created_at = (SELECT MAX(created_at) FROM admin_settings_log asl WHERE asl.setting_id = setting_id);
  END IF;
...
GRANT EXECUTE ON FUNCTION update_admin_setting(TEXT, TEXT, TEXT, TEXT) TO authenticated;
