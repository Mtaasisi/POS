-- =====================================================
-- FIX PURCHASE ORDER RPC FUNCTIONS - CORRECTED VERSION
-- =====================================================
-- This script fixes the 400 Bad Request errors by matching parameter names
...
-- Parameter name matches service call: { purchase_order_id_param: purchaseOrderId }
...
-- Step 3: Create get_received_items_for_po function
-- Parameter name matches service call: { po_id: purchaseOrderId }
...
-- Success message
SELECT 'Purchase order RPC functions have been created successfully! The 400 errors should now be resolved.' as message;
