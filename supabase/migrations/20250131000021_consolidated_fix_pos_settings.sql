-- Consolidated Fix for lats_pos_general_settings Table
-- This migration consolidates all previous attempts and creates a clean, working table
-- Migration: 20250131000021_consolidated_fix_pos_settings.sql
...
-- =====================================================
-- CREATE CLEAN GENERAL SETTINGS TABLE
-- =====================================================
