-- Fixed Enhanced WhatsApp Bulk Messaging Tables Migration
-- This migration creates all necessary tables for the enhanced bulk messaging system
-- Fixed to handle potential conflicts and ensure proper table creation
...
CREATE TABLE whatsapp_bulk_message_results (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX idx_whatsapp_campaigns_created_at ON whatsapp_campaigns(created_at);
CREATE INDEX idx_whatsapp_campaigns_language ON whatsapp_campaigns(language);

CREATE INDEX idx_whatsapp_bulk_results_campaign_id ON whatsapp_bulk_message_results(campaign_id);
CREATE INDEX idx_whatsapp_bulk_results_status ON whatsapp_bulk_message_results(status);
CREATE INDEX idx_whatsapp_bulk_results_phone ON whatsapp_bulk_message_results(phone_number);
CREATE INDEX idx_whatsapp_bulk_results_sent_at ON whatsapp_bulk_message_results(sent_at);

CREATE INDEX idx_whatsapp_escalations_status ON whatsapp_escalations(status);
CREATE INDEX idx_whatsapp_escalations_chat_id ON whatsapp_escalations(chat_id);
CREATE INDEX idx_whatsapp_escalations_created_at ON whatsapp_escalations(created_at);

CREATE INDEX idx_whatsapp_contact_prefs_customer_id ON whatsapp_contact_preferences(customer_id);
CREATE INDEX idx_whatsapp_contact_prefs_phone ON whatsapp_contact_preferences(phone_number);
CREATE INDEX idx_whatsapp_contact_prefs_opt_in ON whatsapp_contact_preferences(opt_in_status);
...
CREATE INDEX idx_whatsapp_analytics_event_type ON whatsapp_analytics_events(event_type);
CREATE INDEX idx_whatsapp_analytics_timestamp ON whatsapp_analytics_events(timestamp);
CREATE INDEX idx_whatsapp_analytics_campaign_id ON whatsapp_analytics_events(campaign_id);
