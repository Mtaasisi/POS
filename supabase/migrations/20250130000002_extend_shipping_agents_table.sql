-- Migration: Extend shipping agents table with comprehensive fields
-- This migration adds all the fields needed for the shipping agents management system

-- =====================================================
-- EXTEND SHIPPING AGENTS TABLE
-- =====================================================

-- Add new columns to lats_shipping_agents table
