-- Create LATS sales and related tables (Safe Version)
-- Migration: 20250128000005_create_lats_tables_safe.sql
...
DROP POLICY IF EXISTS "Admin can manage lats_products" ON lats_products;
DROP POLICY IF EXISTS "Admin can manage lats_product_variants" ON lats_product_variants;
DROP POLICY IF EXISTS "Admin can manage lats_receipts" ON lats_receipts;
DROP POLICY IF EXISTS "Admin can manage lats_stock_movements" ON lats_stock_movements;
...
DROP POLICY IF EXISTS "Authenticated users can view lats_products" ON lats_products;
DROP POLICY IF EXISTS "Authenticated users can view lats_product_variants" ON lats_product_variants;
DROP POLICY IF EXISTS "Authenticated users can view lats_receipts" ON lats_receipts;
DROP POLICY IF EXISTS "Authenticated users can view lats_stock_movements" ON lats_stock_movements;
