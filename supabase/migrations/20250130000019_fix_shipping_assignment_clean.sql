-- Migration: Fix Shipping Assignment - Clean and Simple
...
ALTER TABLE lats_purchase_orders ADD COLUMN IF NOT EXISTS shipping_info JSONB DEFAULT '{}';

-- Add shipping_date column if it doesn't exist
ALTER TABLE lats_purchase_orders ADD COLUMN IF NOT EXISTS shipping_date TIMESTAMP WITH TIME ZONE;
