-- Fix POS Settings Tables - Part 2 - Remove Non-existent Business References
-- This migration fixes the business_id foreign key references for remaining tables

-- =====================================================
-- BARCODE SCANNER SETTINGS TABLE (FIXED)
-- =====================================================
...
-- =====================================================
-- SEARCH & FILTER SETTINGS TABLE (FIXED)
-- =====================================================
