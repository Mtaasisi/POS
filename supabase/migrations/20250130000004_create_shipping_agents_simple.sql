-- Simple Shipping Agents Migration (No Dependencies)
-- This migration creates the shipping agents system without external table dependencies
...
INSERT INTO lats_shipping_agents (
    name, email, phone, whatsapp, company, is_active,
