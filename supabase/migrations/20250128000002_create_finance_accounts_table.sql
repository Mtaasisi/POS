-- Create finance_accounts table for payment methods
-- Migration: 20250128000002_create_finance_accounts_table.sql

-- Finance accounts table (used for payment methods)
...
-- Insert default payment methods (matching POS payment methods)
