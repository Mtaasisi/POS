-- Basic Shipping Tables Migration (No External References)
-- This migration creates the essential shipping tables without any foreign key references
...
CREATE TABLE IF NOT EXISTS lats_shipping_agents (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    manager_id UUID, -- Simple UUID field, no foreign key constraint
    name TEXT NOT NULL,
    email TEXT NOT NULL,
    phone TEXT,
    company TEXT,
...
CREATE TABLE IF NOT EXISTS lats_shipping_agent_offices (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    agent_id UUID NOT NULL, -- Simple UUID field, no foreign key constraint
    name TEXT NOT NULL,
...
-- Shipping Managers (simplified policies)
...
-- Shipping Agents (simplified policies)
...
-- Shipping Agent Offices (simplified policies)
