-- Corrected fix for get_received_items_for_po function
-- This resolves the 400 Bad Request error and "receive form remains empty" issue

-- Drop existing function if it exists with different signature
DROP FUNCTION IF EXISTS get_received_items_for_po(UUID);

-- Create the get_received_items_for_po function with correct return type and table references
...
-- SELECT * FROM get_received_items_for_po('a5b9479b-482e-4c64-ae52-51345bcab362');